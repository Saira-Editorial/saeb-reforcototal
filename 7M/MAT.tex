...
\conteudo{\subsubsection{Retas paralelas e retas transversais}
...
\medskip \noindent \textit{Condição de existência}: para um triângulo ser possível de
...
\conteudo{\subsubsection{Deslocamento}
...
Será realizada uma pesquisa sobre a intenção de voto
...
\conteudo{\subsubsection{Probabilidade condicional}

\medskip \noindent \textit{Eventos independentes:} a ocorrência de um evento não depende de
seus antecessores ou sucessores.

\medskip\noindent {Exemplo:} 

Qual é a probabilidade de tirar um ás de paus em um
...
$$P(A)= \frac{\text{número de chances de ocorrer o  evento}}{\text{espaço amostral\ (todas chances possíveis)}}$$
...
Tirar um número específico em um dado ou cara/coroa em
uma moeda são eventos dependentes.

\medskip \noindent \textit{Regra da multiplicação para eventos independentes:} para
...
\medskip\noindent {Exemplo:} 
A probabilidade de Juliana acertar duas questões
...
\medskip \noindent \textit{Eventos dependentes:} é quando o evento anterior influencia na
tomada de decisão do evento atual.

\medskip\noindent {Exemplo:} 

Em um jogo de baralho, ganha quem encontrar o 10 de
