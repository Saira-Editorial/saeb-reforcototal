...
\noindent \medskip \textit{Proporção:} é a igualdade entre duas razões. Assim, os
...
\noindent \medskip \textit{Propriedade fundamental das proporções:} em uma proporção
...
\noindent \medskip  \textit{Grandezas Diretamente Proporcionais (G.D.P):} duas
...
\noindent \medskip \textit{{Grandezas Inversamente Proporcionais (G.I.P)}:} duas grandezas
...
\noindent \medskip \textit{Regra de três simples direta e inversa:} usada para
