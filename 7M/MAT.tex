...
\item \parbox{4mm}{II} --- Todo número decimal finito pode ser representado por fração.
\item \parbox{4mm}{III} --- O número 21 é primo.
\item \parbox{4mm}{IV} ---  O número 2 é o único número que é par e primo.
\end{itemize}
...
fatores em pares de iguais: $(2 \cdot 2) \cdot (3 \cdot 3)$. A raiz quadrada
...
aproximações para obter uma ideia geral. Por exemplo, você pode dizer que a
raiz quadrada de $7$ está entre $2$ e $3$, pois $2 \cdot 2 = 4$ e $3 \cdot 3 = 9$, e $7$ está
