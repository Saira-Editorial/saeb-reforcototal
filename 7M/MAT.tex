...
\medskip\hfill\includegraphics[width=.7\textwidth]{./imgSAEB_7_MAT/triangulo.pdf}\hfill\medskip
...
\medskip\hfill\includegraphics[width=.6\textwidth]{./tikz/barchart.pdf}\hfill\medskip


{\textbf{Gráfico de colunas:} {Quantas maçãs foram produzidas em cada região?}}\\
\medskip\hfill\includegraphics[width=.6\textwidth]{./tikz/columnchart.pdf}\hfill\medskip
%{\centering \small \it Gráfico de colunas}

{\textbf{Gráfico de setores:} {Com o que sonham os alunos?}}\\
