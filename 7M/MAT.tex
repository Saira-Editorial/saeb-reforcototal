...
\reduline{Se a distância for constante, quanto maior a velocidade, menor será o tempo, ou seja, G.I.P. \hfill}
\linhas{1}
...
\begin{escolha}[itemsep=0pt]
\item Ângulos \preencher{colaterais internos} estão na região interna das paralelas e no mesmo lado
em relação à transversal.
\item Ângulos \preencher{alternos externos} estão na região externa das paralelas e em lados
contrários em relação à transversal.
\item Ângulos correspondentes estão em regiões \preencher{opostas} das paralelas e em
regiões \preencher{iguais} em relação à transversal.
\end{escolha}
...
\noindent{}Determine o caminho correto para o objeto chegar ao ponto B a partir do
ponto A.
...
\begin{escolha}[itemsep=0pt]
    ...
    \reduline{A média de vendas é dada por $\frac{30 + 58 + 63 + 21}{4} = \ 43$
...
\reduline{População: Turma do segundo ano;~amostra: 3 pessoas que usam óculos do segundo ano.\hfill} 
\item Eleitores no Brasil, eleitores de Minas Gerais \\
\reduline{População: Eleitores do Brasil; amostra: Eleitores de Minas Gerais.\hfill} 
\item Macacos, fauna \\
\reduline{População: Fauna; amostra: Eleitores de Minas Gerais.\hfill} 
...
estragarem nesse um ano?\enlargethispage{2\baselineskip}
