...
\begin{itemize}
\item Representação decimal: A representação decimal é baseada no sistema decimal, que utiliza dez dígitos (0 
...
\item Representação binária: A representação binária é baseada no sistema binário, que utiliza apenas dois 
...
\item Representação hexadecimal: A representação hexadecimal é baseada no sistema hexadecimal, que utiliza 
...
\item Representação de ponto flutuante: A representação de ponto flutuante é usada para representar números 
...
\item As representações numéricas são essenciais para realizar operações matemáticas, armazenar e transmitir 
...
\chapter{5. Equações polinomiais de 1º.
grau}
...
R: Utilizando a forma de soma dos termos iguais, temos que:
...
R: Utilizando as propriedades algébricas e as propriedades de potenciação,
temos que:
...
\chapter{7. Equações polinomiais de 2º.
grau}

\section{Habilidades do SAEB}

\begin{itemize}
  \item Inferir uma equação polinomial de 2º. grau que
modela um problema.
\item
...
\num{1} Determine a solução da equação x^2 + 4 = 0 no conjunto \mathbb{R}.

--R: x^2 + 4 = 0
--R: x^2 = - 4
--R: x = (\sqrt{-4})
--R: Como (\sqrt{- 4}) não existe no conjunto \mathbb{R}, não temos valores reais
--R: para x. Logo, a equação não tem raízes reais. Assim, S = 0.

\num{2} Resolva, no conjunto \mathbb{R}, a equação (2y + 1)^2 = 8 + 2(2y + 1).

--R: (2y + 1)(2y + 1) = 8 + 2(2y + 1)
--R: 4y^2 + 2y + 2y + 1 = 8 + 4y + 2
--R: 4y^2 + 4y + 1 = 10 + 4y
--R: 4y^2 + 4y - 4y + 1 - 10 = 0
--R: 4y^2 - 9 = 0
--R: y = ± (\sqrt{\frac{9}{4}}); y = ± (\frac{3}{2})
--R: Logo os números + (\frac{3}{2}) e (\frac{3}{2}) são as raízes da equação.
...
--R: x^2 - 100 = 0; x^2 = 100; x = ±10
--R: Como a idade não pode ser representada, com números negativos, temos que
--R: a idade do filho mais novo de Joana é 10 anos.
...
--R: x^2 - 5x + 4 = 0; a = 1; b = - 5; c = 4
--R: (\frac{- ( - 5) \pm \sqrt{{- 5}^{2} - 4.\ 1.4}}{2.1})
--R: (\frac{5 \pm \sqrt{25 - 16}}{2})
--R: (\frac{5 \pm \sqrt{9}}{2})
--R: x_1 = (\frac{5 + 3}{2}) = 4; x_2 = (\frac{5 - 3}{2}) = 1
--R: Logo, os tamanhos disponíveis de madeira são 1 metro e 4 metros.
...
--R: 2x^2 − 6𝑥 − 8 = 0; a = 2; b = -6; c = -8
--R: (\frac{- ( - 6) \pm \sqrt{{( - 6)}^{2} - 4.2.( - 8)}}{2.2})
--R: (\frac{6 \pm \sqrt{36 + 64}}{4})
--R: (\frac{6 \pm \sqrt{100}}{4})
--R: x_1= (\frac{6 + 10}{4}) = 4; x_2= (\frac{6 - 10}{4}) = -1
--R: Somando-se ambas as raízes, Raiane anda 3 km por dia para ir ao trabalho.
...
--R: x^2 + 4x + 3 = 0; a = 1; b = 4; c = 3
--R: (\frac{- 4 \pm \sqrt{4^{2} - 4.1.3}}{2.1})
--R: (\frac{- 4 \pm \sqrt{16 - 4.1.3}}{2.1})
--R: x_1= (\frac{- 4 + 4}{2}) = 0; x_2 = (\frac{- 4 - 4}{2}) = -4
--R: Multiplicando por 1.000, temos que -4 . 1000 = -4000
--R: Logo, Mateus deve R\$4.000,00 ao banco.
