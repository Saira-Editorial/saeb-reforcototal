...
\subsection{BNCC: EF08MA01 EF08MA02 EF08MA03}
...
\textbf{Potência de um número racional}
...
\textbf{Propriedades da Potenciação:}

\begin{itemize}
  \item 1a propriedade: Produto de potências de mesma base.
...
\item 2ª Propriedade: Quociente de potências de mesma base
...
\item 3ª propriedade: Potência de uma potência.
...
\item 4ª propriedade potência de um produto
...
\textbf{Raiz quadrada exata de um número racional não negativo}
...
\begin{escolha}
\item Eu Nasci Há 10² anos Atrás
\item Eu Nasci Há 10³ anos atrás
\item Eu Nasci Há 10\textsuperscript{4} anos atrás \rosa{(C)}
...
\textbf{Comparação de números racionais}
...
\textbf{Operações com números racionais}
\begin{itemize}
...
\item Fração geratriz de dízimas periódicas simples
