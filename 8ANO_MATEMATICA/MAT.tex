...
\item ((\frac{2}{3})^{4-1}) =
((\frac{2}{3}))^3=(\ (\frac{2}{3})).(\ (\frac{2}{3})).(\ (\frac{2}{3}))
= (\frac{8}{27})
...
\item ((\frac{1}{2})^{-3}) = (\frac{2}{1^3}) = (\frac{2}{1}) = 2
...
J= 207
\item A quantia de R\$2.450, aplicada durante 2 meses, a uma taxa de 1,96\%
ao mês?
...
2) Considerando que a^2+ b^2 = 34 e ab= 15, qual é o valor de
(\frac{(a + b)^2}{8}) ?
\item 2,266666666
\item 19
\item 8
...
3) O diâmetro de um disco de vinil é igual a (x^2 - 3). A partir desse
...
1) Determine a solução da equação x^2 + 4 = 0 no conjunto R.
...
2) Resolva, no conjunto R, a equação (2y + 1)^2 = 8 + 2(2y + 1).
...
5) A idade do filho mais novo de Joana é representado pela equação x^2 -
...
6) Um país situado no continente europeu tem cerca de 135.000 km^2 de
...
15) Dada a equação polinomial de 2º grau: x^2 - 4x + 3 = 0, determine as
...
7) Para representar a sua idade, Pedro utilizou a equação X^2 - 2 809 =
...
13) Para concluir o projeto de sua pipa, qual é a quantidade em m^2 de
...
8) Para cobrir 840 m^2 de um telhado, 14 operários, que apresentam a
...
12) Calcule o valor da expressão: 3^2 + raiz quadrada de 16.
\item 13
\item 11
\item 7
\item 10
