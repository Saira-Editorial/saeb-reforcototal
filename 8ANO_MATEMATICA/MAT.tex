...
C: correta, Ao decompor o número 1 000 em fatores primos obtemos 2^3 x 5³
...
\textsuperscript{a)~-} (( - \frac{1}{2}))\textsuperscript{^2} + (-1)
\textsuperscript{4}

\textsuperscript{b)} -- (2) ^3 \textsuperscript{.} (-2) ³
...
\item (-2,5)\textsuperscript{5} : (-2,5)^2
\item a\textsuperscript{9}: a\textsuperscript{8}, com a racional não nulo
\item 1\textsuperscript{8}:1^2
...
\item 3\textsuperscript{7-5}=3^2 = 3.3= 9
\item (-1)\textsuperscript{8-6}= (-1)^2= (-1).(-1)= +1
\item 
((\frac{2}{3}))\textsuperscript{4-1}=((\frac{2}{3}))³=(\ (\frac{2}{3})).(\ (\frac{2}{3})).(\ (\frac{2}{3}))=
(\frac{8}{27})

\item 2\textsuperscript{10}: 2¹= 2\textsuperscript{9}= 2.2.2.2.2.2.2.2.2=
572

\item (-2,5) \textsuperscript{5-2} = (-2,5)³= (-2,5). (-2,5). (-2,5)=
-15,625

\item a\textsuperscript{9-8}= a¹ =a
\item 1\textsuperscript{8-2}=1\textsuperscript{6}= 1.1.1.1.1.1=1
\item 3\textsuperscript{8-1}= 3\textsuperscript{7} = 3.3.3.3.3.3.3=2187
...
pedra tem o peso de {[}(-5)³{]}^2 kg, quanto pesa a pedra que Jandira
observou?
...
\item (-6)^3 \textsuperscript{.} (-8)³
\item (3,1)\textsuperscript{5~.}
...
\item (11 . 3)^2 = 33^2
\item ((-6) . (-8)) ³= 48³
\item (3,1 . 0,7 . 2) \textsuperscript{5}= 4,34\textsuperscript{5}

\num{7} Calcule o valor de cada potência com exponente negativo

\item 8\textsuperscript{-2}
\item 5\textsuperscript{-1}
\item (-2)\textsuperscript{-4}
\item ((\frac{1}{2}))\textsuperscript{-3}
\item (-3)\textsuperscript{-3}
\item (\left( \frac{1}{2} \right))\textsuperscript{-5}
...
\item 8\textsuperscript{-2}= (\frac{1}{8^2}) = (\frac{1}{64})
\item 5\textsuperscript{-1}= (\frac{1}{5¹}) = (\frac{1}{5})
\item (-2)\textsuperscript{-4} = (\ \frac{1}{2})\textsubscript{4}
=(\ \frac{1}{16})

\item (\ (\frac{1}{2}))\textsuperscript{-3}= (\frac{2}{1³}) =
(\frac{2}{1}) = 2

\item (-3)\textsuperscript{-3}= (- \frac{1}{3³}) = (\frac{1}{27})
\item (\ \frac{1}{2})\textsuperscript{-5} =
(\frac{2}{1})\textsubscript{5} = (\frac{2}{1}) = 2

\num{8} Calcule as seguintes potencias de base 10 e coloque as em forma
decimal

\item 10\textsuperscript{6}
\item 10\textsuperscript{-6}
\item 10\textsuperscript{-4}
\item 10\textsuperscript{4}
\item 10\textsuperscript{-2}
\item 10 \textsuperscript{-5}
\item 10\textsuperscript{10}
\item 10\textsuperscript{-8}
...
\item (\ \sqrt{256})= 16, 16 \textsuperscript{.} 4 = perímetro= 64
\item (\ \sqrt{225}) = 15, 15\textsuperscript{.}4 = perímetro = 60
\item (\ \sqrt{144}) = 12, 12\textsuperscript{.}4= perímetro= 48
\item (\ \sqrt{64})= 8, 8\textsuperscript{.}4= perímetro 32
\item (\ \sqrt{36})= 6, 6\textsuperscript{.}4=perímetro= 24
\item (\sqrt{16})= 4, 4\textsuperscript{.}4=perímetro =16
...
\item Eu Nasci Há 10\textsuperscript{4} anos atrás
\item Eu Nasci Há 10\textsuperscript{5} Anos Atrás
...
\item 0,5 . 12,7 = (\frac{5}{10}) . (\frac{127}{10}) =
(\frac{635}{100})

\item 3,6 . 6,7 = (\frac{35}{10}) . (\frac{67}{10})
\item 9,3 . 13,25 = (\frac{93}{10}) . (\frac{1325}{100}) =
(\frac{123\ 225}{1\ 000})

\item 2,9 . 3,8 = (\frac{29}{10}) . (\frac{38}{10}) =
(\frac{1102}{100})

\item 11,2 . 4,2= (\frac{112}{10}) . (\frac{42}{10}) =
(\frac{4\ 704}{100})

\item 7,5 . 6,6 = (\frac{75}{10}) . (\frac{66}{10}) =
(\frac{4950}{100})

\item 0,456 . 0,345 = (\frac{456}{1\ 000}) . (\frac{345}{1\ 000}) =
(\frac{157\ 320}{1\ 000\ 000})

\item 0,01 . 0,001= (\frac{1}{100}) . (\frac{1}{1\ 000}) =
(\frac{1}{100\ 000})
...
\item 0,5 : 3,4 = (\frac{5}{10}) : (\frac{34}{10}) = (\frac{5}{10}) .
(\frac{10}{34}) = (\frac{50}{340})

\item 9,4 : 3,1 = (\frac{94}{10}) : (\frac{31}{10}) = (\frac{94}{10})
. (\frac{10}{31}) = (\frac{940}{310})

\item 5,1 : 0,2 = (\frac{51}{10}) : (\frac{2}{10}) = (\frac{51}{10})
. (\frac{10}{2}) = (\frac{510}{20})

\item 0,2 : 0,1 = (\frac{2}{10}) : (\frac{1}{10}) = (\frac{2}{10}) .
(\frac{10}{1}) = (\frac{20}{10}) = 2

\item 0,01 : 0,001= (\frac{1}{100}) : (\frac{1}{1\ 000}) =
(\frac{1}{100}) . (\frac{1\ 000}{1}) = (\frac{1\ 000}{100}) = 10

\item 2,1 : 0,5 = (\frac{21}{10}) : (\frac{5}{10}) = (\frac{21}{10})
. (\frac{10}{5}) = (\frac{210}{50})

\item 4,2 : 0,1= (\frac{42}{10}) : (\frac{1}{10}) = (\frac{42}{10}) .
(\frac{10}{1})= (\frac{420}{10}) = 42

\item 3,1: 1,5 = (\frac{31}{10}) : (\frac{15}{10}) = (\frac{31}{10})
...
x = parte literal parte literal x^2y^2 parte literal a³b^2
...
\item considerando que a área do retângulo é l \textsuperscript{.} l e que
o lado maior = x+4
...
\item 57 . 63 = (60-3). (60+3) = 60^2 - 3^2 = 3591
\item 52 . 48= ( 50 +2 ) . (50-2) = 50^2 - 2^2 = 2496
\item 42 . 34= (38 + 4) . (38 -- 4) = 38^2 - 4^2 =1428
...
\item 6x\textsuperscript{4}+ 12x\textsuperscript{6}
\item 10xy-xy
\item (6x³) . (2x^2)
\item (14x\textsuperscript{10)}: (2x^2)
\item (2x³)³
\item (-4xy^2) ³
\item (\frac{30x}{6x}) para x diferente de 0
\item 6x^2 - 8x^2
\item ((\frac{4}{5}x))\textsuperscript{-1}
\item 9x^2 + 6x^2
\item 7x^2 + 4x
...
\item 6x\textsuperscript{4}+ 12x\textsuperscript{6}=18x\textsuperscript{10}
\item 10xy-xy= 9xy
\item (6x³) . (2x^2)=12x\textsuperscript{5}
\item (14x\textsuperscript{10)}: (2x^2)=7x\textsuperscript{8}
\item (2x³)³= 2x\textsuperscript{9}
\item (-4xy^2) ³= -4xy\textsuperscript{6}
\item (\frac{30x}{6x}) para x diferente de 0 = 5x
\item 6x^2 - 8x^2 = -2x^2
\item ((\frac{4}{5}x))\textsuperscript{-1}=+ (\frac{5}{4})
...
\item Área = 3x\textsuperscript{4} - 18x^2 - 27 Perímetro= 6x^2 - 18
\item Área = 3x\textsuperscript{4} - 18x^2 + 27 Perímetro= 6x^2 + 18
\item Área = 3x\textsuperscript{4} + 18x^2 + 27 Perímetro= 6x^2 - 18
\item Área = 3x\textsuperscript{4} - 18x^2 + 27 Perímetro= 6x^2 - 18
...
A= 3 . (x\textsuperscript{4} -- 6x^2 + 9)

A= 3x\textsuperscript{4}- 18x^2 + 27
...
\num{4} . Um bloco maciço de madeira tem 54 kg de massa e ocupa um volume de
...
\num{5} . Um fio de cobre utilizado na fiação de uma casa comum ocupa um
...
\num{5} Utilizando a fórmula S\textsubscript{i} = (n-2) . 180°, calcule a
...
\num{6} Utilizando a fórmula S\textsubscript{i} = (n-2) . 180°, calcule o
...
\num{0} Calcule o valor de x nas figuras abaixo
...
\item 9,11 \textsuperscript{.} 10\textsuperscript{-29}
\item 9,11 \textsuperscript{.} 10\textsuperscript{-28}
\item 9,11 \textsuperscript{.} 10 \textsuperscript{-27}
\item 9,11 \textsuperscript{.} 10 \textsuperscript{-26}
...
(X^2+2x+2x+4)\textsuperscript{.} (x+2)=

(x^2 + 4x +4) \textsuperscript{.} (x+2)=
...
(3x^2 +2x+6x +4) \textsuperscript{.}(7x+2)=

(3x^2+8x +4 ) \textsuperscript{.}(7x+2)=

21x³+ 6x^2 +56x^2 +16x +28x +8=
...
\item 4,0 \textsuperscript{.}10\textsuperscript{-10}
\item 2,0\textsuperscript{.} 10\textsuperscript{-5}
\item 4,0 \textsuperscript{.} 10\textsuperscript{-5}
\item 2,0\textsuperscript{.}10 \textsuperscript{-10}
...
Logo temos que a área do Nano chip em cm^2 é 4,0 \textsuperscript{.}
10\textsuperscript{-10}
...
X^2 - x -- 42 = 0, sendo assim há quantos anos Alfredo já está na
...
\item A potência 3\textsuperscript{5}
...
\item 3a\textsuperscript{4}+ 6a³b+ 3a^2b^2
\item 6a^2b+ 9 ab\textsuperscript{4}
\item 5ab\textsuperscript{6}
\item 3a\textsuperscript{4}+ 6a³+ 3a^2b^2
...
3a\textsuperscript{4}+ 6a³b+ 3a^2b^2
