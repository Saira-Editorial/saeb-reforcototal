...
é representado como a soma de $3 \times 10^2 + 5 \times 10^1 + 8 \times 10^0$.
...
número binário 101 é representado como a soma de $1 \times 2^2 + 0 \times 2^1 + 1 \times 2^0$, que é igual a 5 em decimal.
...
$2 \times 16^1 + A x 16^0$, onde $A$ tem o valor de $10$ em decimal. Portanto, $2A$ em hexadecimal é igual a $42$ em decimal.
...
\reduline{Sim, pois $121 = 11 \times 11$.\hfill}
...
\reduline{ $(\sqrt{2} \times \sqrt{2} = \sqrt{2}^2 = 2)$ e também $(\frac{\sqrt{2}}{\sqrt{2}} = 1)$\hfill}
...
\reduline{ $5$, pois $5\times 125 = 625$ e $(\sqrt{625}) = 25$.\hfill}
...
(a^n = \frac{a \times a \times a \times a \times a\ x \ldots x\ a}{n\ \text{fatores}})
...
\reduline{ 9:0,6 = 15; (15 \times 15 = 225 \;ladrilhos)\hfill}
...
\reduline{ de reescrever seria (8 \times 10^9).\hfill}
...
++R:
\item
  (\sqrt{256} = 16, 16 \times 4 = perímetro = 64)
\item
  (\sqrt{225}) = 15, 15 \times 4 = perímetro = 60
\item
  (\sqrt{144}) = 12, 12 \times 4 = perímetro= 48
\item
  (\sqrt{64}) = 8, 8 \times 4 = perímetro = 32
\item
  (\sqrt{36}) = 6, 6 \times 4 = perímetro = 24
\item
  (\sqrt{16}) = 4, 4 \times 4 = perímetro = 16
...
++R:
\item 0,5 \times 12,7 = (\frac{5}{10}) . (\frac{127}{10}) = (\frac{635}{100})
\item 3,6 \times 6,7 = (\frac{35}{10}) . (\frac{67}{10})
\item 9,3 \times 13,25 = (\frac{93}{10}) . (\frac{1325}{100}) = (\frac{123\ 225}{1\ 000})
\item 2,9 \times 3,8 = (\frac{29}{10}) . (\frac{38}{10}) = (\frac{1102}{100})
\item 11,2 \times 4,2= (\frac{112}{10}) . (\frac{42}{10}) = (\frac{4\ 704}{100})
\item 7,5 \times 6,6 = (\frac{75}{10}) . (\frac{66}{10}) = (\frac{4950}{100})
\item 0,456 \times 0,345 = (\frac{456}{1\ 000}) . (\frac{345}{1\ 000}) = (\frac{157\ 320}{1\ 000\ 000})
\item 0,01 \times 0,001= (\frac{1}{100}) . (\frac{1}{1\ 000}) = (\frac{1}{100\ 000})
...
++R:
\item (\frac{125}{30} = \frac{100}{x}); 125 . x = 30 \times 100; 125x = 3000; x = 24 \%
\item (\frac{125}{18} = \frac{100}{x}); 125 . x = 100 \times 18; 125x = 1800; x = 14,4\%
\item (\frac{125}{45} = \frac{100}{x}); 125 x = 4500; x = 36\%
\item (\frac{125}{32} = \frac{100}{x}); 125 . x = 32 \times 100; 125x = 3200; x = 25,6\%
...
--R; (\frac{x}{2178} = \frac{100}{110}); Logo, x . 110 = 2178 \times 100; 110x = 217 800; x = 1980
...
\reduline{ Ótimo. (\frac{250}{105} = \frac{100}{x}); 250 . x = 100 \times 105; 250x = 10 500; x = 42\% \hfill}
\reduline{ Bom: (\frac{250}{100} = \frac{100}{x})\hfill}
\reduline{ 250 . x = 100 \times 100; 250x= 10 000; X= 40 \%\hfill}
\reduline{ Regular: (\frac{250}{30} = \frac{100}{x}); 250.x=100 .30; 250x = 3000; x = 12 \%; \hfill}
\reduline{ (\frac{250}{15} = \frac{100}{x}); 250x = 100 \times 15; 250 x = 1500; x = 6 \%\hfill}
...
\reduline{ Logo 10.000 . x = 16.000 \times 1.000\hfill}
...
\reduline{ Logo 150 . x = 12 \times 100; 150 x = 1.200; x = 8 \%\hfill}
...
\reduline{ Logo, 3.200 . x = 1.440 \times 100; 3.200x = 144.000; x = 45\% de meninos. Logo, 55\% são meninas.\hfill}
...
\reduline{ R: Utilizando a regra de 3 simples, temos que:\hfill}
\reduline{ (\frac{50}{38} = \frac{100}{x}). Logo 50 . x = 38 \times 100; 50x = 3.800; x = 76\%, logo, Magda foi reprovada.\hfill}
...
\reduline{ R: Utilizando a regra de 3 simples, temos que:\hfill}
\reduline{ (\frac{40}{5} = \frac{100}{x}). Logo 40 . x = 5 \times 100; 40x = 500; x = 12,5\% de faltas.\hfill}
...
\reduline{ Logo, 22x = 100 \times 5; 22x = 500; x = 22,72 \%\hfill}
...
\reduline{x = 2y - 4  \Rightarrow  x= 2 \times 16 - 4  \Rightarrow  x = 28}
...
\reduline{ 6x+ y = 71; 6 \times 9 + y = 71; 54 + y = 71; y = 17\hfill}
...
outra forma de calcular a operação (41 \times 39) e escreveu seus cálculos na
lousa assim:

41 \times 39 = (40 + 1) (40 - 1) = 40^2 - 1^2 = 1.599
...
R:
\item 57 \times 63 = (60 - 3). (60 + 3) = 60^2 - 3^2 = 3.591
\item 52 \times 48 = (50 + 2) . (50 - 2) = 50^2 - 2^2 = 2.496
\item 42 \times 34 = (38 + 4) . (38 - 4) = 38^2 - 4^2 = 1.428
...
\reduline{ Multiplicando por 1.000, temos que -4 \times 1000 = - 4000. Logo, Mateus deve R\$\,4.000,00 ao banco.\hfill}
...
\reduline{ Como a escala é de 1 : 16.000, temos que:\hfill}
\reduline{ Comprimento 5,5 \times 16.000 = 88.000 cm\hfill}
\reduline{ Largura 3,125 \times 16.000 = 50.000 cm\hfill}
...
\reduline{ 180 \times 46 = 30 . x\hfill}
...
\reduline{ 40.075 km : 80 dias = aproximadamente 501 km por dia.\hfill}
...
Contando 5 dias trabalhados na semana, 12 \times 5 = R\$\,60,00 por semana.
...
\reduline{ 8 \times 100.000 = 800.000 km\hfill}
...
++R:
\item 4 \times 3 = 12 cm
\item 3 \times 3 = 9 cm^2
\item 3 \times 3 . 3 = 27 cm^3
...
++R:
\item 8 \times 8 = 64 cm^2
\item 12 \times 12 = 144 cm^2
\item16 \times 16= 256 m^2
\item20 \times 20 = 400 m^2
\item34 \times 34= 1156 m^2
\item 8 \times 8 = 64 mm^2
\item 10 \times 10 = 100 mm^2
...
\reduline{ 10 \times 15 + 10 \times 15 + 10 \times 30 + 10 \times 30 + 15 \times 30 = A\hfill}
...
\reduline{ V = 3 \times 14 \times 11\hfill}
...
\reduline{ V = \frac{4 \times 12 \times 3}{2}\hfill}
...
\reduline{ V_1 = 20 \times 10 \times 15\hfill}
...
\reduline{ V = 8 \times 5 . 1,5 = 60 m^3\hfill}
\reduline{ 60 m^3 = 60 000 litros \times 0,20 centavos\hfill}
...
\reduline{ V= (\Pi) . R^2 .h\hfill}
\reduline{ V= 3,14 \times 1,5^2 \times 140\hfill}
\reduline{ V= 3,14 \times 2,25 \times 140\hfill}
...
\reduline{ 12 \times 8 . 3= 288 maneiras diferentes.\hfill}
...
(0,000000000000000000000000000911 = 9,11 \times 10^{-28})
...
Como x é o dobro de y, temos: x = 2y = 2 \times 26 = 52
...
mundo em formato de um quadrado de lados de (2,0 \times 10 ^{-5 cm}) de
...
Logo temos que a área do Nano chip em cm^2 é (4,0 \times 10^{-10})
...
5 \times 5 . 10 \times 10 \times 10 \times 10 = 250.000 possibilidades de senhas diferentes.
...
B: Correta, pois
(\frac{2}{4} = \frac{(2 \times 2)} {(4 \times 2)} = \frac{4}{8} > \frac{3}{8})
...
3 \times 3 = 9. (\sqrt 16) é 4. Assim, a expressão pode ser reescrita como
9 + 4 = 13.
