...
% Felipe, dá uma olhada aqui pra ver o que vc prefere
% <<<<<<< HEAD
\conteudo{
\smallskip\noindent\textbf{Porcentagem}\quad
Porcentagem é a divisão por cem de algo a ser calculado.

Exemplo:

\begin{escolha}[itemsep=0pt]
\item 30\% de uma jarra de suco
\item 40\% de uma barra de chocolate
\item 25\% de água de um balde
\end{escolha}
...
$(\frac{- ( - 5) \pm \sqrt{{- 5}^{2} - 4.\ 1.4}}{2.1})$;$(\frac{5 \pm \sqrt{25 - 16}}{2})$;
$(\frac{5 \pm \sqrt{9}}{2})$;$(\frac{5 \pm 3}{2})$
$(X_1) = (\frac{5 + 3}{2})= (\frac{8}{2}) = 4; (X~2~) = (\frac{5 - 3}{2})= (\frac{2}{2})=1$
...
$$(\text{Escala} =\frac{\text{comprimento de um desenho}} {\text{comprimento\ real}})$$
...
$$(\text{densidade} = \frac{\text{massa\ do\ corpo}}{\text{volume\ do\ corpo}})$$
...
\item 2 horas e 42 minutos \rosa{-- X}
...
\smallskip\noindent\textbf{Classificação de triângulos}
\quad
...
\num{9} sCalcule as medida do ângulos destacados abaixo, considerando que as
...
\item às bissetrizes do triângulo. \rosa{-- X}
\end{escolha}
...
$$\text{Distância} = \text{Velocidade média} \times \text{tempo.}$$
}
...
++R:
\item $7 + 6,5 + 9 + 8 = 30,5; 30,5 \div 4 = 7,625$
\item $3 + 5 + 6 + 5 = 19; 19 \div 4 = 4,75$
\item $9 + 9 + 8 + 9 = 35; 35 \div 4 = 8,75$
\item $10 + 8 + 8 + 8 = 34; 34 \div 4 = 8,5$
\item $5 + 4 + 5 + 3 = 17; 17 \div 4 = 4,25$
...
\item $16 \cdot 16= 256 m^2$
\item $20 \cdot 20 = 400 m^2$
\item $34 \cdot 34= 1156 m^2$
...
Qual é o volume dessa nova caixa d'água? Considere (\text{\Pi}) = 3,1
...
\conteudo{
\smallskip\noindent\textbf{Experimentoaleatório}
\quad
...
\item $(P(E)\frac{n(49)}{n(60)}) = (\frac{49}{60}) ou 81\%$ aproximadamente.
