...
--R: R: Como a escala é de 1 : 16.000, temos que:
--R: Comprimento 5,5 . 16.000 = 88.000 cm
--R: Largura 3,125 . 16.000 = 50.000 cm
--R: Transformando em metros, temos que
--R: Comprimento = 880 m
...
--R: R: Utilizando a razão da densidade, que é (d = \frac{m}{v}), temos que
--R: (d = \frac{54}{3}); d = 18 kg/m^3
...
--R: R: Utilizando a razão da densidade demográfica, que é
--R: (densidade\ demográfica = \frac{número\ de\ pessoas\ }{dimensão\ do\ espaço\ em\ km^2}), temos que:
--R: (densidade\ demográfica = \frac{12\ 200\ 000}{135\ 000})
--R: (densidade\ demográfica =) 90,37 Habitantes/ km^2
...
--R: R: Utilizando a Regra de 3 simples. temos que:
--R: (\frac{5}{8} = \frac{20}{x}); 5 . 20 = 8 . x; 100 = 8x; X= 12,5
...
--R: 187 200 = x . 50; x = 3744 pães são produzidos
...
(\frac{180}{x} = \frac{46}{30}); 180 . 46 = 30 . x; 8280 = 30x; x = 276
...
\num{4} Utilizando a Fórmula (d = \ \frac{n(n - 3)}{2}), calcule o número
...
R: Considerando que a Área do triangulo retângulo é definida por A=
...
R: Calculando o volume, temos que
...
R: (\frac{5!}{3!.2!}) = (\frac{120}{6\ .\ 2}) = (\frac{120}{12}) = 10
