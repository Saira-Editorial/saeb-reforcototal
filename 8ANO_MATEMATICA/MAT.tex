...
Perímetro = 4x + 8
\item considerando que a área do retângulo é l \cdot l, que o lado maior = x +
4 e o lado menor = x:
x + 4 \cdot x =
(x+4) \cdot x
X^2 + 4x
...
\item 52 \cdot 48 = (50 + 2) \cdot (50 - 2) = 50^2 - 2^2 = 2.496
\item 42 \cdot 34 = (38 + 4) \cdot (38 - 4) = 38^2 - 4^2 = 1.428
...
\reduline{ 2𝑥^2 − 6𝑥 − 8 = 0; A = 2; B = -6; C = -8\hfill}
...
++R:
\item 1080 = (n-2) \cdot 180°
(\frac{1080}{180})= n - 2
6 = n - 2
n = 8

\item 1980 = (n-2) \cdot 180°
(\frac{1980}{180}) = n - 2
11 = n - 2
n = 13

\item 2340 = (n-2) \cdot 180°
(\frac{2340}{180}) = n - 2
13 = n - 2
n = 15

\item 1800 = (n-2) \cdot 180°
(\frac{1800}{180}) = n - 2
10 = n - 2
n = 12
