...
(a^n) =
(\frac{a \times a \times a \times a \times a\ x \ldots x\ a}{n\ \text{fatores}})
...
\reduline{ 9:0,6 = 15; (15 . 15 = 225 \;ladrilhos)\hfill}
...
\reduline{ de reescrever seria (8 . 10^9).\hfill}
...
\reduline{ Ótimo. (\frac{250}{105} = \frac{100}{x}); 250 . x = 100 . 105; 250x = 10 500; x = 42\% \hfill}
\reduline{ Bom: (\frac{250}{100} = \frac{100}{x})\hfill}
\reduline{ 250 . x = 100 . 100; 250x= 10 000; X= 40 \%\hfill}
\reduline{ Regular: (\frac{250}{30} = \frac{100}{x}); 250.x=100 .30; 250x = 3000; x = 12 \%; \hfill}
\reduline{ (\frac{250}{15} = \frac{100}{x}); 250x = 100 . 15; 250 x = 1500; x = 6 \%\hfill}
...
\reduline{ Logo 10.000 . x = 16.000 . 1.000\hfill}
...
\reduline{ Logo 150 . x = 12 . 100; 150 x = 1.200; x = 8 \%\hfill}
...
\reduline{ Logo, 3.200 . x = 1.440 . 100; 3.200x = 144.000; x = 45\% de meninos. Logo, 55\% são meninas.\hfill}
...
\reduline{ R: Utilizando a regra de 3 simples, temos que:\hfill}
\reduline{ (\frac{50}{38} = \frac{100}{x}). Logo 50 . x = 38 . 100; 50x = 3.800; x = 76\%, logo, Magda foi reprovada.\hfill}
...
\reduline{ R: Utilizando a regra de 3 simples, temos que:\hfill}
\reduline{ (\frac{40}{5} = \frac{100}{x}). Logo 40 . x = 5 . 100; 40x = 500; x = 12,5\% de faltas.\hfill}
...
\reduline{ Logo, 22x = 100 . 5; 22x = 500; x = 22,72 \%\hfill}
...
\reduline{ 6x+ y = 71; 6 . 9 + y = 71; 54 + y = 71; y = 17\hfill}
...
\reduline{ Multiplicando por 1.000, temos que -4 . 1000 = - 4000. Logo, Mateus deve R\$\,4.000,00 ao banco.\hfill}
...
\reduline{ Comprimento 5,5 . 16.000 = 88.000 cm\hfill}
\reduline{ Largura 3,125 . 16.000 = 50.000 cm\hfill}
...
\reduline{ 10 . 15 + 10 . 15 + 10 . 30 + 10 . 30 + 15 . 30 = A\hfill}
...
\reduline{ V = \frac{4 . 12 . 3}{2}\hfill}
...
\reduline{ V = 8 . 5 . 1,5 = 60 m^3\hfill}
...
\reduline{ V= (\Pi) . R^2 .h\hfill}
\reduline{ V= 3,14 . 1,5^2 . 140\hfill}
\reduline{ V= 3,14 . 2,25 . 140\hfill}
...
\reduline{ 12 . 8 . 3= 288 maneiras diferentes.\hfill}
