...
$$(a^n = \frac{a \times a \times a \times a \times a \times \ldots \times a}{n})$$
...
\item $(\left - \frac{1}{2} \right) \times (\left + \frac{3}{2} \right) - \left ( \frac{2}{3} \right)^{3} / \left ( - \frac{1}{27}) \right)$  \rosa{$(8 \times \frac{3}{8})$}
\item $(0,1) ^2 / (-2) + (1,5) \times (-0,1)^2$ \rosa{$0,01$}
\end{escolha}
...
\item $((-1^{8 - 6} = -1^2= -1\times-1= +1)$
\item $((\frac{2}{3})$^{4-1}) = $((\frac{2}{3})$)^3=$(\ (\frac{2}{3})$)\times(\ (\frac{2}{3}))\times(\ (\frac{2}{3})) = (\frac{8}{27})
\item (2^{10} / 2^1 = 2^9 = 2.2.2.2.2.2.2.2.2 = 572)
