...
\coment{
\textbf{Números irracionais}\quad 
...
c 121, pois 11\times 11 = 121

\num{9} O produto ou o quociente de dois números irracionais pode ser um
número racional?

Resposta: Sim, como exemplos pode ser citado (\sqrt{2})\times (\sqrt{2})
= ((\sqrt{2}))^2 = 2 e também (\frac{\sqrt{2}}{\sqrt{2}}) = 1
...
Resposta, alternativa D, pois 5\times 125 = 625 e (\sqrt{625}) = 25 logo
...
\item 0,57 = (\frac{57}{100})
\item 1,29 = (\frac{129}{100})
\item 3,124 = (\frac{3124}{1000})
\item -- 32,40= - (\frac{324}{10})
\item 0,9 = (\frac{9}{10})
\item 0,650 = (\frac{65}{100})
\item 1,342 = (\frac{1342}{1000})
\item 5,09409 = (\frac{509\ 409}{100\ 000})
...
C: correta, Ao decompor o número 1 000 em fatores primos obtemos 2^3\times 5^3
...
A^n = (\frac{a\ x\ a\ x\ a\ x\ a\ x\ a\ x\ldots x\ a}{n\ \text{fatores}})
...
A raiz quadrada de 25 é 5, pois 5\times 5 = 52 = 25 Logo (\sqrt{25}) = 5

A raiz quadrada de 49 é 7, pois 7\times 7 = 72 = 49. Logo (\sqrt{49}) = 7
...
\item 3^7-5=3^2 = 3\times 3= 9
\item (-1)^8-6= (-1)^2= (-1).(-1)= +1
\item 
((\frac{2}{3}))^4-1=((\frac{2}{3}))^3=(\ (\frac{2}{3})).(\ (\frac{2}{3})).(\ (\frac{2}{3}))=
(\frac{8}{27})

\item 2^10: 2^1= 2^9= 2\times 2.2\times 2.2\times 2.2\times 2.2=572

\item (-2,5) ^5-2 = (-2,5)^3= (-2,5). (-2,5). (-2,5) = -15,625

\item a^9-8= a^1 =a
\item 1^8-2=1^6= 1\times 1.1\times 1.1\times 1=1
\item 3^8-1= 3^7 = 3\times 3.3\times 3.3\times 3.3=2187
...
\item (10\times 2)^2 = 20^2
\item (11\times 3)^2 = 33^2
\item ((-6)\times (-8))^3= 48^3
\item (3,1\times 0,7\times 2) ^5= 4,34^5
...
\item 8^-2= (\frac{1}{8^2}) = (\frac{1}{64})
\item 5^-1= (\frac{1}{5^1}) = (\frac{1}{5})
\item (-2)^-4 = (\ \frac{1}{2})\textsubscript{4} =(\ \frac{1}{16})

\item (\ (\frac{1}{2}))^-3= (\frac{2}{1^3}) =
(\frac{2}{1}) = 2

\item (-3)^-3= (- \frac{1}{3^3}) = (\frac{1}{27})
\item (\ \frac{1}{2})^-5 =
...
8\times 10^9 sendo assim ocupando um
menor espaço.
...
\item (\sqrt{256})= 16, 16\times 4 = perímetro= 64
\item (\sqrt{225}) = 15, 15\times 4 = perímetro = 60
\item (\sqrt{144}) = 12, 12\times 4= perímetro= 48
\item (\sqrt{64})= 8, 8\times 4= perímetro 32
\item (\sqrt{36})= 6, 6\times 4=perímetro= 24
\item (\sqrt{16})= 4, 4\times 4=perímetro =16
...
10000 = 10\times 10\times 10\times 10 ou seja 10^4
...
\item (- \frac{8}{5}) + 2,5 = -(\ \frac{8}{5}) + (\frac{25}{10}) =
(\frac{- 16}{10})+(\frac{25}{10}) = (\frac{9}{10})

\item (\frac{14}{3}) + (\frac{19}{5})= (\frac{70}{15}) +
(\frac{57}{15}) = (\frac{127}{15})

\item - (\frac{8}{13}) - (\frac{3}{5}) = (- \frac{40}{65}) -
(\frac{39}{65}) = - (\frac{79}{65})

\item 79,02 -- (\frac{12}{5}) = (\frac{7\ 902}{100}) - (\frac{12}{5})
= (\frac{7\ 902}{100}) - (\frac{240}{100}) = (\frac{7\ 662}{100})

\item 125 - (\frac{35}{4}) = (\frac{125}{1}) - (\frac{35}{4}) =
(\frac{500}{4}) - (\frac{35}{4}) = (\frac{465}{4})

\item (\frac{49}{7}) + (\frac{2}{3}) = (\frac{147}{21}) +
(\frac{14}{21}) = (\frac{161}{21})

\item 50 - (\frac{1}{2}) = (\frac{50}{1}) - (\frac{1}{2}) =
(\frac{100}{2}) - (\frac{1}{2}) = (\frac{99}{2})

\item 100 - (\frac{1}{3}) = (\frac{100}{1}) - (\frac{1}{3}) =
...
\item 11,2\times 4,2
\item 7,5\times 6,6
\item 0,456\times 0,345
\item 0,01\times 0,001

Em cada item acima deixar o espaço de 2 linhas para resposta.

Respostas:

\item 0,5\times 12,7 = (\frac{5}{10})\times (\frac{127}{10}) = (\frac{635}{100})
\item 3,6\times 6,7 = (\frac{35}{10})\times (\frac{67}{10})
\item 9,3\times 13,25 = (\frac{93}{10})\times (\frac{1325}{100}) = (\frac{123\ 225}{1\ 000})
\item 2,9\times 3,8 = (\frac{29}{10})\times (\frac{38}{10}) = (\frac{1102}{100})
\item 11,2\times 4,2= (\frac{112}{10})\times (\frac{42}{10}) = (\frac{4\ 704}{100})
\item 7,5\times 6,6 = (\frac{75}{10})\times (\frac{66}{10}) = (\frac{4950}{100})
\item 0,456\times 0,345 = (\frac{456}{1\ 000})\times (\frac{345}{1\ 000}) = (\frac{157\ 320}{1\ 000\ 000})
\item 0,01\times 0,001= (\frac{1}{100})\times (\frac{1}{1\ 000}) = (\frac{1}{100\ 000})
...
\item 0,01 : 0,001= (\frac{1}{100}) : (\frac{1}{1\ 000}) = (\frac{1}{100})\times (\frac{1\ 000}{1}) = (\frac{1\ 000} 100}) = 10
...
\includegraphics[width=2\times 37378in,height=4\times 29167in]{./imgSAEB_8_MAT/media/image3.png}
...
\item o número de ouro representado pelo número 1\times 61803399... é considerado
...
Logo 10 000\times \times = 16 000\times 1000
...
Logo 150\times \times = 12\times 100
...
Logo, 3200\times \times = 1440\times 100
...
Logo 200\times \times = 100\times 120
...
6 000 = 120 000\times 0,01\times x
...
\item Escreva uma expressão algébrica que represente o valor a pagar nessa
...
41\times 39 = (40+1) (40-1) = 40^2 - 1^2 = 1599
...
\item 57\times 63 = (60-3). (60+3) = 60^2 - 3^2 = 3591
\item 52\times 48= ( 50 +2 )\times (50-2) = 50^2 - 2^2 = 2496
\item 42\times 34= (38 + 4)\times (38 -- 4) = 38^2 - 4^2 =1428
...
\item (2x^3)^3
\item (-4xy^2)^3
\item (\frac{30x}{6x}) para\times diferente de 0
\item 6x^2 - 8x^2
\item ((\frac{4}{5}x))^-1
\item 9x^2 + 6x^2
\item 7x^2 + 4x
...
\item (2x^3)^3= 2x^9
\item (-4xy^2)^3= -4xy^6
\item (\frac{30x}{6x}) para\times diferente de 0 = 5x
\item 6x^2 - 8x^2 = -2x^2
...
(\frac{34 + (2\times 15)}{8} =) (\frac{34 + 30}{8}) = (\frac{64}{8}) = 8
...
Multiplicando por 1 000, temos que -4\times 1000 = - 4000
...
Comprimento 5,5\times 16 0000= 88 000 cm

Largura 3,125\times 16 000 = 50 000 cm
...
\item 20 m/s\times 3,6= 72 km/h
\item 100 m/s\times 3,6= 360km/h
\item 55 m/s\times 3,6= 198 km/h
\item 67 m/s\times 3,6= 241,2 km/h
\item 90 m /s\times 3,6= 324 km/h
\item 25 m/s\times 3,6= 90 km/h
\item 30 m/s .3,6= 108 km/h
\item 40 m/s\times 3,6= 144km/h
...
Utilizando a fórmula S\textsubscript{i} = (n-2)\times 180°, podemos
...
Utilizando a fórmula S\textsubscript{i} = (n-2)\times 180° temos que

\item Quadrilátero

S\textsubscript{i} = (4-2)\times 180°

S\textsubscript{i=} 2\times 180 °

S\textsubscript{i}= 360°

\item Pentágono

S\textsubscript{i} = (5-2)\times 180°

S\textsubscript{i}= 3\times 180

S\textsubscript{i}= 540

\item Eneágono

S\textsubscript{i} = (9-2)\times 180°

S\textsubscript{i} = 7\times 180°

S\textsubscript{i} = 1260°

\item Icoságono

S\textsubscript{i} = (20-2)\times 180°

S\textsubscript{i} = 18\times 180°

S\textsubscript{i} = 3240°

\item Dodecagono

S\textsubscript{i} = (12-2)\times 180°

S\textsubscript{i} = 10\times 180
...
\includegraphics[width=2\times 98681in,height=2\times 57292in]{./imgSAEB_8_MAT/media/image12.png}
...
20\times 30 cm = 600 cm de fita ou 6 metros de fita
...
\includegraphics[width=2\times 73958in,height=1\times 54167in]{./imgSAEB_8_MAT/media/image23.png}
...
\includegraphics[width=2\times 73952in,height=2\times 725in]{./imgSAEB_8_MAT/media/image36.png}
...
\includegraphics[width=3\times 55in,height=3\times 406in]{./imgSAEB_8_MAT/media/image37.png}
...
\includegraphics[width=2\times 2in,height=2\times 2in]{./imgSAEB_8_MAT/media/image38.png}
...
Contando 5 dias trabalhados na semana 12\times 5 = 60 reais por semana
...
8\times 100 000 = 800 000 km foi o deslocamento.
...
Resposta: 8km\times 38 partidas = 304 km por campeonato
...
\includegraphics[width=3\times 65in,height=2\times 98179in]{./imgSAEB_8_MAT/media/image41.png}
...
\item 3 000\times 0,53 = R\$ 1 590,00
\item 3 000\times 0,25 = R\$ 750,00
\item 3 000\times 0,12 = R\$ 360,00
...
\item Caso o clube queira contratar o Jogador mais veloz, qual deve
escolher?
...
Volume de um cubo V= l\times l\times l ou l^3
...
\item 8\times 8 = 64cm^2
\item 12\times 12 = 144cm^2
\item 16\times 16= 256 m^2
\item 20\times 20 = 400 m^2
\item 34\times 34= 1156m^2
\item 8\times 8 = 64mm^2
\item 10\times 10 = 100mm^2
\item 25\times 25 = 625 mm^2
...
\includegraphics[width=1\times 50833in,height=1\times 28681in]{./imgSAEB_8_MAT/media/image44.png}b)
...
10\times 15 + 10\times 15 +10\times 30 + 10\times 30 + 15\times 30= A
...
V= 3,14\times 1,5^2\times 140

V= 3,14\times 2,25\times 140
...
12 .8\times 3= 288 maneiras diferentes
...
\item 9,11\times 10^-29
\item 9,11\times 10^-28
\item 9,11\times 10 ^-27
\item 9,11\times 10 ^-26
...
0,000000000000000000000000000911 = 9,11\times 
10^-28
...
500\times 99 = 49 500 foi o público total.
...
3,337\times 78 voltas = 260,286 km
...
D,Correta: pois 5\times 125 = 625 e (\sqrt{625}) = 25 logo um quadrado
perfeito.

\num{2} Um empresa de nanotecnologia resolveu inovar e criar o menor chip do
mundo em formato de um quadrado de lados de 2,0\times 10
^-5 cm de comprimento.
...
Logo temos que a área do Nano chip em cm^2 é 4,0\times 
10^-10
...
Cada tijolo possui 0,11\times 0,24 = 0,0264m^2 de área
...
5\times 5\times 10\times 10\times 10\times 10 = 250 000 possibilidades de senhas diferentes.
...
esse planeta se encontra a 6,0\times 10^8
km da terra e que a velocidade da luz é 3,0\times 
10^5 km/s depois de quanto tempo a luz poderia ser
...
6,0\times 10^8 = separando os termos temos
que 6,0 : 3,0 = 2
...
Realizando a operação 2\times 1000= 2000
...
60\times (\frac{2}{3}) = (\frac{120}{3}) = 40 litros foram consumidos
...
No total são 33 traços, logo 33\times 1 000 = 33 000 ou 33km
...
2,5\times 10^4 km/h, quantas horas
...
1,5\times 10^8 = separando os termos temos
que 1,5 : 2,5 = 0,6
...
Realizando a operação 0,6\times 10000= 6000
...
30 : 16= 1,875\times 5 = 9,375

Calculando o Corredor B temos que:

30: 20= 1,5\times 9 = 13,5
...
B: incorreta, o aluno chegaria a esse valor caso multiplicasse 57\times 0,05
...
\item Movimentou se para frente 7 metros
...
1 200\times 36 = 43 200 metros ou 43,2 km
...
600 = 3\times R^2\times 8

(\frac{600\ }{8})= 3\times R^2
