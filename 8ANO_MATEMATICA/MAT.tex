...
\num{2} Considerando que a²+ b² = 34 e ab= 15, qual o valor de
(\frac{(a + b)²}{8}) ?
...
\num{1} Determine a solução da equação x² + 4 = 0 no conjunto R
...
\num{2} Resolva, no conjunto R, a equação (2y + 1) ² = 8 + 2(2y + 1).
...
\num{6} Um país situado no continente europeu, tem cerca de 135 000 km² de
...
\num{6} Ao simplificar a expressão algébrica (x+1)² + (x-1)² + 2(x+1)(x-1)
...
\num{1} Ao calcularmos (\sqrt{3^{3} + 3²}) obtemos como resposta:
...
\num{7} Ao Calcularmos o produto das raízes da equação x² - 2x -- 35= 0
