...
\noindent A \textbf{resenha crítica} é um tipo de texto que tem por característica
...
\noindent A \textbf{crônica argumentativa} é um gênero textual que busca
...
\fonte{https://fernandatakai.com.br/livros. Acesso em: 22 de fev. 2023.}
\end{quote}
...
emotional expressions}\footnote{\emph{Dogs can infer implicit information from human emotional expressions}, em português significa ``Cães podem inferir informações implícitas em expressões humanas relacionadas a emoções''.} foi publicado na revista científica \emph{Animal Cognition} e desenvolvido pelos pesquisadores Natalia Albuquerque e Briseida Resende, do Instituto de Psicologia da USP, e Daniel Mills, Kun
...
\fonte{Guilherme Gama. Jornal da USP. Seu cão reconhece suas emoções e toma decisões a partir disso, mostra estudo da USP. Disponível em: https://jornal.usp.br/ciencias/seu-cao-reconhece-suas-emocoes-e-toma-decisoes-a-partir-disso-mostra-estudo-da-usp. Acesso em: 01 mar. 2023. Adaptado.}
...
\begin{quote}
\textbf{Texto I}\quad Precisamos prevenir a obesidade infantil, para não precisarmos lidar com a doença nos adultos depois.

\noindent\textbf{Texto II}\quad Hábitos saudáveis começam na infância. \#obesidadeinfantilnão
\end{quote}
...
nós, seres humanos.\hfill}\linhas{1}
...
viverem em liberdade. \rosa{Correta.}
...
\noindent Considerando seu uso, pode-se afirmar que o piso tátil
...
\paragraph{BNCC: EF69LP20} Identificar, tendo em vista o contexto de produção, a
...
\noindent Utilize os dois textos a seguir para responder às questões 1 a 4.

\begin{quote}
\textbf{Texto 1\quad A donzela, o sapo e o filho do chefe}
...
\begin{quote}
\textbf{Texto 2\quad Legenda da foto: Sapatinho de cristal.}
\end{quote}
%\fonte{Pixabay.}

\begin{figure}
\includegraphics[width=3.20455in,height=4.27009in]{./imgSAEB_6_POR/media/image9.jpeg}
\caption{Fotos grátis de Cinderela. Pixabay.}
\end{figure}
...
\begin{boxlist}
\boxitem[\rosa{1}] Uma das esposas do chefe morre.
\boxitem[\rosa{8}] O filho do chefe manda buscar a donzela.
\boxitem[\rosa{5}] A menina encontra, perto do poço, um sapo.
\boxitem[\rosa{7}] O sapo impõe a condição de que, quando os bailarinos estiverem se
dispersando, a moça vá para casa e deixe o sapatinho de ouro no lugar.
\boxitem[\rosa{4}] Sem poder fazer nada, a menina vai até o poço comer as raspas de
alimento que a madrasta deixava para ela.
\boxitem[\rosa{6}] O sapo engole e vomita a menina, fornecendo-lhe roupas e joias para
que ela possa ir ao festival.
\boxitem[\rosa{3}] Certo dia, a garota queria ir a um festival, porém não tinha roupas
boas o suficiente para se vestir.
\boxitem[\rosa{2}] A filha do chefe é feita de empregada por sua madrasta.
\end{boxlist}
...
\begin{boxlist}
\boxitem[\rosa{V}] O texto 1 é escrito conforme lendas e referências típicas da cultura
africana.
\boxitem[\rosa{V}] O texto 2 dá ênfase ao sapato de cristal, ao passo que no texto 1
esse sapato é de ouro.
\boxitem[\rosa{F}] No texto 1, a filha do chefe apenas deseja ir ao Festival da
Colheita.
\boxitem[\rosa{V}] No texto 2, a personagem é uma princesa e deseja ir a uma festa no
castelo.
\boxitem[\rosa{F}] O texto 1 deixa claro que a filha do chefe é maltratada pela
madrasta e suas duas meia-irmãs.
\boxitem[\rosa{F}] O elemento místico no texto 1 está no fato de os sapos falarem, ao
passo que no texto 2 está no fato de haver uma fada-madrinha.
\end{boxlist}

\noindent No texto 1, a filha do chefe deseja ir ao Festival da Colheita para
...
\begin{quote}
\textbf{Texto 1}\quad Olhos de cigana, oblíqua e dissimulada. (Machado de Assis, \emph{Dom Casmurro})
\end{quote}
...
\begin{quote}
\textbf{Texto 2}\quad Juro! Deixe ver os olhos, Capitu.\\
...
extraordinário; a cor e a doçura eram minhas conhecidas. (Machado de Assis, \emph{Dom Casmurro})
\end{quote}
...
\item Um ditado popular. \rosa{Correta.}
...
\begin{quote}
\textbf{Texto 1}\quad Tudo bem que você é essencial, mas tem hora que precisamos de uma
trégua, seu Hélio.
\end{quote}

\begin{quote}
\textbf{Texto 2}\quad O que acontece se o Sol deixar de brilhar?
\end{quote}
...
\item Apresentam intertextualidade quanto ao tema. \rosa{Correta.}
\item Não têm qualquer relação.
\item São de cunho informativo.
\end{escolha}

\paragraph{BNCC: EF67LP27} Analisar, entre os textos literários e entre estes e
...
\fonte{\url{https://pixabay.com/pt/photos/arte-de-rua-urbano-banksy-muro-606379/}}
...
\noindent Utilize o texto a seguir para responder às questões de 1 a 7.
...
\begin{escolha}
\item Reproduzem a fala do especialista na forma de discurso indireto. \rosa{Correta.}
...
\noindent Leia o texto a seguir para responder às questões de 8 a 10.
...
\begin{escolha}
\item Saúde mental e saúde física caminham juntas. \rosa{Correta.}
...
\item Uma citação indireta. \rosa{Correta.}
...
crianças pois elas entendem mais do que se imagina. \rosa{Correta.}
\end{escolha}
...
\begin{figure}
\includegraphics[width=0.7\textwidth]{./imgSAEB_6_POR/freepik/PORT_6_IMG-36.jpeg}
\end{figure}
...
\noindent Leia o texto a seguir para responder às questões de 6 a 10.
...
historiadores descrevem. \rosa{Corrreta.}
...
\item Mas com certo amadurecimento. \rosa{Correta.}
\end{escolha}

\paragraph{BNCC: EF67LP04} Distinguir, em segmentos descontínuos de textos, fato
...
\begin{escolha}
\item Uma opinião da especialista entrevistada. \rosa{Correta.}
...
parceria com Facebook e Instagram. \rosa{Correta.}
\end{escolhar}
...
\noindent Leia o texto abaixo para responder às perguntas de 1 a 3.
...
\noindent Leia o post a seguir, composto de imagem e texto escrito, para responder
...
\reduline{O cachorro rasgou toda a almofada, mas justificou contanto que
...
\item Fato de a pessoa ficar pensando na palavra beleléu. \rosa{Correta.}
\end{escolha}

\paragraph{BNCC: EF69LP05} Inferir e justificar, em textos multissemióticos —-
...
associa a ela.
\item Da relação surpreendente entre papéis e animais.
\end{escolha}
...
texto verbal.
\item a relação equivocada entre a cor rosa e a educação no trânsito,
...
\fonte{https://www.uol.com.br/vivabem/noticias/redacao/2021/03/10/animal-de-estimacao-como-filho.htm. Acesso em: mar. 2023.}
...
\fonte{\url{https://www.patasdacasa.com.br/noticia/dia-dos-pais-como-e-a-vida-e-rotina-de-um-pai-de-pet_a1893/1}. Acesso em: mar. 2023.}
...
\item Peça para sua mãe deixar você dormir na minha casa.
\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
\item Talvez eu vá ao jogo sexta-feira. \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
\item Compre em até 10x sem juros. \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
...
\item É proibido fumar neste lugar. \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
...
\def\labelenumi{\alph{enumi})}
\item É indiscutivelmente possível viajar para qualquer lugar do mundo
tendo bastante dinheiro. \textsc{certeza}
\item Peça para sua mãe deixar você dormir na minha casa.
\textsc{obrigatoriedade/\,possibilidade}
\item Talvez eu vá ao jogo sexta-feira. \textsc{possibilidade}
\item Compre em até 10x sem juros. \textsc{obrigatoriedade/\,possibilidade}
\item Não tenho \textsc{certeza} se vou à festa amanhã. \textsc{possibilidade}
\item Se eu conseguir chegar a tempo, vou à sua casa ainda hoje.
\textsc{possibilidade}
\item É proibido fumar neste lugar. \textsc{certeza}
\item Não é permitido entrar com animais neste estabelecimento. \textsc{certeza}
\end{enumerate}}
...
\begin{enumerate}
\def\labelenumi{\alph{enumi})}
\item Se = condição; de fato = certeza.
\item Exato = certeza.
\item Quase = condição; incontornável = certeza.
\item Não precisamos = certeza.
\end{enumerate}}
...
\begin{itemize}
\item Sinônimo:\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
\item Antônimo:\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
\end{itemize}
...
\begin{enumerate}
\def\labelenumi{\alph{enumi})}
\item Sinônimo: piedade; Antônimo: desprezo.
\item Sinônimo: gargalha; Antônimo: chora.
\item Sinônimo: cortês, gentil, solidário; Antônimo: malvado.
\item Sinônimo: boa; Antônimo: baixa.
\end{enumerate}}
...
\begin{enumerate}
\def\labelenumi{\alph{enumi})}
\item Comprei muitas frutas para \_\_\_\_\_ fazer uma sobremesa.
\item Pode emprestar para \_\_\_\_\_\_\_\_ aquela borracha?
\item Este bolo é para \_\_\_\_\_\_\_\_\_ comer?
\item Nada pode fazer para \_\_\_\_\_\_\_\_\_ ficar, infelizmente.
\item Entre \_\_\_\_\_\_ e você há um abismo de ressentimentos.
\item Pode fazer aquela comida gostosa para \_\_\_\_\_\_\_\_?
\end{enumerate}
...
\fonte{\url{https://ciencianarua.net/tirinha-de-silva-joao-20-05-2020}}
...
\begin{enumerate}
\def\labelenumi{\alph{enumi})}
\item Refere-se à história de Ricardo.
\item Refere-se às fronteiras entre um país e outro.
\item Refere-se ao nome do livro mencionado no texto.
\item Refere-se ao fato de tratar de alimentos do mundo todo.
\end{enumerate}
...
\fonte{\url{https://aetrancoso.pt/2019/10/10/10-de-outubro-de-2019-dia-mundial-da-saude-mental/}}
...
\fonte{\url{https://www.crmpr.org.br/Pais-precisam-manter-atualizado-o-calendario-de-vacinacao-dos-filhos-mesmo-na-pandemia-11-54287.shtml}}
...
\fonte{Herton Escobar. \textsc{Cara a cara com a família imperial: pesquisa simula
...
\fonte{\url{http://www.unifap.br/conscientizacao-no-transito-e-o-objetivo-da-campanha-maio-amarelo-2/}}
...
\fonte{\url{https://dragoesdegaragem.com/cientirinhas/cientirinhas-18/}}
...
% REVER
\includegraphics[width=5.90556in,height=4.96042in]{./imgSAEB_6_POR/media/image42.png}
%Uma imagem contendo Desenho técnico Descrição gerada automaticamente}

\fonte{\url{https://www.instagram.com/p/CPG8z6dsj5u/?hl=pt}}
...
\fonte{\url{https://www.gov.br/turismo/pt-br/centrais-de-conteudo/viva-de-perto-fazendo-ola-natal-rn}}
...
\fonte{\url{https://revistatrip.uol.com.br/upload/2019/02/5c6c0cf368385/906x264x960x540x-26x-137/nov20181.jpg})}
...
\url{https://www.camara.leg.br/noticias/945937-camara-aprova-projeto-que-obriga-pet-shops-e-clinicas-veterinarias-a-divulgar-adocao-de-animais}.
Acesso em: mar. 2023. Adaptado.)}
...
\fonte{\url{https://www.medicina.ufmg.br/contato-precoce-com-tecnologia-digital-pode-provocar-danos-a-saude-dos-bebes\%EF\%BB\%BF/}.}
...
\fonte{\url{https://memoria.ebc.com.br/noticias/brasil/2014/05/manifestantes-protestam-contra-copa-no-centro-de-brasilia}.
Acesso em: mar. 2023.}
...
\fonte{\url{https://museudememes.com.br/collection/naovaitercopa/nao-vai-ter-copa}}
...
\fonte{\url{https://www.instagram.com/p/CkJ4ETwg5Kv/?hl=pt}}
...
\fonte{\url{https://tubarao.sc.gov.br/uploads/sites/265/2022/01/3172563.png}.}
