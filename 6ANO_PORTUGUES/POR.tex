...
O que eu penso também tem valorF
...
\reduline{Trata-se das duas ocorrências da palavra "era" --- a primeira é uma forma verbal e a segunda é o nome de um longo período de tempo.}
...
\begin{quote}
\noindent\textbf{Dados estatísticos de fontes confiáveis}\\
...
\url{https://jornal.usp.br/ciencias/seu-cao-reconhece-suas-emocoes-e-toma-decisoes-a-partir-disso-mostra-estudo-da-usp/}.
...
\coment{
\begin{itemize}
\item[(\,1\,)] Uma das esposas do chefe morre.
\item[(\,8\,)] O filho do chefe manda buscar a donzela.
\item[(\,5\,)] A menina encontra, perto do poço, um sapo.
\item[(\,7\,)] O sapo impõe a condição de que, quando os bailarinos estiverem se
dispersando, a moça vá para casa e deixe o sapatinho de ouro no lugar.
\item[(\,4\,)] Sem poder fazer nada, a menina vai até o poço comer as raspas de
alimento que a madrasta deixava para ela.
\item[(\,6\,)] O sapo engole e vomita a menina, fornecendo-lhe roupas e joias
para que ela possa ir ao festival.
\item[(\,3\,)] Certo dia, a garota queria ir a um festival, porém não tinha
roupas boas o suficiente para se vestir.
\item[(\,2\,)] A filha do chefe é feita de empregada por sua madrasta.
\end{itemize}}
...
\coment{\begin{itemize}
\item[(\,V\,)] O Texto 1 é escrito conforme lendas e referências típicas da
cultura africana.
\item[(\,V\,)] O Texto 2 dá ênfase ao sapato de cristal, ao passo que no Texto 1
esse sapato é de ouro.
\item[(\,F\,)] No Texto 1, a filha do chefe deseja ir ao Festival da Colheita
para encontrar o príncipe.
\item[(\,V\,)] No Texto 2, a personagem é uma princesa e deseja ir a uma festa no
castelo para encontrar o príncipe.
\item[(\,F\,)] O Texto 1 deixa claro que a filha do chefe é maltratada pela
madrasta e suas duas meia-irmãs.
\item[(\,F\,)] O elemento místico no Texto 1 é o sapo, ao passo que no Texto 2 é
...
\item Moça, essa baguete foi feita hoje?
\item Sim, foi feita hoje.
\item E qual é o sabor?
\item É de parmesão.
\end{itemize}}
...
casas, [\ldots{}] consome-se mais gastronomia na TV [\ldots{}]."; "Mas na hora de escolher um restaurante, vamos de gastronômicos até onde o bolso alcança".}
...
árcia do céu, você não acredita! A almofada explodiu, menina! Veio com
