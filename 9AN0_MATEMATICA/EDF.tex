...
\chapter{Práticas corporais: dos jogos eletrônicos até aos esportes radicais}
...
\reversemarginpar\marginnote{Este módulo tem o como o foco do estudante identificar as práticas
...
(\rosa{2}) Dança do hip-hop que o dançarino pode improvisar os movimentos.

(\rosa{3}) Desenhos artísticos feitos em muros ou em paredes com spray.

(\rosa{1}) Música do hip-hop que tem improvisações e rimas.
