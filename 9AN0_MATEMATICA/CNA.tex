...
%\coment{ -- Luz, som e calor são formas de energia, não de matéria}
...
%\coment{ -- A energia não se cria e nem se destrói, apenas se transforma}

\boxitem{F} Energia e matéria não podem sofrer transformações
%\coment{ -- Tanto energia quanto matéria sofrem transformações}
\end{boxlist}

%\coment{Professor, a questão avalia a capacidade do aluno de identificar afirmações falsas sobre os conceitos de matéria e energia. Atenção ao explicar o conceito de matéria, já que, para a física moderna, existem diferentes tipos de matéria no Universo.}
...
%\coment{Ondas eletromagnéticas se propagam no vácuo}

\boxitem{V} Ondas sonoras são um exemplo de ondas longitudinais 

\boxitem{F} Ondas mecânicas se propagam no vácuo
%\coment{Ondas mecânicas necessitam do meio para se propagar}
