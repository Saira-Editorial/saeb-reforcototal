...
\reduline{Professor, durante a explicação acerca do surgimento
...
\begin{boxlist}
\item Marte é um planeta Joviano devido a sua composição rochosa. \reduline{(F)
...
portanto, pode-se afirmar que é um planeta gasoso. \reduline{(V)}

\item A Terra é um planeta Joviano devido ao surgimento tardio de vida em
sua crosta. \reduline{(F) A Terra é um planeta Telúrico, pois apresenta crosta
rochosa.}

\item Assim como Mercúrio, Vênus é um planeta Telúrico. \reduline{(V)}
\end{boxlist}

\num{3}  Complete as lacunas a seguir.

\reduline{Mercúrio}\preencher é um planeta rochoso, conhecido por ser
...
\begin{boxlist}
\item Dura 24 horas. \reduline{(R)}

\item Origina as estações do ano. \reduline{(T)}

\item Dura 365 dias e alguns minutos, o que gera, após 4 anos, um ano
bissexto. \reduline{(T)}

\item Origina os dias e as noites. \reduline{(R)}
\end{boxlist}
...
\reduline{À teoria do Big Crunch.}
...
\reduline{De cima para baixo: crosta, manto superior, manto inferior e núcleo.}
...
\reduline{BNCC: EF09CI14 -- Descrever a composição e a estrutura
...
\reduline{BNCC: EF09CI17 -- Analisar o ciclo evolutivo do Sol (nascimento, vida e morte) baseado no conhecimento das etapas de evolução de estrelas de diferentes dimensões e os efeitos desse processo
no nosso planeta.
...
\reduline{BNCC: EF09CI16 -- Selecionar argumentos sobre a
...
\reduline{BNCC: EF09CI01 -- Investigar as mudanças de estado
...
\reduline{BNCC: EF09CI08 -- Associar os gametas à transmissão
...
\reduline{BNCC: EF09CI14 -- Descrever a composição e a
...
\reduline{BNCC: EF09CI02 - Comparar quantidades de reagentes e
...
\reduline{BNCC: EF09CI11 -- Discutir a evolução e a diversidade
...
\reduline{BNCC: EF09CI17 -- Analisar o ciclo evolutivo do Sol
...
\reduline{BNCC: EF09CI03 -- Identificar modelos que descrevem
...
\reduline{BNCC: EF09CI12 -- Justificar a importância das
...
\reduline{BNCC: EF09CI03 -- Identificar modelos que descrevem a
...
\reduline{BNCC: EF09CI10 -- Comparar as ideias evolucionistas
