...
\begin{figure}[htpb!]
\includegraphics[width=2.91389in,height=1.47847in]{./imgs/img8.jpg}
\end{figure}
...
\item A nível mais alto e complexo é o organismo. \coment{(F)}

\item Um conjunto de ecossistemas formam uma comunidade. \coment{(F)}
\end{boxlist}
...
\begin{boxlist}
\item homo sapiens é a forma correta de escrita da espécie humana. \coment{(F)
...
epíteto generico. \coment{(F) Pois o primeiro nome se refere ao gênero da
...
e culta. \coment{(F) Pois o latim foi escolhido por ser uma língua morta, sendo
...
espécies pertencentes a um mesmo genero. \coment{(V)}
...
da fauna e flora de uma região. \coment{(V)}
...
intimamente ligada a sobreviência da espécie humana. \coment{(V)}
\end{boxlist}
...
\includegraphics[width=1.78261in,height=0.90032in]{./imgs/img10.jpg}
...
\begin{figure}[htpb!]
\includegraphics[width=2.58803in,height=2.75652in]{./imgs/img11.jpg}
