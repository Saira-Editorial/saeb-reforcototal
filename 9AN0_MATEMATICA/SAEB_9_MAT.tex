...
\num{1} Escreva se os números abaixo são Racionais (Q) ou Irracionais
(I)
...
\def\labelenumi{\alph{enumi})}
\item
  Decimal exato é racional.
\item
  O número pi é irracional.
\item
  Toda fração é racional.
\item
  A raiz quadrada de 7 não é exata, está entre os números naturais 2 e
  3, pois 2² = 4 e 3² = 9. Toda raiz quadrada não exata é irracional.
\item
  Este número trata-se de uma dízima \textbf{não} periódica, ou seja,
  irracional.
\end{enumerate}
...
consistia em cada grupo sortear 5 números sem reposição, posteriormente
deveriam colocar os números sorteados em ordem crescente. Os números
sorteados por um destes grupos foram: 7; ; ; 0,75 e . Escreva eles em
ordem crescente.

Colocar uma linha para a resposta

Professor: BNCC: EF09MA02 SAEB: 9N1.4 Considerando as aproximações ; ;
0,75 e Temos: ; 0,75; ; ; 7

\num{4} Complete a tabela:

Representação decimal ou fracionário Descrição na língua materna
(escrito por extenso) --------------------------------------
---------------------------------------------------
...
Professor: BNCC: EF09MA02 SAEB: 9N1.1 Dois centésimos // ou 0,3 // Três
milésimos // ou 0,002 // Cinquenta e um décimos
...
Deixar 3 linhas para resposta Professor: BNCC: EF09MA02 SAEB: 9N1.2 O
número 89 é composto, pois pode ser escrito como 3 · 29 e o número 29 é
primo, pois não tem outro divisor primo.
...
correspondente ao número de divisores positivos do número 5 040. Quantos
aos completou Jorge no ano de 2023?

Deixar 3 linhas para resposta Professor: BNCC: EF09MA02 SAEB: 9N1.11
Decompondo o número 5 040 temos que: com isso o número de divisores
positivos são: (4+1) · (2+1) · (1+1) · (1+1) = 5 · 3 · 2 · 2 = 60. Desta
...
Professor: BNCC: EF09MA02 SAEB: 9N1.1 2,4 // // // // 0,875
...
\def\labelenumi{\alph{enumi})}
\item
  256 = 2\textsuperscript{8}
\item
  1250 = 2 · 5\textsuperscript{4}
\item
  4800 = 2\textsuperscript{6} · 3 · 5\textsuperscript{2}
\end{enumerate}

\num{9} Escreva o número que corresponde a cada fatoração em números
primos: Deixar espaço na frente de cada item para responder
...
\num{0} Ao fazer a decomposição de 336 em fatores primos, Thiago chegou
a seguinte expressão . Qual o valor que Thiago deve colocar no lugar de
x?

Colocar uma linha para a resposta Professor: BNCC: EF09MA02 SAEB: 9N1.2

Como o número 336 = 2\textsuperscript{4} · 3 · 7, temos que x é igual a
4

\colorsec{Treino}

\num{1} Se o número tem exatamente 60 divisores positivos então o valor
e x é:
...
\def\labelenumi{\alph{enumi})}
\item
  Falso, 10 é múltiplo de 5 e não é ímpar.
\item
  Falso, 3 é ímpar e não é múltiplo de 5.
\item
  Falso, 2 é par e não é múltiplo de 6.
\item
  Verdadeiro, como o 12 é par todo múltiplo deste número terá o fator 2.
\end{enumerate}
...
4\textsuperscript{3}~(quatro elevado a terceira potência ou quatro
...
2,87 · 10\textsuperscript{9} km.

\num{2} Jorge foi fazer uma entrega, em um condomínio, de 50 caixas
pesando 60kg cada caixa. Para tal utilizou o elevador, que tinha a
capacidade máxima de 800kg. Jorge pesa 100kg. Por segurança o zelador
não deixa que o limite de capacidade do elevador seja ultrapassado.
...
que a cada duas maçãs fossem pagos (custo) o valor de R\$ 0,80. O preço
de venda será de R\$ 1,00 a unidade.
...
\num{6} ``A NGC 4151 está localizada a cerca de 43 milhões de anos-luz
da Terra e se enquadra entre as galáxias jovens que possui um buraco
...
uma referência ao vilão do filme `O Senhor dos Anéis'\,''.

(\url{http://www1.folha.uol.com.br/ciencia/887260-galaxia-herda-nome-de-vilao-do-filme-o-senhor-dos-aneis.shtml}
...
43 milhões representa 43 000 000, ou seja, 43 · 10\textsuperscript{6} ou
4,3 · 10\textsuperscript{7}.
...
repetição dos esportes das turmas. O futebol acontece a cada 30 dias, os
de basquete a cada 45 dias e os de handebol, a cada 60 dias.
...
\num{8} Durante uma campanha de arrecadação de alimentos motivados por
uma gincana na escola a turma da Larissa arrecadou: 288 pacotes de
feijão, 96 pacotes de açúcar, 360 pacotes de arroz e 240 pacotes de
fubá. Larissa recorreu a seus conhecimentos matemáticos para organizar
pacotes para que cada família beneficiária.
...
1,20m e 1,80m essas fitas, quantos pedaços menores de fita e de máximo
...
Professor: BNCC: EF09MA03 SAEB: 9N1.6 d
...
Julinha decidiu fazer doces. Ela decidiu que para facilitar iria fazer
pacotinhos com brigadeiros e com beijinhos. Fez uma primeira receita de
cada para ver quantos consegui em cada receita. Neste primeiro teste ela
conseguiu fazer 150 brigadeiros e 120 beijinhos.
...
\def\labelenumi{\alph{enumi})}
\item
  \textbf{5 brigadeiros, 4 beijinhos, 30 pacotes de cada.}
\item
  15 brigadeiros, 12 beijinhos, 10 pacotes de cada.
\item
  10 brigadeiros, 12 beijinhos, 15 pacotes de cada.
\item
  3 brigadeiros, 3 beijinhos, 90 pacotes de cada.
\end{enumerate}
...
\num{3} \textbf{Equipe diz ter descoberto menor forma de vida}
...
Os pesquisadores as chamam de nanobes. O "nano" vem de seu comprimento,
de 20 a 150 nanômetros (bilionésimos de metro).

(Disponível em:
\url{https://www1.folha.uol.com.br/fsp/ciencia/fe1901200001.htm} -
acessado em 25/02/2023)
...
0,151515... são dízimas periódicas. Qual a fração representa a soma de x
e y?
...
\num{5} Quando Artur chega em casa encontra uma pizza com alguns pedaços
já consumidos, seu irmão deve ter comido, então come alguns pedaços.
...
\num{8} Qual a fração que representa a quantidade de crianças que
preferem hamster como animal de estimação?
...
\num{9} Uma fração equivalente ao número de peixes que Pedro tem em
relação aos amigos.
...
\item
  \(\frac{3}{25}\)
\item
  \(\frac{\mathbf{9}}{\mathbf{48}}\)
\item
  \(\frac{5}{16}\)
\end{enumerate}

Professor BNCC: - SAEB:9N1.8 Pelo gráfico a quantidade a fração da
quantidade de peixes que Pedro tem em relação ao total é
\(\frac{3}{16}\), esta fração é equivalente a fração da alternativa c.
...
Bruno \(\frac{2}{7}\), Augusto \(\frac{12}{15}\) e Cadu
\(\frac{8}{10}\).
...
\item
  Bruno e Augusto.
\item
  \textbf{Alice e Augusto.}
\item
  Augusto e Cadu.
\end{enumerate}

Professor BNCC: - SAEB:9N1.8 As frações equivalentes são as que
representam a quantidade da Alice e Augusto, pois
\(\frac{4}{5} = \frac{12}{15}\).
...
Professor BNCC: - SAEB:9N1.10 0,126126... =
...
Professor BNCC: - SAEB:9N1.7 Como o valor 111 é igual a 3·37, então
basta fazer 3·12=36, desta forma x=36.
...
Professor BNCC: - SAEB: 9N1.8

\(\frac{2}{3}\ \)de 12 são 8 pedaços e \(\frac{1}{2}\) de 12 são 6
pedaços, ou seja, Juca comeu 14 pedaços dos 35 disponíveis. A fração que
ele comeu de chocolate foi \(\frac{14}{35} = \frac{2}{5}\) que está
...
\num{2} Vou comprar um tênis no valor de R\$ 250,00 e tenho duas opções
para pagar que são:
...
seria o valor à vista temos: \(\frac{125}{75} = 1,667\), ou seja, 66,7\%
a mais.
...
\begin{longtable}[]{@{}lll@{}}
\toprule\noalign{}
\textbf{ANO} & \textbf{Escola A} & \textbf{Escola B} \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
...
\num{5} \emph{``A sigla Ideb se refere ao Índice de Desenvolvimento da
...
\num{6} \textbf{Disparidade de rendimento entre sexos permanece alta
...
\url{https://censo2010.ibge.gov.br/noticias-censo?busca=1\&id=1\&idnoticia=2747\&t=estatisticas-genero-mostram-como-mulheres-vem-ganhando-espaco-realidade-socioeconomica-pais\&view=noticia\#:~:text=Em\%202010\%2C\%20o\%20rendimento\%20m\%C3\%A9dio,7\%25\%20do\%20rendimento\%20masculino}
...
razão \(\frac{513}{1587} \cong 0,3232..\), ou seja, aproximadamente
32,3\%.
...
\url{https://petrobras.com.br/data/files/55/43/0A/53/165954104F528454893851A8/producao-petroleo-VALE-ESTE.jpg}
...
Calculando a razão \(\frac{3,9}{2,32} = 1,681\ldots\ \). Sendo assim
...
\num{0} Um produto teve um aumento de 20\% e posteriormente um desconto
de 15\%. Considerando o valor final tivemos um aumento ou um desconto de
quantos porcento?
...
Professor BNCC: EF09MA05 SAEB: 9N2.3 Como foi pago 30\% de entrada
sobrou 70\% para a segunda parcela. Para saber o valor da segunda
parcela precisamos calcular 70\% de 2150. 0,70 · 2150 =1505.

\num{2} Hugo comprou 150 figurinhas para o seu álbum da copa do mundo de
2022. Porém, dessas 150 figurinhas, 90 eram repetidas.
...
Professor BNCC: EF09MA05 SAEB: 9N2.3 Hugo comprou 150 figurinhas, mas
apenas 60 não eram repetidas, sendo assim ele usou efetivamente
\(\frac{60}{150} = 0,40 = 40\%.\)

\num{3} Kríssia quer comprar à vista uma mochila que custa R\$ 560,00,
mas, para pagamento à vista, a loja oferece um desconto de 5\%. No
entanto por ser a última peça foi oferecido um desconto na etiqueta de
20\%.
...
Professor BNCC: EF09MA05 SAEB: 9N2.3 Houve dois descontos sucessivos,
sendo um de 20\% e outro de 5\%. (1 -- 0,2) · (1 -- 0,05) · 560 = 0,8 ·
095 · 560 = 425,60.
...
\num{1} Leia o problema cuidadosamente: certifique-se de entender o que
...
informações que são relevantes para o problema. Seja claro sobre o que
você está tentando encontrar e quais dados você tem.

\num{3} Desenhe um diagrama: um diagrama pode ajudar a visualizar o
problema e ajudar na solução. Isso pode ser especialmente útil em
problemas geométricos.

\num{4} Use palavras-chave: muitas vezes as palavras usadas em um
problema podem dar uma indicação de que tipo de operação matemática deve
ser usada. Por exemplo, "mais" pode indicar uma adição, "menos" pode
indicar uma subtração, "vezes" pode indicar uma multiplicação e
"dividido por" pode indicar uma divisão.

\num{5} Escreva equações: transforme as informações importantes do
problema em equações matemáticas. Use variáveis para representar
quantidades desconhecidas.

\num{6} Simplifique: tente simplificar as equações matemáticas tanto
quanto possível. Isso pode ajudar a reduzir a complexidade do problema.

\num{7} Resolva a equação: use as propriedades matemáticas para resolver
...
1) Com o objetivo de juntar um dinheiro para a formatura Jorge começou a
produzir doces para revender. Cada receita é composta de kg de castanha
e kg de açúcar.
...
\begin{longtable}[]{@{}ll@{}}
\toprule\noalign{}
\textbf{Entrada de água} & \textbf{Vazão (litro/minuto)} \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
...
100\% a vazão total de água nas entradas de água. Para esse propósito,
...
vendidas de~\emph{y}, faço o sistema que representa, em linguagem
...
\colorsec{Treino} primeiro perdia 1,2 kg, enquanto o outro ganhava 0,6
kg. Logo após esse período de preparação, a diferença de massa entre os
dois atletas era de apenas 4 kg.
...
6) Paulo é garçom de um badalado de um restaurante. Ele recebe, por mês,
R\$ 650,00 mais R\$ 20,00 por hora extra que trabalha. Quanto ele
receberá este mês?
...
\begin{figure}
\centering
\includegraphics[width=2.24688in,height=0.95376in]{./_SAEB_9_MAT/media/image70.png}
...
2) Um estacionamento tem 50 veículos entre carros e motos, sabendo que o
total de rodas do estacionamento é igual a 160 rodas, qual o número de
carros?
...
a\textsubscript{n}= 3n +1, calculando 1º termo com n=1, 2º termo com n=2
e assim sucessivamente teremos a sequência: (4, 7, 10, 13, 16, 19, ...).

\ul{Classificação da sequência numérica}
...
2\textbf{)} Em um grupo de crianças, 210 de bombons foram distribuídos
...
\textbf{6ª} & \textbf{7ª} & \textbf{8ª} & \textbf{9ª} & \textbf{10ª} \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
...
3\textbf{)} Observe a quantidade de lugares em cada configuração:
...
4) Uma fábrica trabalha com vários modelos e tamanhos de mesas. As mesas
...
6) \textbf{Qual o número de cadeiras ao utilizar 10 mesas na
configuração da imagem abaixo:}

\includegraphics[width=4.6875in,height=0.8in]{./_SAEB_9_MAT/media/image83.wmf}

\textbf{Montar imagem semelhante, número de cadeiras é importante.}
...
\textbf{Montar tabela semelhante}
...
9) Dado a expressão a\textsubscript{n} = 3n + 2. A diferença entre o
...
1. Considere um poliedro convexo que possui oito vértices e apenas faces
...
6. Entre as medidas dos palitos dadas abaixo quais dela impossibilitam a
