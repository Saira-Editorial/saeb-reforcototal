...
\coment{Segundo o enunciado, o sangur do doador universal é do tipo O com Rh--. 
...
b) Correta. Há 5 maneiras de sacar R\$ 400,00 em notas de 20 ou 50, sendo que apenas 
em 2 temos quantidade ímpar de notas. Observe a tabela a seguir.
...
a) Incorreta. A probabilidade de que as bolas sorteadas sejam da mesma cor é mais próxima de 30\%.
b) Incorreta. A probabilidade de que as bolas sorteadas sejam da mesma cor é mais próxima de 30\%.
...
\num{4} Pedro tem uma dívida com o banco no valor de R\$ 6 000,00. Neste mês
...
contexto da educação financeira. Calculando 20\% de 6.000 → 0,2 \cdot 6000 =
1200. Desta forma Pedro irá pagar R\$1.200,00 ao banco. Alternativa c.

\num{5} Aluísio olhou sua carteira e decidiu dar um terço do dinheiro que tinha nela para sua neta mais velha. Posteriormente ele deu mais 10 reais a ela e ficou com 20 reais na carteira.
...
Sendo assim para n = 8 teremos 2\cdot8 + 1 = 17 palitos.
...
basta substituir t = 3 na expressão: h(3) = - 3² + 5 \cdot 3 = - 9 + 15 = 6,
...
corrida de 4 km custou R\$16,50 e de deslocamento gastou-se 4 \cdot 3 = 12,
...
9 \cdot 12 \cdot 1,4 = 151,2 m³ → 151 200 litros. Calculando agora quantos
...
p\cdot(1+0,1) = 1,1p. Como depois temos o desconto, aplicaremos o fator de
correção: 1,1p\cdot(1-0,1) = 1,1p\cdot0,9 = 0,99p, ou seja, o produto custará
...
c) 6 horas, porque 23 = 8 + (x -- 1) \cdot 3.

d) 5 horas, porque 23 = 3 + (x -- 1) \cdot 3.
...
Calculando a receita, temos: 450 \cdot 10 + 300 \cdot 15 = 4 500 + 4 500 = 9
...
Vamos usar a relação entre hipotenusa e altura. 10 \cdot h = 6 \cdot 8 → h = 4,8
cm.
...
Calcule 100 \cdot 2 500 = 250 000 folhas, como cada resma tem 500 folhas
...
Sendo assim: 0,25 \cdot 400 = 100. Como o desconto será de R\$100,00 o valor
...
expressão será 4x com algum ajuste. Fazendo 4\cdot5 obtemos 20, mas o número
é 17 (3 a menos), fazendo 4\cdot6 obtemos 24, mas o número é 21 (3 a menos),
...
9 vírus podemos determinar k, pois 9 = 4\cdot3 + k → 9 -- 12 = k → k = -- 3.

Dado que q = 4n -- 3 → q = 4\cdot30 -- 3 = 120 -- 3 = 117.
