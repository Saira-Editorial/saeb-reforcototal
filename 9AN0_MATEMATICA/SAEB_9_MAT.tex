...
\num{8} Mário gosta muito de montar e desmontar coisas, recentemente ganhou
...
\num{9} Observando dois reservatórios A e B percebeu-se que os volumes, em
...
\num{13} Uma empresa de importação de cosméticos possui 30 funcionários com a
...
\num{7} Os valores referentes às duas raízes da equação \textbf{x² + 2x -- 24
...
\num{10} Na figura abaixo, temos um quadrado AEDF e e .
...
\num{11} Um triângulo retângulo tem a medida da hipotenusa é 13 cm e a de um
dos catetos é 5 cm.
...
\num{12} Os gráficos mostram, em milhões de reais, o total do valor das
