...
100x - x = 23,23232323\ldots{} - 0,232323\ldots{}
...
$x = 0,5123123123\ldots{}

10x = 5,123123123\ldots{}

10000x = 5123,123123\ldots{}

10000x - 10x = 5123,123123\ldots{} - 5,123123123\ldots{}
...
num{10} O professor de André montou uma grande lista de exercícios 
...
a) Incorreta. 1)  A dízima periódica $0,126126\ldots{}$ é representada pela 
fração $\frac{14}{111}$.
b) Correta. $0,126126\ldots{}$ = $\frac{126}{999}$ = $\frac{14}{111}$.
c)  Incorreta. 1)  A dízima periódica $0,126126\ldots{}$ é representada pela 
fração $\frac{14}{111}$.
d)  Incorreta. 1)  A dízima periódica $0,126126\ldots{}$ é representada pela 
fração $\frac{14}{111}$.
}
...
a) Incorreta. $x = 36$.
b) Incorreta. $x = 36$.
c) Correta. Como o valor 111 é igual a $3 \cdot 37$, então basta fazer 
$3 \cdot 12 = 36$, desta forma $x = 36$.
d) Incorreta. $x = 36$.
}
...
%deixar box pequeno para resolução
\coment{Calculando 75\% de 60, teremos $0,75 \cdot 60=45$, ou seja, no final
...
determinará o valor procurado. Assim: $76,92 \cdot 1,9 = 146,15$.}
...
%deixar box pequeno para resolução
\coment{$(1 + 0,2) \cdot (1 + 0,2) = 1,44$. Assim podemos afirmar que tivemos um
aumento de 44\%.}
...
%deixar box pequeno para resolução
\coment{$(1 - 0,1) \cdot (1 - 0,1) = 0,81$. Assim podemos afirmar que tivemos um
desconto de 19\%.}
...
%deixar box pequeno para resolução
\coment{$(1 +0,2) \cdot (1 - 0,15) = 1,2 \cdot 0,85 = 1,02$. Pode-se afirmar, assim,
...
2150, da seguinte maneira: $0,70 \cdot 2150 = 1505$.
...
de 5\%. $(1 - 0,2) \cdot (1 - 0,05) \cdot R\$ 560 = 0,8 \cdot 0,95 \cdot R\$ 560 = R\$ 425,60$.
...
$\frac{4}{5} \cdots 20 + \frac{1}{5} \cdots 4 = 16 + 0,8 = R\$ 16,80$
...
$60x + 850 = 1870 \rightarrow \\
60x = 1870 - 850 \rightarrow \\
60x = 1020 \rightarrow \\
x = 17$
...
\begin{enumerate}
\item
  $3x^2 + 4x + 1 = 0$: é uma equação do segundo grau, 
  com a = 3, b = 4, c = 1;
\item
  $x² - x - 1 = 0$: é uma equação incompleta com grau 2, com $a = 1, 
  b= -1, c = -1$;
\item
  $x^2 - 5x = 0$: também é uma equação incompleta de grau 2, com a = 9, b = --5, c = 0;
\item
  $5x^2 -- 4 = 0$: equação do segundo grau, com a = 5, 
  b = 0, c = --4$.
\end{enumerate}
}
...
\coment{
a) Por fatoração podemos escrever a equação $x^2 + 6x + 8 = (x+4) x (x+2) = 0$.
Com isso, temos como raízes $- 4 e - 2. S={-4, -2}$.

b) Por fatoração podemos escrever a equação $x^2 - 5x - 24 = 
(x+8)x (x-3) = 0$.
...
\coment{$x^2 + 7 = 7x - 3 \rightarrow

x"2} -7x + 10 = 0 \rightarrow

(x - 5)\cdot(x - 2) = 0 \rightarrow

x = 5 ou x = 2$}

\num{4} Suponha que a área de 4.225 km^2 é delimitada por um
...
\coment{$4 \cdot 10 \cdot (x+10) + x^2 = 900 \rightarrow
40x + 400 + x^2 = 900 \rightarrow
x^2 + 40x - 500 = 0 \rightarrow
\mathrm{\Delta} = 40^2 - 4 \cdot 1 \cdot -500 = 3600 \rightarrow
x = \frac{-40\pm\sqrt{3600}}{2\cdot1} \rightarrow$
x = -50 (não convém) ou x = 10}

\num{6} Um retângulo tem 204 cm\textsuperscript{2}.
...
3600x - 3600x + 28800 - 75x^2 + 600x = 0 \rightarrow
- 75x^2 + 600x + 28800 = 0 (\div 75) \rightarrow
- x^2 + 8x + 384 = 0$ 
...
\Delta = (-4)^2 - 4 \cdot 1 \cdot (-96) = 400 \\
...
da ``Jabulani'' -- apelido da bola utilizada naquele certame.  
Ela era mais simples do que suas antecessoras, que eram compostas
...
\coment{SAEB: Resolver problemas que possam ser representados por equações polinomiais de 2º grau.
