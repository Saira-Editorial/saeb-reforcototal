...
\num{3} Observe a ilustração a seguir.
...
\url{https://www.shutterstock.com/pt/image-vector/water-tank-vector-wallpaper-on-white-1346364413}
 ...
 Uma caixa em forma de cilindro reto foi instalada em um condomínio
...
\num{9} Uma empresa premia seu funcionário quando atingem a meta de
...
\num{10} Os tipos sanguíneos são 4, como consta na tabela abaixo, sendo ainda
