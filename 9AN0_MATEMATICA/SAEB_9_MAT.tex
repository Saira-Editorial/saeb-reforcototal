...
Para determinar aumentos ou descontos sucessivos, utilizamos o 
...
\begin{itemize}
  ...
  \item \textbf{Plano II} Pagamento em duas parcelas iguais sem aumento, pagando a primeira no dia da compra e a segunda um mês depois.
\end{itemize}
...
após 30 dias, pagando um total de R\$ 250,00. 

Considerando que o preço à vista é de R\$ 200,00, a segunda parcela seria de apenas R\$ 200,00
-- R\$ 125 = R\$ 75,00.

No entanto, nesse segundo plano \textit{as duas parcelas são iguais}, no
valor de R\$ 125,00. Calculando o valor pago em relação ao que seria o
valor à vista temos: \frac{125}{75} = 1,667, ou seja, 66,7\%
a mais.
}
