...
Baseado nestes preços, em qual distância o valor das duas empresas se
iguala?
...
\num{5} Carlos trabalha como segurança, cobrando uma taxa fixa de 150,00 mais
...
\num{6} O corte transversal de um túnel, de pista única, em que a
...
\num{8} A concentração de um medicamento de certa medicação, em varia de
