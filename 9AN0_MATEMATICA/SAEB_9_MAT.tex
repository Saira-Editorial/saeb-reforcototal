...
\num{6} Luiz Felipe criou uma planta da sua casa para um trabalho da escola.
...
\num{7} João e Marcos resolveram disputar uma corrida diferente, entre os
...
\num{9} Carlos precisa sair do ponto A e chegou no ponto D. Faça a indicação
...
\num{10} Um turista caminhou por todo os pontos turísticos, a distância entre
