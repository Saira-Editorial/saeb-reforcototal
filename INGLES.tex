...
\coment{Neste módulo, os alunos retomam como reconhecer o gênero de um texto e
...
\begin{boxlist}
\item Não é importante identificarmos o tipo de texto que estamos lendo. \marginnote{F}

\item Identificar palavras-chave é uma estratégia importante na
compreensão textual. \marginnote{V}

\item Textos literários não contam histórias. \marginnote{F}

\item Diálogos geralmente constituem uma parte importante de textos
literários. \marginnote{V}
\end{boxlist}
...
\coment{Neste módulo, o professor deverá mostrar aos alunos como os argumentos
...
convencer o leitor. \marginnote{V}

\item Um texto argumentativo deve apresentar diferentes aspectos sobre
um assunto. \marginnote{V}

\item ``So'' não pode ser considerado um conectivo de argumentação. \marginnote{F}

\item Um texto argumentativo não apresenta exemplos. \marginnote{F}
\end{boxlist}
...
\coment{Neste módulo, os alunos aprenderão a diferenciar as possíveis visões
...
\begin{boxlist}
\item Fatos e opiniões são conceitos sinônimos. \marginnote{F}

\item É muito importante identificarmos diferentes perspectivas sobre um
tema. \marginnote{V}

\item Não é possível encontrarmos fatos e opiniões em um mesmo texto. \marginnote{F}
