...
%Paulo: Colocar cada número abaixo com uma cor
diferente.
...
\begin{boxlist}
\boxitem{F} Todo número que é racional é também irracional.
...
\boxitem{V} Dízimas periódicas podem ser escritas na forma de fração.
...
\num{0} Na sala da professora Ana Júlia, foi realizada uma atividade de
...
\num{3} Associe a primeira coluna das operações com os resultados
...
\num{5} A cada letra está associado o valor de uma raiz quadrada. Calcule o
...
\num{0} Em um ateliê, existem três tecidos iguais, mas de estampas
...
\num{0} Em uma corrida dividida em 6 partes, há 10 competidores. Ricardo,
...
Habilidades da BNCC EF07MA23, EF07MA24, EF07MA25.
...
Habilidades do SAEB * Resolver problemas que envolvam a probabilidade de
...
\num{0} No plano cartesiano, considere o triângulo ABC com vértices A(2, 4),
...
\num{0} Em uma festa na escola, cada aluno levou um cupcake para comemorar.
...
\num{0} Considere um triângulo ABC, onde AB = 8 cm, AC = 6 cm e BC = 10 cm.
...
\num{0} Analisando as sequências abaixo, podemos classificá-las como
