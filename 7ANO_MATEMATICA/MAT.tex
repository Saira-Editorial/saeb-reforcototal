...
\[B = \sqrt{784} = \sqrt{2^{2}.2^{2}.7^2} = 2\ .\ 2\ .\ 7 = 28\]
...
% REVER
% Criar uma tabela como a colocada à cima, mas onde tem 10^2 trocar por
% 10³.
...
% REVER
% \[\therefore\ \text{AT} = 72 + 44 + 15 = 131\text{cm}^2\]
