...
\noindent \includegraphics[width=\textwidth]{../ilustracoes/MAT1/SAEB_1ANO_MAT_FIGURA1.png}
}
...
%\coment{Somente na figura da caixa de correio, encontramos um número identificador. Em todas as outras imagens, os números são usados para quantificar medidas.}
...
%\coment{Oriente os alunos acerca das funções dos números de identificação dos carros, destacando que eles não são os números que indicarão a ordem de chegada deles. Oriente-os para que entendam que a ordem se inicia da esquerda para a direita.}
...
\coment{O aluno deve contar as duas coleções e perceber que a coleção de camisas de Alberto é maior, pois tem mais unidades do que a coleção de Júnior.}
...
%\coment{Oriente os alunos a olharem para o resultado da face superior do dado, da mesma forma como eles fariam ao jogar um jogo de tabuleiro.
\coment{A imagem a ser circulada é a da direita, pois a soma dos valores dos dados representados é maior do que a soma dos valores representados nos dados da imagem da esquerda.}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.7\textwidth]{../ilustracoes/MAT1/SAEB_1ANO_MAT_FIGURA23.png}
\end{figure}
...
% \begin{figure}[htpb!]
% \centering
% \includegraphics[width=.8\textwidth]{../ilustracoes/MAT1/SAEB_1ANO_MAT_FIGURA28.png}
% \end{figure}
...
% \begin{figure}[htpb!]
% \centering
% \includegraphics[width=.6\textwidth]{../ilustracoes/MAT1/SAEB_1ANO_MAT_FIGURA30.png}
% \end{figure}
...
\includegraphics[width=.2\textwidth]{../ilustracoes/MAT1/SAEB_1ANO_MAT_FIGURA32.png}
\end{wrapfigure}
...
ELAS ANOTAM A ALTURA DE MARIANA JUNTAS. MARIANA ESTÁ AGORA COM 80 CENTÍMETROS DE \textbf{ALTURA}, QUE, EM GERAL, É A ALTURA DE UMA MESA DE ESCRITÓRIO.
...
\noindent MARIANA ESTÁ AGORA COM 18 QUILOGRAMAS DE \textbf{MASSA}, OU SEJA, A MESMA QUE UMA POLTRONA PODE TER. SE UMA POLTRONA E MARIANA TÊM A MESMA MASSA, POR QUE A POLTRONA É
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.5\textwidth]{../ilustracoes/MAT1/SAEB_1ANO_MAT_FIGURA36.png}
\end{figure}
...
\conteudo{VOCÊ SABE EM QUE DIA ISSO ACONTECERÁ? E EM QUE DIA
...
\noindent\includegraphics[width=\textwidth]{../ilustracoes/MAT1/SAEB_1ANO_MAT_FIGURA46.png}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.4\textwidth]{../ilustracoes/MAT1/SAEB_1ANO_MAT_FIGURA54.png}
\end{figure}
...
\centering{\includegraphics[width=.7\textwidth]{../ilustracoes/MAT1/SAEB_1ANO_MAT_FIGURA63.png}}
}
...
\includegraphics[width=\textwidth]{../ilustracoes/MAT1/SAEB_1ANO_MAT_FIGURA70.png}
\end{minipage}
\begin{minipage}{.3\textwidth}
...
\includegraphics[width=.7\textwidth]{../ilustracoes/MAT1/SAEB_1ANO_MAT_FIGURA77.png}

\item UMA BALA DE R\$ 0,15 (QUINZE CENTAVOS).

\includegraphics[width=.7\textwidth]{../ilustracoes/MAT1/SAEB_1ANO_MAT_FIGURA78.png}

\item UM APITO DE R\$ 0,30 (TRINTA CENTAVOS).

\includegraphics[width=.7\textwidth]{../ilustracoes/MAT1/SAEB_1ANO_MAT_FIGURA79.png}

\item UM CHAVEIRO DE SUPER-HERÓI DE R\$ 3,75 (TRÊS REAIS E SETENTA E CINCO

\includegraphics[width=.7\textwidth]{../ilustracoes/MAT1/SAEB_1ANO_MAT_FIGURA80.png}
\end{escolha}
...
\centering{\includegraphics[width=.7\textwidth]{../ilustracoes/MAT1/SAEB_1ANO_MAT_FIGURA83.png}}
}
...
\begin{figure}[htpb!]
\includegraphics[width=.8\textwidth]{../ilustracoes/MAT1/SAEB_1ANO_MAT_FIGURA86.png}
\end{figure}
...
\centering{\includegraphics[width=.45\textwidth]{../ilustracoes/MAT1/SAEB_1ANO_MAT_FIGURA94.jpg}}
}
...
\includegraphics[width=\textwidth]{../ilustracoes/MAT1/SAEB_1ANO_MAT_FIGURA95-2.png}
...
%\coment{Oriente os alunos a transferirem as informações da primeira tabela para o gráfico de barras. Explique aos alunos que cada quadradinho é um aluno que escolheu o jogo selecionado. Esta atividade favorece o trabalho com a competência geral 5 da BNCC.}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=\textwidth]{../ilustracoes/MAT1/SAEB_1ANO_MAT_FIGURA102.png}
\end{figure}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.5\textwidth]{../ilustracoes/MAT1/SAEB_1ANO_MAT_FIGURA103.png}
\end{figure}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.9\textwidth]{../ilustracoes/MAT1/SAEB_1ANO_MAT_FIGURA104.png}
\end{figure}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.8\textwidth]{../ilustracoes/MAT1/SAEB_1ANO_MAT_FIGURA105.png}
\end{figure}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.6\textwidth]{../ilustracoes/MAT1/SAEB_1ANO_MAT_FIGURA109.png}
\end{figure}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.6\textwidth]{../ilustracoes/MAT1/SAEB_1ANO_MAT_FIGURA111.png}
\end{figure}
