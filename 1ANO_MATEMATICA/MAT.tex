...
\begin{minipage}{.8\textwidth}
\includegraphics[width=\textwidth]{../ilustracoes/MAT1/SAEB_1ANO_MAT_FIGURA80.png}
\end{minipage}
...
\end{escolha}
\end{minipage}
\sidetext{SAEB: Ler/identificar ou comparar dados estatísticos ou informações, expressos
