...
\begin{escolha}
\item Susto: \reduline{sus-to\hfill}\reduline{assustar\hfill}

\item
  Barba: \reduline{bar-ba\hfill}\reduline{barbeiro\hfill}

\item
  Saco: \reduline{sa-co\hfill}\reduline{cola\hfill}

\item
  Pedra: \reduline{pe-dra\hfill}\reduline{dreiro\hfill}

\item
  Manteiga: \reduline{man-tei-ga\hfill}\reduline{amanteigado\hfill}
\end{escolha}
