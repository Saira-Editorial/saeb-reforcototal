...
% \begin{figure}[htpb]
% \vspace*{-2.5cm}
% \hspace*{-2.5cm}\includegraphics[height=\paperheight]{../separadores/separadorEDF9A.png}
% \end{figure}

% \pagebreak
% \begin{figure}[htpb]
% \vspace*{-2.5cm}
% \hspace{-3cm}\includegraphics[height=\paperheight]{../separadores/separadorEDF9B.png}
% \end{figure}
