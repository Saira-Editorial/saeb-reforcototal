...
\newcommand\MyCirc{\raisebox{-2pt}{\tikz\draw[fill,red!40] circle (1ex);}\,}
\newcommand\MySemi{\raisebox{-2pt}{\tikz\draw[fill,red!40] (0,0) arc (90:360/4*3:1ex);}\,}

\num{8} Considerando o diagrama abaixo, qual fração representa a
quantidade de crianças que preferem hamster como animal de estimação (\MyCirc $=2$)?
...
Gato     & \MyCirc \MyCirc \MyCirc \MyCirc \MySemi\\
Cachorro & \MyCirc \MyCirc \MySemi \\
Pássaro  & \MyCirc \MyCirc \MyCirc \MySemi \\
Hamster  & \MyCirc\MyCirc\MyCirc\MyCirc\MyCirc
\end{tabular}
\end{center}
\end{table}
...
Qual a fração correspondente à quantidade que Juca comeu?

\begin{figure}[htpb!]
\begin{center}
\includegraphics[width=.5\textwidth]{./tikz/032.pdf}
\end{center}
\end{figure}
...
\num{1} Mateus montou figuras com palitos de fósforo. Na 1ª figura, montou
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.6\textwidth]{./tikz/033.pdf}
\end{figure}
...
\hspace{2cm}\includegraphics[width=.6\textwidth]{./tikz/015.pdf}
% 
...
\hspace{2cm}\includegraphics[page=4,width=.3\textwidth]{./tikz/019.pdf}
...
\begin{emptybox}
\coment{
\includegraphics[width=\textwidth]{./tikz/034.pdf}
...
\pagebreak
\num{6} Escreva os respectivos nomes dos segmentos e retas:

\begin{figure}[htpb!]
\centering
\includegraphics[width=.5\textwidth]{./tikz/036.pdf}
\end{figure}
...
\end{enumerate}
\end{multicols}
% TODO: colocar respostas dentro dos itens
\reduline{
  $a=$ raio; 
  $b=$ corda; 
  $c=$ secante;
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.8\textwidth]{./tikz/035.pdf}
\end{figure}
...
\textbf{Mês}   & \textbf{Quantidae de queijos}\\
...
\noindent\includegraphics[width=\textwidth]{./tikz/037.pdf}
...
\noindent\includegraphics[width=.8\textwidth]{./tikz/038.pdf}

\item Capacidade

\noindent\includegraphics[width=.8\textwidth]{./tikz/039.pdf}
\end{enumerate}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.5\textwidth]{./tikz/040.pdf}
\end{figure}
