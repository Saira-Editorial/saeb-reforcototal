...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.7\textwidth]{./imgs/img7.jpg}
...
\num{5}  O corpo humano é muito complexo, formado por \preencher{sistemas} 
...
\preencher{Mercúrio} é um planeta rochoso, conhecido por ser
o mais próximo do Sol e, portanto, o primeiro do nosso sistema solar. Em
contrapartida, \preencher{Netuno} é um planeta gasoso e o mais distante
