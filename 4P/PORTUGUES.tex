...
\noindent\includegraphics[width=\textwidth]{media/image1.jpeg}
...
\item\reduline{O termo \textbf{belas} pertence à classe dos adjetivos.\hfill}

\item
A que classe de palavras pertence a palavra \textbf{fraqueza}?
\item\reduline{A palavra \textbf{fraqueza} pertence à classe dos substantivos.\hfill}
\end{escolha}
...
\item\reduline{Filha.\hfill}
\linhas{1}

\item Quem é o destinatário dessa carta?
\item\reduline{Cecília.\hfill}
\linhas{1}

\item Escreva qual foi a despedida da carta. 
\item\reduline{Beijo, Mamãe.\hfill}
\linhas{1}
\end{escolha}
...
\item\reduline{O texto lido pode ser considerado instrucional porque é uma receita de
...
para fazer o suco?
\item\reduline{Para fazer o suco, é necessário usar 1 beterraba média e 1
colher de açúcar.\hfill}
\linhas{1}

\item Como você descobriu essa informação?
\item\reduline{A informação está presente na lista de ingredientes da receita.\hfill}
\linhas{1}

\item No modo de preparo, por que não é necessário expor a quantidade de
ingredientes que devem ser utilizadas?
\item\reduline{A quantidade já foi informada na lista de ingredientes\hfill}
\linhas{1}
\end{escolha}
...
\item\reduline{O texto pode ser considerado instrucional porque sua finalidade
é auxiliar o leitor a realizar determinada tarefa, por meio de instruções
específicas.\hfill}

\item Qual é o objetivo do texto lido?
\item\reduline{O objetivo do texto lido é ensinar a fazer um origami em forma de coração.\hfill}

\item Que características do texto instrucional podem ser encontradas no texto lido?
\item\reduline{O título em destaque, apresentando claramente o que o leitor
...
\item\reduline{A Prefeitura de Guiricema promoveu o cartaz analisado.\hfill}
\linhas{1}
...
\item\reduline{Os alunos podem citar o colorido do cartaz, a ilustração de uma
...
Feira de Santana?
\item\reduline{O Festival Nacional de Teatro Infantil de Feira de Santana já aconteceu 10 vezes\hfill}

\item Quais são as atividades paralelas que vão ocorrer durante o festival?
\item\reduline{Oficinas, palestras, \emph{Workshops}, exibição de filmes e documentários.\hfill}
...
\item\reduline{O desenho de um personagem infantil foi usado para atrair a atenção das crianças.\hfill}
\linhas{1}

\item Quando esse festival aconteceu? 
\item\reduline{O festival ocorreu de 01 a 12 de outubro de 2017.\hfill}
\linhas{1}
\end{escolha}
...
\item\reduline{O objetivo da campanha é a conscientização a respeito da economia
de água durante o banho.\hfill}
\linhas{2}

\item Segundo o cartaz, como se pode economizar água durante o banho?
\item\reduline{Para economizar água, o banho não deve durar mais de cinco minutos
...
\item\reduline{Resposta pessoal. Aproveite o momento e explique aos alunos que a
...
\noindent\includegraphics[width=\textwidth]{media/image20.png}}
...
\item\reduline{Na notícia, relata-se que um menino de 4 anos sobreviveu sozinho por 2 dias em mata densa e fria, no Estado de Montana, nos Estados Unidos.\hfill}

\pagebreak
\item Onde o fato relatado aconteceu?
\item\reduline{O fato aconteceu em Montana, nos EUA.\hfill}
\linhas{1}

\item Quando o fato aconteceu?
\item\reduline{O menino desapareceu na sexta-feira, 03/06, e foi encontrado no 
domingo, 05/06.\hfill}
\linhas{3}
...
\item\reduline{Os envolvidos no fato são Ryker Webb, equipes de socorristas,
autoridades e voluntários.\hfill}
\linhas{2}

\item Onde a notícia foi publicada?
\item\reduline{A notícia foi publicada no site Observatório do terceiro setor.\hfill}
\linhas{1}

\item Quem escreveu a notícia?
\item\reduline{A autora da notícia é Maria Fernanda Garcia\hfill}
\linhas{1}

\item Essa notícia foi escrita para quem?
\item\reduline{Espera-se que os alunos percebam que a notícia é destinada a
...
\item\reduline{Sugere-se que os alunos compartilhem as respostas, averiguando
