...
\begin{myquote}
Onda de calor levará a temperaturas recordes nos próximos dias
...
O mês de agosto já vem sendo marcado por calor acima do normal, como em Cuiabá (MT), que registrou temperaturas entre 38°C e 40°C durante todo o período entre 1 e 12 de agosto. A média normal de temperatura máxima para agosto é de 34,7°C, pelo cálculo para o período de 1991 a 2020, informa a Climatempo.
...
\fonte{Disponível em: https://globorural.globo.com/previsao-do-tempo/noticia/2023/08/onda-de-calor-levara-a-temperaturas-recordes-nos-proximos-dias.ghtml. Acesso em: 22 ago 2023.}
\end{myquote}
...
https://pt.wikisource.org/wiki/O\_Mar\_(Cruz\_e\_Sousa). Acesso em 4 maio 2023.}
\end{myquote}
...
<https://pt.wikisource.org/wiki/O\_Guarani/II/X>. Acesso em: 4 maio
2023.}
\end{myquote}
...
e intersetorial''. \textit{Agência Brasil}. 
...
ser entrevistado''. \textit{Agência Brasil}. Disponível em: https://agenciabrasil.ebc.com.br/geral/noticia/2023-01/nao-sou-o-substituto-do-google-afirma-chatgpt-ao-ser-entrevistado. com alterações. 
Acesso em: 4 maio 2023.}
\end{myquote}
...
\begin{center}
\includegraphics[width=.7\textwidth]{media/image45.png}
\end{center}

1. Consiga gizes coloridos e uma pedrinha;

2. Escolha uma área onde você possa escrever e desenhar no chão. Para isso, peça autorização a um adulto; 

3. Reserve uma àrea na entrada e outra na saída, que você pode chamar de início e fim;

4. Avalie qual o tamanho de cada quadrado, para que todos caibam no espaço escolhido;

5. Com os gizes, desenhe os quadrados coloridos no chão;

6. Em cada quadrado, escreva os números de 1 a 10;

7. Vamos às regras: A pedra deve ser lançada primeiro no número um, 
...
8. Convide seus amigos e sua família para brincar com você.

\fonte{Texto adaptado. ``Brincar de Amarelinha''. Secretaria Municipal de Educação de Goiânia. Disponível em: https://sme.goiania.go.gov.br/conexaoescola/ensino\_fundamental/brincar-de-amarelinha/. Acesso em: 4 maio 2023.}
\end{myquote}
...
https://pt.wikisource.org/wiki/Iracema. Acesso em: 4 maio 2023. com
adaptações.}
\end{myquote}
...
\fonte{Mário de Andrade. Macunaíma. Disponível em:
https://pt.wikisource.org/wiki/Macunaíma/1928. Acesso em: 4 maio
2023.}
\end{myquote}
...
em terra Yanomami. Disponível em: https://agenciabrasil.ebc.com.br/saude/noticia/2023-04/centro-de-referencia-em-saude-indigena-e-inaugurado-em-terra-yanomami. Acesso em: 4 maio 2023}
\end{myquote}
...
\fonte{Casimiro de Abreu. Meus oito anos. Disponível em: http://www.pb.utfpr.edu.br/literaturalusofona/Infancia/Casimiro\%20de\%20Abreu/Meus\_oito\_anos\_Casimiro\_de\_Abreu.pdf. Acesso em: 5 maio 2023.}
\end{myquote}
...
\fonte{Imagem contendo Diagrama Descrição gerada automaticamente. Disponível em: Secretaria da Saúde do Governo do Estado da Bahia.
...
brasileiras''. \textit{Agência Brasil}. Disponível em:
...
públicas para leitura''. \textit{Agência Brasil}. Disponível em:
...
Contra o Trabalho Infantil. Disponível em: https://www2.bauru.sp.gov.br/materia.aspx?n=34083. Acesso em: 5 maio 2023.}
...
https://pt.wikisource.org/wiki/Lucíola. Acesso em: 5 maio 2023.}
\end{myquote}
...
traduzida. \textit{Agência Brasil}. Disponível em:
