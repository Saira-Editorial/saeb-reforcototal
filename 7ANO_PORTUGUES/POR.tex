...
\textbackslash{}rosa\{F\} & Apresentam linguagem de difícil compreensão \\ \hline
\textbackslash{}rosa\{F\} & Utilizam apenas recursos não verbais \\ \hline
\textbackslash{}rosa\{V\} & Pretendem convencer \\ \hline
\textbackslash{}rosa\{V\} & Apresentam linguagem objetiva \\ \hline
\end{tabular}
\end{table}
...
\textbackslash{}rosa\{V\} & Apresentam linguagem direta \\ \hline
\textbackslash{}rosa\{V\} & Contêm verbos no imperativo \\ \hline
\textbackslash{}rosa\{F\} & Servem para divulgar conhecimentos \\ \hline
\textbackslash{}rosa\{V\} & Tem como objetivo convencer ou informar \\ \hline
\end{tabular}
\end{table}
...
\item\reduline{O texto se destina a jovens, como se pode verificar por meio do trecho 
...
\item\reduline{Ao apresentar o número de jovens que sofrem com problemas de alcoolismo, a
...
\multicolumn{1}{|c|}{\textbf{1}} & \textbf{petição} & \textbackslash{}rosa\{1\} & É um texto argumentativo de reivindicação \\ \hline
\multicolumn{1}{|c|}{\textbf{2}} & \textbf{estatuto} & \textbackslash{}rosa\{4\} & Tem como objetivo divulgar informações \\ \hline
\multicolumn{1}{|c|}{\textbf{3}} & \textbf{folheto} & \textbackslash{}rosa\{3\} & \begin{tabular}[c]{@{}c@{}}Utiliza recursos não verbais como \\ forma de persuasão\end{tabular} \\ \hline
\multicolumn{1}{|c|}{\textbf{4}} & \textbf{notícia} & \textbackslash{}rosa\{2\} & Tem por objetivo regulamentar e normatizar \\ \hline
\end{tabular}
\end{table}
...
\hline
\rosa{1, 2} & Poucos personagens \\ 
\rosa{1, 2} & Curto e objetivo \\ 
\rosa{1} & Histórias narram fatos do cotidiano e podem estimular a reflexão \\ 
\rosa{2} & Podem surgir de narrativas populares transmitidos pela tradição oral \\ 
\rosa{1} & É comum que seja publicado em jornais \\ 
\end{tabular}
\end{table}
...
\hline
\textbf{\begin{tabular}[c]{@{}c@{}}Verdadeiro (V) \\ ou Falso (F)?\end{tabular}} & \textbf{Afirmação} \\ \hline
\textbackslash{}rosa\{F\} & É a prática de copiar trechos de outras obras \\ \hline
\textbackslash{}rosa\{V\} & \begin{tabular}[c]{@{}c@{}}É um recurso que pode trazer ainda mais \\ possibilidades de interpretação para um texto\end{tabular} \\ \hline
\textbackslash{}rosa\{V\} & \begin{tabular}[c]{@{}c@{}}Pode estar implícita ou explícita em textos \\ e demais obras artísticas\end{tabular} \\ \hline
\textbackslash{}rosa\{V\} & \begin{tabular}[c]{@{}c@{}}Pode estar presente em traduções, paródias \\ e releituras de obras\end{tabular} \\ \hline
\textbackslash{}rosa\{F\} & Pode ser caracterizada como plágio \\ \hline
\end{tabular}
\end{table}
...
\textbackslash{}rosa\{O\} & A melhor hora para dormir é o começo da tarde \\ \hline
\textbackslash{}rosa\{F\} & Dormir 8 horas por dia melhora a saúde \\ \hline
\textbackslash{}rosa\{F\} & O médico receitou remédios controlados \\ \hline
\textbackslash{}rosa\{O\} & Os remédios controlados são baratos \\ \hline
\end{tabular}
\end{table}
...
\hline
\textbf{\begin{tabular}[c]{@{}c@{}}Verdadeiro (V) \\ ou \\ Falso (F)\end{tabular}} & \textbf{Afirmação} \\ \hline
\textbackslash{}rosa\{F\} & Fatos são baseados em sentimentos e impressões \\ \hline
\textbackslash{}rosa\{F\} & Opiniões são suficientes para adquirir conhecimento \\ \hline
\textbackslash{}rosa\{F\} & Opiniões são baseadas em questões objetivas \\ \hline
\textbackslash{}rosa\{V\} & Opiniões são baseadas em sentimentos e impressões \\ \hline
\textbackslash{}rosa\{V\} & Fatos se apoiam em evidências \\ \hline
\end{tabular}
\end{table}
...
\textbf{1} & \begin{tabular}[c]{@{}c@{}}Estudiosos alertam para os riscos de doenças \\ cardiovasculares e o sedentarismo\end{tabular} & \textbackslash{}rosa\{1\} & \begin{tabular}[c]{@{}c@{}}Análise de hábitos de pacientes com problemas cardiovasculares \\ traz novas informações sobre como prevenir doenças crônicas\end{tabular} \\ \hline
\textbf{2} & Casos de dengue preocupam secretarias de saúde & \textbackslash{}rosa\{3\} & \begin{tabular}[c]{@{}c@{}}Associação brasileira de pediatria publica estudo sobre os impactos\\  dos jogos e redes sociais na vida de adolescentes\end{tabular} \\ \hline
\textbf{3} & \begin{tabular}[c]{@{}c@{}}O perigo está em casa: Pediatras alertam sobre o uso \\ excessivo de telas por crianças e adolescentes\end{tabular} & \textbackslash{}rosa\{4\} & \begin{tabular}[c]{@{}c@{}}Ministério da saúde lança cartilha para informar a população \\ sobre as formas de contágio da doença\end{tabular} \\ \hline
\textbf{4} & Covid-19: Informar para proteger & \textbackslash{}rosa\{2\} & \begin{tabular}[c]{@{}c@{}}Alerta foi dado às secretarias de saúde de todo país, especialmente \\ nas regiões em que se inicia o período de chuvas\end{tabular} \\ \hline
\end{tabular}
\end{table}
...
\textbackslash{}rosa\{V\} & \begin{tabular}[c]{@{}c@{}}A imparcialidade no jornalismo é importante pois promove \\ a formação de opinião a partir dos fatos apresentados na reportagem\end{tabular} \\ \hline
\textbackslash{}rosa\{F\} & \begin{tabular}[c]{@{}c@{}}O princípio da imparcialidade no jornalismo significa que o jornalista \\ não deve apresentar os diferentes pontos de vista e deixar que o público \\ forme sua própria opinião\end{tabular} \\ \hline
\textbackslash{}rosa\{V\} & \begin{tabular}[c]{@{}c@{}}A imparcialidade no jornalismo pode levar a erros de interpretação e \\ compreensão dos fatos por parte do público, prejudicando a credibilidade da reportagem do jornalista\end{tabular} \\ \hline
\textbackslash{}rosa\{V\} & \begin{tabular}[c]{@{}c@{}}A falta de apresentação de fontes e dados confiáveis pode ser uma \\ característica de parcialidade por parte do jornalista ou do veículo de \\ comunicação colocando em dúvida a qualidade das notícias veiculadas\end{tabular} \\ \hline
\end{tabular}
\end{table}
...
\textbackslash{}rosa\{V\} & a campanha sugere que não se deve dirigir após beber \\ \hline
\textbackslash{}rosa\{F\} & a campanha sugere que as pessoas não devem beber durante o carnaval \\ \hline
\textbackslash{}rosa\{F\} & a campanha orienta os foliões a não dirigir no carnaval \\ \hline
\textbackslash{}rosa\{F\} & a campanha pretende alertar sobre a violência no trânsito \\ \hline
\end{tabular}
\end{table}
...
\textbf{1} & É necessária a presença de um acompanhante & \textbackslash{}rosa\{2\} & Expressa proibição \\ \hline
\textbf{2} & É proibida a entrada de acompanhante & \textbackslash{}rosa\{1\} & Expressa obrigatoriedade \\ \hline
\textbf{3} & É permitida a entrada de um acompanhante & \textbackslash{}rosa\{3\} & Expressa permissão \\ \hline
\end{tabular}
\end{table}
...
\hline
\textbf{\begin{tabular}[c]{@{}c@{}}Verdadeiro (V)\\ ou Falso (F)?\end{tabular}} & \textbf{Afirmação} \\ \hline
\textbackslash{}rosa\{F\} & toda situação comunicativa exige o uso da norma-padrão \\ \hline
\textbackslash{}rosa\{V\} & \begin{tabular}[c]{@{}c@{}}o uso da norma-padrão é mais adequado para a redação de\\ documentos oficiais, textos de lei e petições\end{tabular} \\ \hline
\textbackslash{}rosa\{F\} & textos literários devem sempre fazer uso da norma-padrão \\ \hline
\textbackslash{}rosa\{V\} & em algumas situações, é mais adequado não utilizar a norma-padrão \\ \hline
\textbackslash{}rosa\{V\} & \begin{tabular}[c]{@{}c@{}}a escolha pelo uso da norma-padrão ou de variações que se distanciam dela\\  deve orientar-se pelo contexto da comunicação\end{tabular} \\ \hline
\end{tabular}
\end{table}
