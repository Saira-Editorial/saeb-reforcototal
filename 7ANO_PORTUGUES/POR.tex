...
\begin{table}[]
\begin{tabular}{ll}
\begin{tabular}[c]{@{}l@{}}(I) Ceará\\ (II) Pernambuco\end{tabular} & \begin{tabular}[c]{@{}l@{}}(\rosa{II}) O segundo colocado em número de casos de feminicídio.\\ (\rosa{II}) Estado onde ocorre pelo menos um caso a cada dois dias.\\ (\rosa{II}) O primeiro colocado em número de casos de transfeminícidio.\\ (\rosa{I}) O primeiro colocado em número de casos de transfeminicídio nos anos anteriores.\end{tabular}
\end{tabular}
\end{table}
