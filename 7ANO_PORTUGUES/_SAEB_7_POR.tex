...
\textbf{(EF69LP27)} Analisar a forma composicional de textos
...
\conetudo{Os elementos utilizados para argumentação em textos podem ser muitos.
...
\coment{O que nos faz rir? Existem alguns recursos e maneiras de relacionar
...
\conetudo{Professor(a), estimule os estudantes a pensarem em exemplos. O uso de
...
\textbf{(EF07LP14)}Identificar, em textos, os efeitos de sentido do uso
...
\textbf{(EF67LP38)} Analisar os efeitos de sentido do uso de figuras de
