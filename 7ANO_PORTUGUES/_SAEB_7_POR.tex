...
\fonte{Freepick. https://br.freepik.com/fotos-gratis/full-shot-garota-sentada-na-mala_11309223.htm#query=mulher\%20observando\%20o\%20mar&position=21&from_view=search&track=ais}

\num{1} Na imagem acima pode-se perceber que o humor está presente. Qual  palavra está sendo usada para produzir esse efeito?
...
\textit{vender}, isto é: para ele, a menina \textit{está vendendo} o pôr do sol. 
...
\linhas{4}
\coment{A menina quer dizer que está 
\textit{observando} o pôr do sol; neste sentido, ``vendo'' é gerúndio do
verbo \textit{ver}.} 
