...
\begin{figure}[htpb!]
\includegraphics[width=\textwidth]{./imgs/art6.png}
\end{figure}
...
\begin{figure}[htpb!]
\includegraphics[width=\textwidth]{./imgs/art7.png}
\end{figure}
...
\begin{figure}[htpb!]
\includegraphics[width=\textwidth]{./imgs/art13.png}
\end{figure}
...
\begin{figure}[htpb!]
\includegraphics[width=\textwidth]{./imgs/art14.png}
\end{figure}
...
\begin{figure}[htpb!]
\acima{(\rosa{4})}
\includegraphics[width=.5\textwidth]{./imgs/art15c.jpg}
\end{figure}
\begin{figure}[htpb!]
\acima{(\rosa{1})}
\includegraphics[width=.5\textwidth]{./imgs/art15d.jpg}
\end{figure}
...
\multicolumn{1}{|l|}{cabaça} & \multirow{4}{*}{\begin{tabular}[c]{@{}l@{}}Para marcar o ritmo do canto e da dança durante cerimônias,\\ festividades, ritos e outras manifestações culturais e sociais.\end{tabular}} \\
\multicolumn{1}{|l|}{pedras, caroços ou sementes} &  \\
\multicolumn{1}{|l|}{madeira} &  \\
\multicolumn{1}{|l|}{penas} &  \\ \hline
\end{tabular}
...
\includegraphics[width=.5\textwidth]{./imgs/art22a.jpg}
%\caption{Vestimenta do século XVIII.}
\includegraphics[width=.5\textwidth]{./imgs/art22b.jpg}
%\caption{Trajes típicos bolivianos.}

\includegraphics[width=.5\textwidth]{./imgs/art22c.jpg}
%\caption{Chinesa comendo com palitinhos.}
\includegraphics[width=.5\textwidth]{./imgs/art22d.jpg}
%\caption{Criança aprendendo a fazer pão de queijo com o pai.}

\includegraphics[width=.5\textwidth]{./imgs/art22e.jpeg}
%\caption{Grupo mexicano de dança – Festa dos Mortos.}
\includegraphics[width=.5\textwidth]{./imgs/art22f.jpg}
%\caption{Fotos de família.}
...
\begin{figure}[htpb!]
\acima{c)}
\includegraphics[width=.5\textwidth]{./imgs/art30c.jpg}
\end{figure}
\begin{figure}[htpb!]
\acima{d)}
\includegraphics[width=.5\textwidth]{./imgs/art30d.jpeg}
\end{figure}
