...
\coment{\textbf{Habilidades da BNCC}: EF15AR01, EF15AR02, EF15AR08, EF15AR13,
EF15AR14, EF15AR18}
...
\begin{figure}[htpb!]
\includegraphics[width=\textwidth]{./imgs/art5.png}
\end{figure}
...
\begin{figure}[htpb!]
\includegraphics[width=\textwidth]{../ilustracoes/ART5/SAEB_5ANO_ART_FIGURA5.png}
\end{figure}
...
\reduline{Após a realização da atividade, divida a turma em seis grupos, e cada grupo
...
em: \emph{https://bit.ly/3VDcleP}; \emph{Vídeo Grupo Sucena} \emph{– Samba De Roda:} \emph{Ritmos e Manifestações Afro-Brasileiras}, disponível em: \emph{https://bit.ly/3NLWBnY};
...
\conteudo{ \textbf{Bata palma com as costas da mão}: feche uma das mãos e bata as costas
  da mão fechada na palma da outra mão.}
\conteudo{ \textbf{Faça estalos com os dedos}: deslize o polegar pelo dedo médio,
  deixando que este dedo bata contra a parte inferior do outro dedo.}
\conteudo{ \textbf{Bata a palma estrela}: abra bem as duas mãos e bata uma contra
  a outra.}
\conteudo{ \textbf{Bata no peito}: abra as mãos e bata as duas, alternadamente,
  contra cada um dos lados do peito.}
\conteudo{ \textbf{Bata na barriga}: abra as mãos e bata cada uma delas, alternadamente,
  contra um dos lados da barriga.}
\conteudo{ \textbf{Bata nas coxas}: com as mãos abertas, bata em cada uma das coxas.}
\conteudo{ \textbf{Faça estalo com os lábios}: feche bem os lábios e, em um movimento
  rápido, abra-os bem, fazendo um estalo.}
\conteudo{ \textbf{Faça barulho com beijo}: estale os lábios dando um beijo no ar.}
\conteudo{ \textbf{Faça estalo com a língua}: com a boca aberta, deslize a língua
...
\includegraphics[width=\textwidth]{./imgs/art22ab.png}
\end{minipage}
\begin{minipage}{\textwidth}\vspace{.5cm}
Vestimenta do século XVIII e trajes típicos bolivianos
\end{minipage}\bigskip

\begin{minipage}{\textwidth}
\includegraphics[width=\textwidth]{./imgs/art22cd.png}
\end{minipage}
\begin{minipage}{\textwidth}\vspace{.5cm}
Chinesa comendo com palitinhos e criança aprendendo a fazer pão de queijo com o pai
\end{minipage}\bigskip
}
