...
\begin{itemize}
\item Criança: De \reduline{zero\hspace{2cm}} até \reduline{doze\hspace{2cm}} anos de idade.

\item Adolescente: Entre \reduline{doze\hspace{2cm}} e \reduline{dezoito\hspace{2cm}} anos de idade.
\end{itemize}
