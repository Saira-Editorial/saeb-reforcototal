...
\chapter{\LARGE Representações de tempo e espaço}
\markboth{Módulo 1}{}
...
\end{escolha}
\end{minipage}
\sidetext{a) Incorreta. Não há indícios no texto sobre a relação da nomeação com
proteção.
...
\end{escolha}
\end{minipage}
\sidetext{a) Incorreta. Não é o professor, mas o estado o responsável pela criação
...
\boxitem{\color{white}{X}} Garantir moradia a todos.

\boxitem{X} Permitir trabalho escravo e forçado.

\boxitem{\color{white}{X}} Tratar todos de maneira igual.

\boxitem{X} Condenar alguém de maneira injusta.

\boxitem{\color{white}{X}} Oferecer bom salário e boas condições de trabalho.
...
\end{escolha}
\end{minipage}
\sidetext{a) Correta. Vital fala que estamos escolhendo quem vai tomar as decisões
...
\end{escolha}
\end{minipage}
\sidetext{a) Incorreta. O texto não fala sobre a intenção de ganhar dinheiro
...
\end{escolha}
\end{minipage}
\sidetext{a) Incorreto. Não se trata de um pasto, mas de uma indústria.
...
\end{escolha}
\end{minipage}
\sidetext{a) Incorreta. O avião é um transporte atual e não antigo.
...
\begin{figure}[htpb!]
\vspace*{-3cm}
\hspace*{-2.5cm}\includegraphics[scale=1]{../watermarks/1simulado5ano.pdf}
\end{figure}
\newwatermark[pagex={57,59}]{\vspace{2.5cm}\hspace*{8cm}\includegraphics[scale=1]{../watermarks/bgsim5anoimpar.pdf}}
\newwatermark[pagex={58}]{\vspace{2.5cm}\hspace*{7.8cm}\includegraphics[scale=1]{../watermarks/bgsim5anopar.pdf}}
...
\end{escolha}
\end{minipage}
\sidetext{a) Incorreta. O desmatamento das florestas pode piorar a poluição nos
rios.
...
\coment{BNCC: EF05GE10 - Reconhecer e comparar atributos da qualidade
...
\end{escolha}
\end{minipage}
\sidetext{a) Incorreto. A prática não deve necessariamente ter retorno financeiro
...
\num{5} Home Office, ao pé da letra, significa algo como “escritório em casa”. Isso significa que o
...
\num{2} O Brasil é dividido em cinco regiões. Identifique cada uma conforme sua numeração no mapa abaixo:
...
\end{escolha}
\end{minipage}
\sidetext{a) Correta. Precisamos da pecuária para as carnes e da agricultura para
...
\end{escolha}
\end{minipage}
\sidetext{a) Incorreta. O texto não fala que os objetos ameaçam o meio ambiente.
...
\coment{BNCC: EF05HI07 - Identificar os processos de produção, hierarquização e difusão
dos marcos de memória e discutir a presença e/ou a ausência de
diferentes grupos que compõem a sociedade na nomeação desses marcos de
memória.}

\num{2} A imagem abaixo representa a seguinte ação individual prejudicial ao meio ambiente:
...
\end{escolha}
\end{minipage}
\sidetext{a) Incorreta. A imagem não mostra o corte de árvores.
...
\end{escolha}
\end{minipage}
\sidetext{a) Incorreta. A escrita não foi inventada pelos fenícios.
...
\end{escolha}
\end{minipage}
\sidetext{a) Incorreta. Não é um relógio.
...
\end{escolha}
\end{minipage}
\sidetext{a) Incorreta. Um condomínio residencial não é considerado patrimônio
...
\end{escolha}
\end{minipage}
\sidetext{a) Incorreta. O texto não fala sobre o ferimento do direito de proteção
contra a tortura.
