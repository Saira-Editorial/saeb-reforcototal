...
% Experiências com o Paulo para resolver alinhamento
\reduline{Metus maximus scelerisque lectus diam magnis aliquam leo dignissim
nibh lacinia si est imperdiet amet duis cubilia mi nunc semper auctor pulvinar
parturient fusce odio accumsan mattis nascetur facilisi turpis congue quam a
	phasellus\hfill\mbox{}}
...
(\coment{3}) Sinal de pontuação que é empregado para indicar uma pergunta.
...
Disponível em:\emph{https://turminha.mpf.mp.br/explore/direitos-das-criancas/saude/dicas-de-saude}.
...
\linhas{2}
\coment{Um texto argumentativo é essencialmente constituído por tese e argumentos.}


\num{3} Assinale V para o que for verdadeiro e F para o que for falso.

\begin{boxlist}
\item É melhor que um texto argumentativo não cite exemplos relacionados à tese. \coment{F}

\item Um texto argumentativo não pretende convencer o leitor a respeito de
um ponto de vista. \coment{F}

\item Um texto argumentativo pode apresentar ações a serem realizadas por alguém em prol de um objetivo relacionado à tese. \coment{V}
...
cuidados a serem observados ao tossirmos ou espirrarmos.}
...
\linhas{3}
\coment{Um texto argumentativo pode apresentar recursos visuais.}


\num{10} Por que é importante que um texto argumentativo traga também esses recursos?

\linhas{4}
\coment{Um texto argumentativo pode lançar mão desse tipo de recurso para fortalecer o
...
\linhas{3}
\coment{O texto em prosa é organizado em parágrafos, enquanto o poema é organizado em versos, que podem ser agrupados em estrofes.}

\num{3} Assinale V para o que for verdadeiro e F para o que for falso.

\begin{boxlist}
\item Um poema necessariamente não explora sonoridades. \coment{F}

\item Um poema pode ser declamado. \coment{V}

\item Os versos de uma estrofe costumam tratar de um mesmo tema. \coment{V}
...
Um conjunto de versos constitui uma \preencher. \coment{estrofe}
...
\linhas{2} O poema está organizado em cinco estrofes.

\item Quantos versos há em cada estrofe?

\linhas{2} Cada uma das três primeiras estrofes contém quatro versos, enquanto cada uma das duas últimas estrofes contém seis versos.
\end{escolha}
...
\linhas{2}
\coment{Possibilidades de resposta: cá/sabiá; flores/amores.}
...
\coment{SAEB: Reconhecer diferentes modos de organização composicional de textos
...
\coment{SAEB: Analisar a construção de sentidos de textos em versos com base em
...
\chapter{6. Modos variados de se escrever e falar}
...
\linhas{4}
\coment{Espera-se que os estudantes identifiquem o texto como escrito em uma
...
\linhas{2}
\coment{Resposta pessoal. Sugestões: apre, mecê, canhe, nhor-sim.}
...
%Paulo: inserir esta imagem: https://br.freepik.com/fotos-gratis/arranjo-de-raizes-nutritivas-de-mandioca_18037118.htm#query=mandioca&position=5&from_view=search&track=sph
...
\linhas{2}
\coment{São estes os nomes: mandioca, macaxeira ou aipim.}


\num{9} Complete as lacunas com exemplos de variação linguística para cada palavra ou expressão.

\begin{escolha}
\item Ônibus: \preencher \preencher. \coment{coletivo}

\item Refrigerante: \preencher \preencher. \coment{refri}

\item Pão francês: \preencher \preencher. \coment{pão de sal; cacetinho}

\item Pipoca: \preencher \preencer. \coment{poca; pipoquinha}
\end{escolha}
...
\linhas{4}
\coment{Resposta pessoal. É importante que os estudantes percebam, por exemplo, que o
...
casa é feita de madeira; a terceira casa é feita de tijolos.}
...
``logo'', ``mais'', ``bastante'', ``firmemente'' e ``finalmente''.}
...
até o momento em que a casa se quebrou completamente.}
...
\fonte{Olavo Bilac. Poesias infantis. Rio de Janeiro: Francisco Alves, 1929. Disponível em: \ewmph{https://www.unicamp.br/iel/memoria/Ensaios/LiteraturaInfantil/Poesias\%20Infantis/Pi01.htm}. Acesso em: 25 mar. 2023.}
\end{quote}
...
\item \textbf{Fatos} são informações objetivas que podem ser comprovadas por evidências
...
\item \textbf{Opiniões} refletem nossos pensamentos, crenças ou
...
\linhas{3}
\coment{Uma notícia no site de um jornal americano que atribuía equivocadamente
a morte de um médico à vacina contra o novo coronavírus.}
...
vacinação tivesse causado a morte do homem.}
...
vacinação tivesse causado a morte do médico.}
...
\linhas{4}
\coment{Isso ocorreu, porque os adeptos desses movimentos encontram no Facebook
um ambiente fértil para a distribuição desse tipo de conteúdo e porque promovem
histórias emotivas para impedir as pessoas de serem vacinadas.}


\num{5} Quantas visualizações o link teve no total?

\linhas{2}
\coment{Foram 54 milhões de visualizações de usuários do Facebook.}
...
\linhas{3}
\coment{O Centro de Controle de Doenças do Departamento de Saúde dos Estados Unidos
afirma que as vacinas são seguras e eficazes.}
...
\linhas{3}
\coment{Essa relação existe, porque esses ativistas encontram no Facebook um ambiente fértil para
a distribuição desse tipo de conteúdo.}
...
\linhas{3}
\coment{Promover histórias emotivas, como a do médico, cuja morte foi equivocadamente atribuída
...
histórias que não encontram validação na realidade, sem embasamento em dados objetivos.}
...
muitas pessoas, nos casos de se voltarem aos temas de saúde e ciência.}
...
%Paulo: inserir esta imagem: https://br.freepik.com/fotos-gratis/loei-tailandia-10-de-maio-de-2017-mao-segurando-samsung-s8-com-aplicativo-movel-para-o-facebook-na-tela_1254944.htm#query=facebook&position=48&from_view=search&track=sph
...
%POR 5 FIGURA 1 - \includegraphics[width=.5\textwidth]{./imgs/chart1.png}
...
%POR 5 FIGURA 2 - \includegraphics[width=.5\textwidth]{./imgs/chart2.png}
...
\linhas{2}
\coment{Trata-se de um gráfico que mostra quantidades diferentes de algo usando barras
...
\linhas{2}
\coment{O gráfico de barras serve para comparar quantidades diferentes de algo.}


\num{3} O que é um gráfico de pizza?

\linhas{2}
\coment{Trata-se de um gráfico que representa porcentagens de algo, usando fatias (porções) de uma uma figura parecida com uma pizza (o todo).}

\num{4} Para que serve um gráfico de pizza?

\linhas{2}
\coment{O gráfico de pizza serve para mostrar a proporção de algo em relação ao todo.}


\num{5} Como podemos comparar quantidades usando um gráfico de barras?

\linhas{2}
\coment{Por meio de um gráfico de barras, quantidades podem ser comparadas por meio da comparação entre as alturas (barras verticais) ou os comprimentos (barras horizontais) dos elementos do gráfico.}


Analise o gráfico a seguir para resolver as atividades de 6 a 8.

\begin{figure}[htpb!]
%POR 5 - FIGURA 3 - \includegraphics[width=.5\textwidth]{./imgs/chart3.png}
\end{figure}
...
\linhas{2}
\coment{O sabor mais popular é aquele que é representado, no gráfico, pela fatia maior da pizza.}
...
\linhas{1}
\coment{O sorvete de chocolate ao leite.}
\end{escolha}
...
\linhas{2}
\coment{Chocolate ao leite < baunilha < chocolate branco < morango.}


\num{8} Com base nos dados do gráfico, adapte as informações para um gráfico de barras verticais.

%Paulo: aqui é preciso criar um retângulo razoável para os alunos desenharem um gráfico como resposta. Na versão do professor, dentro do retângulo para a resposta dos alunos, inserir a imagem POR 5 - FIGURA 4.


\num{9} A seguir, marque V para o que for verdadeiro e F para o que for falso.

\begin{boxlist}
\item Gráfico é uma forma escrita de organizar informações. \coment{F}

\item Pode ser mais fácil depreender determinados dados por meio de um gráfico. \coment{V}

\item Uma tabela e um gráfico podem estar vinculados no que se referem aos dados apresentados. \coment{V}

\item Uma tabela não pode originar um gráfico. \coment{F}

\item Um gráfico sem dados numéricos não pode ser adaptado para uma tabela. \coment{V}
\end{boxlist}
...
\linhas{3}
\coment{O número de pessoas que preferem sorvete de chocolate é maior que a metade do todo, e isso pode ser afirmado porque a fatia da pizza que representa esse grupo é maior que meia pizza.}
...
\conteudo{Uma sequência de sons forma uma palavra. Palavras unidas de determinado modo formam uma frase e, no caso dos textos em prosa, frases organizam parágrafos, que são colocados em um texto como uma sequência lógica. A \textbf{progressão textual} é como uma estrada que nos leva de um lugar para outro: no caso dos textos, ela nos leva de uma ideia para outra.
...
\linhas{3}
\coment{Ela resolveu chamar sua melhor amiga, Ana, para acompanhá-la em um
...
\linhas{2}
\coment{O parque ficava bem perto da casa de Sofia.}
...
\linhas{2}
\coment{Ana contou sobre as férias que passou na praia.}


\num{8} Sobre o que Sofia falou com Ana?

\linhas{2}
\coment{Sofia falou sobre o livro que estava lendo.}
...
\emph{https://www.grimmstories.com/pt/grimm_contos/o_anao_saltador}.
...
\coment{Identificar os mecanismos de progressão textual. BNCC:
...
\coment{SAEB: Localizar informação explícita. BNCC: EF15LP03 - Localizar
...
\coment{SAEB: Identificar elementos constitutivos de textos narrativos. BNCC:
...
\coment{SAEB: Reconhecer diferentes modos de organização composicional de textos em versos.
...
\coment{SAEB: Identificar as variedades linguísticas em textos. BNCC: EF35LP22
...
\coment{SAEB: Identificar as marcas de organização de textos dramáticos. BNCC:
...
\coment{SAEB: Reconhecer diferentes gêneros textuais. BNCC: EF35LP29 -
...
\coment{SAEB: Analisar informações apresentadas em gráficos, infográficos ou
