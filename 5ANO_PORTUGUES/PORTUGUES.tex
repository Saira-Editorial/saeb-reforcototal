...
{\hspace*{-.3cm}\marginnote{Os alunos serão expostos a textos argumentativos neste módulo. O
...
\marginnote{\color{black}\hspace*{-.8cm}
\begin{tabular}{ll}
...
\conteudo{\includegraphics[width=\textwidth]{./imgs/img22.jpg}\bigskip
