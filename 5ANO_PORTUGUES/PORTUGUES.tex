...
\coment{SAEB: Identificar os mecanismos de referenciação lexical e pronominal.
...
\coment{SAEB: Reconhecer em textos o significado de palavras derivadas a partir
...
\coment{SAEB: Inferir o sentido de palavras ou expressões em textos. BNCC:
...
da palavra, relacionado ao sentido de ``dinheiro''.}
...
d) Correta. O trecho ``uma \textit{startup} {[}...{]} voltada a melhorar a
