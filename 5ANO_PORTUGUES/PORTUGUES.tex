...
%\fonte{Fonte: https://unsplash.com/pt-br/fotografias/kcT-7cirBEw. Acesso 20/02/2023.}
...
%\fonte{Fonte: https://unsplash.com/pt-br/fotografias/soH7UcycvKA. Acesso em: 20/02/2023.)
...
\coment{O texto fala sobre a comemoração do Carnaval no Brasil.}
...
\item É possível deduzirmos informações a partir de um texto. \coment{V}
\end{boxlist}
...
Cuidar: \preencher \coment{cuidado}

Falar: \preencher \coment{falado}

Terminar: \preencher \coment{terminado}

Trabalhar: \preencher \coment{trabalhado}
\end{escolha}
...
\begin{boxlist}
\item É possível concluirmos que Luciana tem uma gata. \coment{V}

\item Luciana andava a pé pela rua. \coment{F}

\item Lili é o nome da gata de Luciana. \coment{V}
\end{boxlist}
...
\linhas{2}
\coment{A terminação -s é utilizada para indicar o uso do plural.}
\end{escolha}
...
%\fonte{fonte: https://pixabay.com/pt/photos/aster\%c3\%b3ide-cometa-meteorito-3628185/. Acesso em 20/02/2023.)
...
\fonte{Fonte:
https://g1.globo.com/ciencia/noticia/2023/02/15/asteroide-de-mais-de-1-km-vai-passar-proximo-da-terra-nesta-quarta-15-entenda-classificacao-da-nasa.ghtml.
...
\fonte{Fonte: https://www.bbc.com/portuguese/articles/cq5gge11dldo. Acesso em 20/02/2023.}
\end{quote}
...
\begin{escolha}
\item os danos causados pelo impacto de um asteroide.

\item o aumento do número de objetos espaciais que se chocam contra a Terra.

\item a eficiência da agência de notícias Reuters.

\item o impacto de um asteroide na Terra.
\end{escolha}
...
\chapter{2. Gêneros Textuais: Narração e Drama}

\coment{Os alunos serão apresentados a dois gêneros textuais diferentes:
...
%\fonte{Fonte:
%https://unsplash.com/pt-br/fotografias/O5EMzfdxedg. Acesso em 21/02/2023.}
...
%\fonte{Fonte: https://pixabay.com/pt/vectors/chapeuzinho-vermelho-garota-corrida-156953/. Acesso em 21/02/2023.}
...
\begin{boxlist}
\item Em um texto dramático não são descritas as ações das personagens. \coment{F}
...
\linhas{2}
\coment{O texto apresenta as personagens Príncipe e Rapunzel.}
...
(\coment{2}) Os diálogos são introduzidos pelos nomes das personagens.

(\coment{2}) A ação é apresentada diretamente ao leitor.

(\coment{1}) Os diálogos são introduzidos por um travessão.
\end{multicols}

\num{7} Qual é a principal diferença entre um texto narrativo e um texto dramático?

\linhas{2}
\coment{Em um texto narrativo, a estória é contada pelo narrador. Já em um texto
...
%\fonte{Fonte: https://pixabay.com/pt/vectors/imagens-de-palavras-do-alfabeto-1298865/. Acesso em 21/02/2023.}
...
\fonte{ASSIS, Joaquim Maria Machado de Assis. \emph{A Cartomante}.
...
\fonte{ALENCAR, José de. \emph{Iracema}.
http://objdigital.bn.br/Acervo\_Digital/Livros\_eletronicos/iracema.pdf.
Acesso em 21/02/2023.}
\end{quote}
...
\fonte{ASSIS, Joaquim Maria Machado de Assis. \emph{Lição de
Botânica.}
https://machado.mec.gov.br/obra-completa-lista/item/download/65\_2b8fb9ad43aa37653a58bc2bd56e33aa.
Acesso em 21/02/2023.}
...
\item informações sobre o cenário.
...
\chapter{3. O Gênero Notícia e o Uso da Pontuação}

\coment{Neste módulo, estudaremos o gênero textual notícia. O professor deverá
...
%\fonte{Fonte: https://pixabay.com/pt/illustrations/ponto-de-interroga\%c3\%a7\%c3\%a3o-pergunta-ajuda-2314115/. Acesso em 21/02/2023.}
...
%\fonte{Fonte: https://unsplash.com/pt-br/fotografias/A9pxMWzlfW0. Acesso em 21/02/2023.}

\begin{quote}
\textbf{Arqueólogo amador desvenda mistério de sinais em pinturas da Era do Gelo}

Caçadores-coletores da Era do Gelo que viviam em regiões da
...
\fonte{Fonte: https://www.bbc.com/portuguese/geral-64172834.
Acesso em 21/02/2023.}
\end{quote}
...
\linhas{2}
\coment{Devemos conhecer as características específicas de cada gênero textual.}
...
\linhas{1}
\coment{Trata-se do título da notícia.}

\num{4} Qual a função do texto inserido logo após o título da notícia?

\linhas{2}
\coment{Esse texto cumpre a função de resumir o conteúdo da notícia ao leitor
...
\coment{Detalhes e perspectivas.}

\num{6} Assinale V para verdadeiro e F para falso.

\begin{boxlist}
\item Uma notícia não costuma apresentar um título. \coment{V}

\item O principal assunto da notícia não deve aparecer em seu título. \coment{F}

\item O principal intuito de uma notícia é informar o leitor. \coment{V}

\item Uma notícia deve expor ao leitor diferentes informações sobre um \coment{V}
determinado tema.
\end{boxlist}
...
(\coment{3}) Esse sinal serve para indicar uma pergunta. 

(\coment{2}) Esse sinal é utilizado para separar frases. 

(\coment{1}) Esse sinal é colocado ao final das frases. 

(\coment{4}) Esse sinal é usada para destacar informações. 
\end{multicols}
...
\fonte{Fonte:
https://www1.folha.uol.com.br/ciencia/2023/02/brasileiros-descobrem-anel-em-quaoar-primo-de-plutao.shtml.
Acesso em 21/02/2023.}
\end{quote}
...
\linhas{2}
\coment{A notícia fala sobre a descoberta de um anel orbitando ao redor de um
planeta longínquo.}
...
\linhas{2}
\coment{O tema é discutido no título, no texto inserido após o título e no texto
da notícia em si.}
...
%\fonte{Fonte: https://unsplash.com/pt-br/fotografias/tLxGw\_ITs7k. Acesso em 21/03/2022.}
...
\fonte{Fonte:
https://www.uol.com.br/tilt/noticias/afp/2022/12/12/mais-energia-do-que-o-sol-cientistas-irao-revelar-grande-marco-em-fusao-nuclear.htm.
...
\chapter{4. Persuasão e Argumentação}
...
%\fonte{Fonte: https://unsplash.com/pt-br/fotografias/wXJViXxHP44. Acesso em 20/02/2023.}
...
%\fonte{Fonte: https://www.saopaulo.sp.gov.br/tag/dengue/. Acesso em 21/02/2023.}
...
%\fonte{Fonte: http://www.fundacaocultural.ba.gov.br/2020/03/14210/Governo-do-Estado-anuncia-medidas-para-o-enfrentamento-ao-novo-coronavirus-Covid-19-na-Bahia.html. Acesso em 21/02/2023.}
...
%\fonte{Fonte: https://unsplash.com/pt-br/fotografias/PC-8bIgAVQg. Acesso em 21/03/2023.}
...
%\fonte{Fonte: https://unsplash.com/pt-br/fotografias/Ux0bFtZJnKw. Acesso em 21/02/2023.}
...
%\fonte{Fonte: https://pixabay.com/pt/illustrations/diversidade-pessoas-cabe\%c3\%a7as-humanos-5582454/. Acesso 26/02/2023.}
...
%\fonte{Fonte: https://unsplash.com/pt-br/fotografias/UOAD9U-TYxc. Acesso em: 26/02/2023.}
...
% \fonte{Fonte: https://pixabay.com/pt/illustrations/porco-porco-de-desenho-animado-4417320/}
...
%\fonte{Fonte: https://unsplash.com/pt-br/fotografias/Bc\_y35IwUHw. Acesso 20/02/2023.}
...
%\fonte{Fonte: https://unsplash.com/pt-br/fotografias/Jy2mwPtOCOU}
...
%\fonte{Fonte: https://pixabay.com/pt/photos/filho-crian\%c3\%a7a-jogar-estude-cor-865116/}
...
%Tabela e gráfico das páginas 100 e 101 do original
...
%\fonte{Fonte: https://portalcovid19.saude.rn.gov.br/noticias/sesap-orienta-populacao-para-prevencao-a-dengue-chikungunya-e-zika/. Acesso em 26/02/2023.}
