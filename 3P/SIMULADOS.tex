...
\fonte{Texto adaptado. Disponível em: https://guia.folha.uol.com.br/crianca/2020/02/peca-primorosa-da-cia-delas-maria-e-os-insetos-retrata-cientista-como-heroina.shtml.
...
\fonte{Irmãos Grimm. Os sete corvos. Disponível em: 
...
\fonte{Maria Luiza La Porta e Everton Lima. Instituto Fernandes
Figueira/Fundação Osvaldo Cruz (IFF/Fiocruz). \textit{Vacinação infantil sofre queda brusca no
...
\fonte{Bianca Encarnação e Cathia Abreu (Instituto Ciência Hoje) e Marcos
Rodrigues Barreto (Fundação Municipal de Educação de Niterói). ``De mãos 
dadas com os povos originários''. In: \textit{Ciência Hoje das Crianças}. 
Disponível em: https://chc.org.br/artigo/de-maos-dadas-com-os-povos-originarios/. 
Acesso em: 21 abr. 2023.}
\end{myquote}
...
\fonte{Wanderley Preite Sobrinho. \textit{Chuvas torrenciais serão cada vez mais
frequentes, dizem meteorologistas}. In: UOL Notícias. Disponível em:
https://noticias.uol.com.br/cotidiano/ultimas-noticias/2023/02/25/eventos-extremos-aquecimento-global-chuvas-litoral-norte-de-sao-paulo.htm.
Acesso em: 21 abr. 2023.}
\end{myquote}
...
\fonte{``Doutor chocolate''. In: \textit{Ciência Hoje das Crianças}. Disponível em:
...
http://www.dominiopublico.gov.br/download/texto/ea000464.pdf.
...
\fonte{José Mauro de Vasconcelos. \textit{Meu pé de laranja lima}. Editora
Melhoramentos. Livro digital publicado em 26 de março de 2013.
Disponível em:
\textit{https://www.google.com.br/books/edition/O\_meu\_p\%C3\%A9\_de\_laranja\_lima\_Edi\%C3\%A7\%C3\%A3o\_hist/8AOIYOdyt1wC?hl=pt-BR\&gbpv=1\&printsec=frontcover}
Acesso em: 21 abr. 2023.}
\end{myquote}
...
\fonte{``Ali Babá e os quarenta ladrões''. \textit{As mil e uma noites}. Disponível em:
\emph{www.dominiopublico.gov.br/download/texto/me001614.pdf}. Acesso em: 28
fev. 2023.}

\begin{small}
\noindent{\textbf{Vocabulário:}} oásis: pequena região fértil no deserto, com presença de água; 
...
\fonte{\textit{A cigarra e as formigas}. Disponível em: \emph{http://www.dominiopublico.gov.br/download/texto/me001614.pdf}. Acesso em: 18 abr. 2023.}
\end{myquote}
...
\fonte{Texto criado especialmente para este material.}
\end{myquote}
...
\fonte{Texto criado exclusivamente para este material.}
\end{myquote}
...
\fonte{g1 Ceará. \textit{Cão é resgatado após passar três dias em poço de 15m de
profundidade em Itapipoca, no Ceará}. Disponível em
https://g1.globo.com/ce/ceara/noticia/2023/04/23/cao-e-resgatado-apos-passar-tres-dias-em-poco-de-15m-de-profundidade-em-itapipoca-no-ceara.ghtml.
Acesso em 23 abr. 2023.}
\end{myquote}
...
\begin{flushright}
\begin{small}
\noindent{\textbf{Vocabulário:}} ofício: trabalho.
\end{small}
\end{flushright}
\end{myquote}
...
\fonte{Lunetas. \textit{``Lá vem história'': por que é saudável ler para crianças?}
Disponível em: https://lunetas.com.br/ler-para-criancas/. Acesso
em: 24 abr. 2023.}
\end{myquote}
...
\fonte{Alberto Caeiro (heterônimo de Fernando Pessoa). \textit{O guardador de rebanhos}.
...
\fonte{Julia di Spagna. \textit{Guia do Estudante}. ``Microplásticos: entenda os impactos
no meio ambiente e na saúde humana''. Disponível em:
https://guiadoestudante.abril.com.br/atualidades/o-que-sao-microplasticos-e-o-impacto-no-meio-ambiente-e-na-saude-humana.
Acesso em: 25 abr. 2023.}
\end{myquote}
...
\fonte{Eduarda Hutter. \textit{G1}. ``Caso Patolino: Polícia analisa imagens de câmeras e
ouve pessoas que trabalhavam em condomínio onde pato desapareceu''.
Disponível em: https://g1.globo.com/sp/mogi-das-cruzes-suzano/noticia/2023/04/25/caso-patolino-policia-analisa-imagens-de-cameras-e-ouve-pessoas-que-estavam-no-condominio-no-dia-do-desaparecimento-do-pato.ghtml.
Acesso em: 25 abr. 2023.}
\end{myquote}
...
Os sinais de pontuação podem ser usados para demonstrar surpresa, alegria; 
