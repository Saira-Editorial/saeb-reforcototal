...
13 fev. 2023.}
\end{quote}
%Note. O link não funciona e não encontrei este texto buscando pelo título no site do domínio público. Encontrei o texto em outros links. Há uma publicação independente que tem esse conto cuja autoria é de Carlos Alberto Omena.
...
\num{5} Qual é a mensagem que a história transmite? Transcreva no espaço a seguir.
