...
\begin{myquote}
\textbf{\textsc{A toupeira avarenta}}\medskip
...
\begin{myquote}
\textbf{\textsc{Água da vida}} \medskip
...
escreve. Observe, a seguir, os sinais de pontuação.

\begin{center}
\includegraphics[width=.2\textwidth]{./media/image4b.png}
\end{center} 

Para entender melhor, leia um trecho do conto ``O
