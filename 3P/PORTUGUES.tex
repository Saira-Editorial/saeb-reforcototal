...
\begin{center}
\noindent\includegraphics[width=.5\textwidth]{./media/image1a.png}
\end{center}
...
\reduline{Era arrogante e queria provar que era mais corajosa que o leão.}
%Note. Reelaborar e tornar a questão dissertativa.
...
\end{itemize}
\end{escolha}
%Note. Verificar padrão de pontuação nas perguntas e respostas
...
\num{3} Leia um trecho da quadrinha e responda.
...
\end{escolha}
%Note. Fazer outro exercício. Este como está pode sofrer crítica ao atribuir à mulher a qualidade de preguiçosa.
...
\includegraphics[width=.5\textwidth]{./media/image7.jpeg}
