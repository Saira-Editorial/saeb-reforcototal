...
como animais, plantas ou objetos, aos quais são atribuídas características humanas, e
...
--- Não tenho medo do leão por causa da sua juba -- disse a pulga, enquanto mordia o focinho do leão.  
...
Quando a pulga foi embora, queria contar a todo mundo como tinha vencido o leão. Porém, antes de contar a qualquer um, caiu na teia de uma aranha minúscula que a devorou.

\emph{Texto elaborado especialmente para este material.}
\end{quote}
...
\reduline{O leão ficou com raiva porque a pulga picou seu focinho.\hfill}
\linhas{1}
...
\item\reduline{Sugestão de resposta: O mosquito continuou picando o leão, que começou a \textbf{rugir} como um louco.\hfill}

\item \textbf{Irritado} com a mordida da pulga, o leão deu um duro golpe contra o próprio focinho, e outro, e outro, e outro.
\item\reduline{Sugestão de resposta: \textbf{Bravo} com a mordida da pulga, o leão deu um duro golpe contra o próprio focinho, e outro, e outro, e outro.\hfill}

\item Porém, antes de contar a qualquer um, caiu na teia de uma aranha \textbf{minúscula} que a devorou.
\item\reduline{Sugestão de resposta: Porém, antes de contar a qualquer um, caiu na teia de uma aranha \textbf{pequenina} que a devorou.\hfill}
\end{escolha}

\num{7} Marque com um X a alternativa que explica a atitude da pulga.

\begin{boxlist}
\boxitem{\white{X}} Queria punir o leão porque ele foi agressivo.

\boxitem{\white{X}} Queria que o leão passasse vergonha diante dos outros animais.

\boxitem{X} Era arrogante e queria provar que era mais corajosa que o leão.
\end{boxlist}
...
\begin{escolha}[itemsep=-5pt]
\item Osso: \reduline{os-so\hfill}
\reduline{ósseo\hfill}
\item
...
14 fev. 2023.}
\end{quote}
%NOTE. Não encontrei a fonte, e o link indicado não abre. O texto aparece associado a site da Amazon e às vezes a Monteiro Lobato, não encontrei naquilo que consegui encontrar na obra dele. 
...
\item\reduline{João, Maria, o pai e a madrasta.\hfill}

\item Explique por que a madrasta sugeriu abandonar João e Maria.
\item\reduline{A madrasta deu essa sugestão, porque não havia comida para todos.\hfill}

\item Indique onde os pais planejavam abandonar as crianças.
\item\reduline{Eles planejavam abandonar as crianças na mata.\hfill}
...
\item\reduline{O lobo e o cordeiro.\hfill}


\item Onde a história acontece?
\item\reduline{Provavelmente, na floresta, em um riacho.\hfill}


\item Qual é o assunto tratado no texto?
\item\reduline{Trata-se da história de um lobo que queria encontrar motivos para matar um cordeiro.\hfill}
\end{escolha}
...
\item\reduline{Ponto final, ponto de exclamação e ponto de interrogação.\hfill}
...
\item\reduline{Explique aos alunos que frases terminadas com ponto final denominam-se
\textbf{frases} \textbf{declarativas}; as terminadas com ponto de interrogação
denominam-se \textbf{frases} \textbf{interrogativas}; as que terminam com ponto
de exclamação denominam-se \textbf{frases} \textbf{exclamativas}.\hfill}

\item Que função tem o segundo travessão que aparece após uma fala?
\item\reduline{A segunda ocorrência do travessão marca o fim da fala do personagem e o
...
\begin{boxlist}
\boxitem{\white{X}} Dúvida.

\boxitem{\white{X}} Surpresa.
...
\item\reduline{Ela perguntava se no mundo havia mulher mais bela do que ela.\hfill}

\item
  Dos sinais de pontuação que estão destacados no texto, qual indica o
  início da fala do personagem?
\item\reduline{O travessão.\hfill}

\item
  Qual sinal anuncia que o personagem vai falar?
\item\reduline{Os dois-pontos.\hfill}
...
\boxitem{\white{X}} --- Espelho, espelho meu, diga-me se há no mundo mulher mais bela do que eu!
\end{boxlist}
\end{escolha}
...
público em relação ao que está sendo veiculado, como a comprar um
...
\begin{boxlist}
  ...
  \boxitem{X} triste.
  \boxitem{\white{X}} cansado.
  \boxitem{\white{X}} eufórico.
\end{boxlist}
...
\item\reduline{O objetivo é orientar a população a higienizar as mãos.\hfill}


\item Você acha importante lavar as mãos? Por quê?
\item\reduline{Resposta pessoal. Espera-se que os alunos respondam que sim, porque é um hábito que pode impedir a propagação de diversas doenças.\hfill}


\item Segundo o anúncio, o que é preciso usar para lavar as mãos e proteger a saúde?
\item\reduline{Água e sabão.\hfill}

\item O que a imagem da mão está representando?
\item\reduline{A imagem representa os micróbios prejudiciais que ficam nas mãos quando não estão higienizadas.\hfill}
...
\begin{boxlist}
  \boxitem{\white{X}} lentamente.
  \boxitem{\white{X}} calmamente.
  \boxitem{X} rapidamente.
  \boxitem{\white{X}} vagarosamente.
\end{boxlist}
...
\boxitem{\white{X}} mimada
\boxitem{X} sedosa
\boxitem{\white{X}} quietinha
\end{boxlist}
...
\boxitem{\white{X}} chateados

\boxitem{\white{X}} decepcionados
\end{boxlist}
