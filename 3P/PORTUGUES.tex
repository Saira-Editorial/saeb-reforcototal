...
Anúncio publicitário (ou propaganda) é um gênero textual que tem como finalidade divulgar uma ideia, um produto, um valor ou um conceito. 
...
%\begin{center}
%\includegraphics[width=4in,height=3in]{./media/image8.jpeg}
%\end{center}
}
...
%\includegraphics[width=3in,height=4in]{./media/image9.jpeg}
