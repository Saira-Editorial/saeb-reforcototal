...
\end{minipage}
\begin{minipage}{.5\textwidth}
\includegraphics[width=.7\textwidth]{./media/image17.png}
\end{minipage}
...
\includegraphics[width=3.01042in,height=3.01042in]{./media/image18a.png}
\end{wrapfigure}
...
Leia o diálogo, a seguir, e responda aos itens de 9 e 10.
