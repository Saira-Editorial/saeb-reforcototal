...
\conteudo{{\hfill\textbf{Sinais de pontuação}\hfill}\medskip

Os sinais de pontuação organizam um texto escrito e 
auxiliam na construção de sentidos pretendida por quem o
escreve. Para entender melhor, leia um trecho do conto ``O
rouxinol do imperador'', atentando-se à pontuação.

\begin{center}
\includegraphics[width=.2\textwidth]{./media/image4b.png}
\end{center}
...
\begin{center}
\includegraphics[width=.3\textwidth]{./media/image4a.png}
\end{center}
...
O texto apresenta diferentes sinais de pontuação. Entre eles, estão o ponto (\textbf{.}),
...
\reduline{O travessão no início do texto indica a fala da personagem.}
...
\reduline{O ponto indica o final do trecho em destaque.}

\num{4} Leia o trecho de um tradicional conto de fada.
...
\item 
  Se a frase ``--- Espelho, espelho meu, diga-me se há no mundo mulher
mais bela do que eu.'' fosse uma pergunta, como ela seria escrita?
Marque a alternativa correta.
\reduline{ --- Espelho, espelho meu, há no mundo mulher mais bela do que eu?}

%%% FAZER EXERCÍCIOS DO 6 ao 10
