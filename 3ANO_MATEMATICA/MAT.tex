\pagestyle{mat}
\chapter{}
\markboth{1. O que dizem os números}{}
...
\colorsec{Habilidades da BNCC: EF03MA19, EF03MA20.}
...
\chapter{}
\markboth{5. Tempo e comprimento}{}
...
%Fechar texto citado. Texto escrito especialmente para o material.
...
\colorsec{Habilidade da BNCC: EF03MA24.}
...
\linhas{2}
\coment{Como o enunciado indica que são cédulas e moedas, ela deva ter recebido
...
\linhas{3}
\coment{Lendo atentamente o texto, sabe-se que cada parcela será de R\$ 1.200,00}
...
\item
  Uma possibilidade para R\$ 966,00 podem ser 48 notas de 20 reais e 3
  notas de 2 reais.
\item
  Uma possibilidade para R\$ 3.940,00 podem ser 15 notas de 200 reais, 9
...
\coment {Professor, aproveite o exercício para dar outros exemplos e, aos poucos,
ir trabalhando o conceito com os alunos, devido à importância de eles
desenvolverem essa habilidade de encontrar maiores chances por meio de uma análise simples.}
...
\linhas{2}
\coment{A maior chance é de sair uma bola preta.}

\item
 Qual cor de bola tem menos chances de sair?
\linhas{2}
\coment{A menor chance é de sair uma bola amarela.}
\end{escolha}
...
\linhas{2}
\coment{A chance é tota, ou seja, de 100 em 100, já que há apenas livros na caixa.}

\item
  Qual a probabilidade de ser um livro de português?
\linhas{2}
\coment{A probabilidade é de 1 em cada 2, ou metade, ou 50 em cada 100.}
...
\linhas{3}
\coment{Total de alunos: 32
Número de meninos: 32 -- 8 = 24
Portanto, a probabilidade será de 24 em cada 32, ou seja, 3 em cada 4.}
...
\linhas{3}
\coment{Total de letras: 10
Vogais: 4; consoantes: 6.
Portanto, a probabilidade de ser uma vogal é menor do que a de ser uma consoante.}
...
Carta de copas: 13
Probabilidade = 13 em 52 = uma em cada quatro.}
...
Total de números que interessam: 5 (9, 10, 11, 12 e 13)
Probabilidade de cinco em dezesseis.}
...
\linhas{3}
\coment{Total de estudantes: 450
Preferência por humanas: 150
Probabilidade: 450/150 = 3 = uma chance em cada três.}
...
Bolas verdes: 4
Probabilidade: 4 em cada 20, ou 1 em cada 5, ou 25 em cada 100.}
...
\item
  ...
  \linhas{2}
  \coment{O dia com maior venda foi 04/05, com 89 abacaxis.}

\item
  Em que dia a venda de abacaxis foi a menor?
  \linhas{2}
  \coment{O dia com menor venda foi 06/05, com 52 abacaxis.}
\end{escolha}
...
número que faltava; após alguns minutos, conseguiu descobrir. Qual o número que Gabriel encontrou?
