...
é necessário trabalhar a decomposição dos números e a escrita deles por extenso.}
...
\coment{Resposta pessoal: Exemplo: 222}
  ...
  \item Um número formado por três algarismos na qual o 0 (zero) seja o terceiro algarismo.
\linhas{1}
...
Escreva os número escritos em cada item e após isso, decomponha esse
...
\coment{Professores talvez esse seja um dos módulos mais importantes por se
...
Foto de 5 reais & R\$ 5,00 & Cinco reais\tabularnewline
