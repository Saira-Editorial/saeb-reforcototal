...
\coment{Levar as palavras Violeta e Filomena em um cartaz explorar 
letra inicial e som da letra nas palavras.}
...
\coment{Faça leitura das palavras com as crianças, de modo a identificar
...
\coment{Convide as crianças para falar o nome das imagens para 
identificar a escrita da palavra.}
...
música. Quando a música parar, o aluno ler a palavra observando a letra 
final. Em seguida, convide toda a turma para chamar a palavra e, então,
descobrir a sílaba forte. Explique como descobrir quando a sílaba é forte
e fraca, ensinando que, quando o U está no final, ele é sempre forte, 
e que o O é sempre fraco no final das palavras.}
...
AS PALAVRAS SÃO LIDAs E ESCRITAs DA ESQUERDA PARA A DIREITA.VELA:
...
Para iniciar este módulo, é possível comentar os tipos dos textos que serão
lidos e explorar bastante a oralidade, fazendo diversos questionamentos de
