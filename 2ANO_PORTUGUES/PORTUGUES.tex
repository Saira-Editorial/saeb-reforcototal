...
\begin{escolha}
\item Por que os cuidados da menina com o passarinho foram em vão?

\reduline{Porque ele morreu.\hfill}

\item Pinte o balão que explica por que o passarinho precisou de cuidados.
\end{escolha}
...
\begin{escolha}
\item Para você por que o pai esperou Bel completar 16 anos para dar o
...
\begin{escolha}
\item A expressão facial usada pelo menino significa que ele está
...
\item A posição de joelhos.

\item As lágrimas descendo.
\end{escolha}
\end{minipage}
