...
\reduline{Carta de leitor é o gênero usado para interagir com as publicações de um veículo de comunicação.\hfill}
...
produzir para realizar essa tarefa. %Depois, justifique sua resposta.
...
%\reduline{Resenha crítica é o gênero usado para fazer a análise de um produto cultural.\hfill}
...
\reduline{Isso é feito por meio do uso da 3ª pessoa e da ausência de adjetivação valorativa, por exemplo.\hfill}
\linhas{2}
...
\conteudo{Os gêneros literários desempenham um papel de suma importância 
na estruturação e na interpretação do amplo espectro de obras presentes na 
literatura. Constituem-se como ferramentas cruciais na classificação e na 
identificação das características intrínsecas de cada obra.

A categorização em gêneros permite a
leitores e estudiosos situarem cada obra em um contexto mais 
amplo, compreendendo melhor sua estrutura, estilo e temática. O gênero 
épico, por exemplo, é conhecido por narrar grandes feitos heroicos e 
aventuras, muitas vezes situados em cenários épicos e míticos. Já o gênero 
lírico se concentra nas emoções e nos sentimentos de um eu, apresentando 
uma abordagem mais subjetiva e introspectiva. O gênero 
dramático se destaca por suas peças teatrais, que exploram conflitos humanos 
por meio do diálogo e da performance.

Essas categorias enriquecem nossa experiência como leitores, 
permitindo-nos explorar uma ampla gama de estilos e perspectivas. Ao 
entendermos as características de cada gênero, somos capazes de mergulhar 
mais profundamente nas nuances de cada obra, apreciando sua singularidade 
e seu valor artístico de maneira mais completa. Assim, os gêneros literários 
funcionam como guias valiosos em nossa jornada de exploração literária, 
tornando a literatura uma experiência mais rica e enriquecedora.}
...
veículo de informação por aquele dizer. 
...
criança não compreendeu a explicação dada por ele.\hfill}
\linhas{2}
...
palavras e seus significados dicionarizados, mas também a de
...
sempre é simplesmente fazer piada ou crítica pura e simplesmente, mas sim
...
as palavras ``ciumento'' e ``cimento''.
...
( \rosa{IV} ) Um rapaz chegou a um velório e a primeira coisa que perguntou foi:
...
o leitor entenda o contrário do que disse, isto é, que o erro não é grave.\hfill}
\linhas{3}
...
supér-herói com outro, mostrando que o Batman não era, de fato, seu ídolo entre os heróis.\hfill}
\linhas{4}
...
\reduline{O personagem tinha a expectativa de que era um super-herói extremamente famoso e, portanto, reconhecido por todos,
mas descobriu que na verdade foi confundido.\hfill}
\linhas{4}

\num{6} A estratégia usada pelo autor da anedota para gerar o humor é a
quebra de expectativa. Justifique essa afirmação.

\reduline{O personagem pensou ter sido reconhecido pelo menino como Batman,
...
\num{7} O que a postura de Batman mostra sobre a personalidade do herói?

\reduline{A postura mostra que o homem-morcego tem uma postura de arrogância e enorme autoconfiança.\hfill}
\linhas{5}
...
\fonte{Fernando Sabino. Reunião de mães. In: *O homem nu*. Rio de Janeiro: Record, 1976.}
\end{myquote}
...
linguísticas do texto, ou implícita, quando exige interpretação
por parte do leitor.}
...
\fonte{Fonte de pesquisa: Brenda Brito e Jeferson Almeida. El País.}
\end{myquote}
...
\num{2} O fato é abordado com parcialidade ou com imparcialidade? Justifique
...
abordado com parcialidade, pois os autores passam a avaliar essas mudanças
como prejudiciais à proteção das florestas públicas, sobretudo da
Amazônia. Os elementos do texto que comprovam a parcialidade são, por exemplo:
...
suspeita é de que ele tentava roubar a fiação}
\end{myquote}
...
de alumínio, enquanto o texto II acrescenta que ele tentou furtá-los e afirma que
...
fios; portanto, o furto teria sido o motivo que o levou a se arriscar.\hfill}
\linhas{4}

\num{8} Em relação ao tratamento do fato e à motivação do homem, qual é
a diferença do texto III para os textos I e II?

\reduline{O texto III trata a morte como fato e o furto como hipótese, enquanto o texto I não menciona futro, falando sobre "serrar" de forma ampla, e o texto II trata o furto como fato inquestionável.\hfill}
\linhas{4}
...
categoricamente que o homem tentava roubar os fios e buscando manter essa ideia no campo da hipótese, para que não soe como acusação leviana.\hfill}
\linhas{6}
...
abordagem feita às caraterísticas dos textos, é apontar o texto III. Também é possível que se aponte o texto I, no qual a questão do furto nem mesmo é abordada.\hfill}
\linhas{1}
...
\begin{myquote}
\textbf{Serviço essencial deve ser prestado}

\emph{Falta na greve do
...
\begin{figure}[H]
\centering
\includegraphics[width=.8\textwidth]{./imgSAEB_8_POR/media/image45.png}
\end{figure}
...
já registrada pelo Imazon}

\emph{Com devastação recorde em 2022,
...
\emph{O resultado positivo foi consequência do trabalho de
...
enunciados combinados. Por trás desse conjunto a que chamamos de texto
...
e combinação que o autor pode interferir, para moldar seu texto conforme
...
\begin{center}
Chamamos essas marcas de \textbf{modalizadores do discurso}.
\end{center}

Em resumo, modalizadores são as marcas linguísticas que
...
\begin{escolha}
\item \textbf{Possivelmente}, aqui no Brasil, a melhor solução para os
...
\item O secretário-geral das Nações Unidas, António Guterres, afirmou que
...
\item A arte de viver cada vez mais se faz \textbf{indispensável} para a
emancipação humana.
...
\item Hoje enfrentamos, em nosso país, árdua discussão sobre o uso do
...
\item \textbf{Estranhamente}, a cada temporada, os eleitores teimam em
...
( \rosa{II} ) É vedado ao assistente social praticar condutas antiéticas. 

( \rosa{III} ) Você pode sair hoje à noite com seus amigos. 
...
\begin{escolha}
\item Um banho quente de chuveiro elétrico de 15 minutos consome 135 litros
...
\item Ainda é cedo para afirmar quais são os verdadeiros impactos da
...
\item O controle de dados dos internautas pode ser utilizado como artifício
...
\item Sim! Foi a Tara Sports, usando a imagem de Ronaldo Fenômeno, que
...
\fonte{W. R. Cereja e T. C. Magalhães. \textit{Português:} linguagens. São Paulo:
Atual, 2012.}
\end{myquote}
...
todos, enquanto aquela está restrita à literatura de grandes autores, demandando maior esforço para ser constituída e adquirida.\hfill}
%\linhas{2}
...
\reduline{O articulador "mas" expressa sentido oposto àquele que foi construído na frase
...
\begin{figure}[H]
\centering
\includegraphics[width=.9\textwidth]{./imgSAEB_8_POR/media/image46.png}
\end{figure}
...
suavizada? Explique sua resposta
...
abordado de uma forma que poderia lhe causar incômodo.\hfill}
\linhas{6}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{./imgSAEB_8_POR/media/image47.png}
\end{figure}
...
\reduline{Ironia. A inflação, algo que é prejudicial à economia de um país, mas, ironicamente, é
tratada como se fosse algo bom, equiparado a um recorde, embora a intenção
do autor seja dizer justamente o contrário.\hfill}
\linhas{1}
...
representa o trabalho. Com esses usos, o texto ganha força argumentativa.\hfill}
\linhas{2}
...
\num{7} Ela murmurou, sussurrou, falou, gritou, berrou; já não
...
\reduline{Comparação. A comparação entre a casa e o campo de batala significa que as
...
\fonte{Fernando Pessoa. O guardador de rebanhos. In: \textit{Poemas de Alberto Caeiro}. Disponível em: \emph{http://arquivopessoa.net/textos/613}. Acesso em: 19 mar. 2023.}
\end{myquote}
...
\begin{figure}[H]
\centering
\includegraphics[width=.9\textwidth]{./imgSAEB_8_POR/media/image48.png}
\end{figure}
...
Para alcançar a progressão textual de maneira eficaz, a coesão desempenha um papel crucial.}
...
(~\rosa{IV} ) \textbf{De fato} o Brasil é o país do futebol.

(~\rosa{I} ) Choveu bastante, \textbf{portanto} a colheita está garantida.
\end{multicols}
...
\begin{escolha}
\item \reduline{Embora\white{\_\_\_\_\_\_\_\_\_\_\_\_}} pertencêssemos a
partidos rivais, nossos ideais coincidiam em muitos pontos. (Concessão.)

\item Ele disse que gostou muito do meu CD,
\reduline{mas\white{\_\_\_\_\_\_\_\_\_\_\_\_}} com algumas ressalvas. (Contraste.)

\item Irei contigo, \reduline{caso\white{\_\_\_\_\_\_\_\_\_\_\_\_}} minha
...
\num{7} Releia um trecho do texto.
...
\reduline{O fato de direitos presentes na legislação não se refletirem na prática mostra como é grave a questão do cumprimento de alguns direitos no Brasil.\hfill}
\linhas{2}
...
O que o pronome ``isso'', destacado no texto, retoma? Explique
...
\begin{figure}[H]
\centering
\includegraphics[width=.6\textwidth]{./imgSAEB_8_POR/media/image49.png}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{./imgSAEB_8_POR/media/image50.png}
\end{figure}
...
diferentes classes sociais; enfim, qualquer critério que possamos
determinar.

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{imgSAEB_8_POR/media/image51.png}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{imgSAEB_8_POR/media/image54.png}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{imgSAEB_8_POR/media/image52.png}
\end{figure}
...
A variação linguística é à diversidade de formas de linguagem que existem em uma língua devido a diferentes fatores, como regionalismo, classe social, idade, etnia e contexto de uso. Essas variações podem incluir diferenças de vocabulário, pronúncia, gramática e até mesmo expressões culturais, refletindo a riqueza e complexidade da comunicação humana em diferentes contextos e comunidades linguísticas.

\begin{itemize}
\item \textbf{Variação histórica.} Refere-se às mudanças linguísticas que ocorrem ao longo do tempo em uma língua. Isso envolve evoluções na gramática, vocabulário, pronúncia e estrutura da língua à medida que gerações sucessivas a utilizam. A variação histórica é essencial para entender como as línguas se transformam e se adaptam ao longo das gerações, resultando na formação de diferentes estágios da mesma língua, como o latim que deu origem às línguas românicas modernas, como o espanhol, o francês e o italiano. Por exemplo, o português falado hoje no Brasil não é o mesmo que foi falado no Brasil Colônia.

\item \textbf{Variação geográfica (regional).} Refere-se às diferenças linguísticas que ocorrem em diferentes áreas geográficas ou regiões. Essas variações podem incluir diferenças de pronúncia, vocabulário, gramática e até mesmo expressões culturais específicas a uma determinada região. Elas surgem devido ao isolamento geográfico, migração, contato com outros grupos linguísticos e outros fatores, tornando a língua flexível e adaptável às características locais de diversas comunidades linguísticas. Por exemplo, o vocabulário regional gaúcho é diferente do vocabulário
regional mineiro, e vice-versa.

\item \textbf{Variação social.} Refere-se às diferenças linguísticas que ocorrem com base nas características sociais dos falantes, como classe social, nível educacional, grupo étnico e contexto social. Essas variações podem incluir escolha de vocabulário, sotaque, gírias e até mesmo padrões de fala mais formais ou informais. A variação social reflete como a língua é moldada pela sociedade e como os indivíduos usam a linguagem para se identificar ou se relacionar com diferentes grupos sociais.

\item \textbf{Variação situacional.} Refere-se às mudanças na forma de linguagem com base no contexto ou na situação comunicativa. Isso envolve ajustar a linguagem de acordo com o ambiente, o propósito da comunicação e a audiência. Por exemplo, alguém pode usar um registro formal em uma apresentação de trabalho e um registro informal com amigos. Essa variação situações ajuda a adequar a comunicação de acordo com as normas e expectativas sociais em diferentes situações.
\end{itemize}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{imgSAEB_8_POR/media/image53.png}
\end{figure}
}
...
linguística: histórica, social, geográfica, social,
situacional.

\reduline{Variação linguística refere-se à diversidade de formas de linguagem dentro de uma língua, incluindo cinco tipos de variação. Variação histórica envolve as mudanças linguísticas ao longo do tempo, incluindo evoluções na gramática, vocabulário e pronúncia. Variação social diz respeito às diferenças linguísticas com base em fatores sociais, como classe social, nível educacional e grupo étnico. Variação geográfica consiste nas diferenças linguísticas entre regiões geográficas, incluindo variações de sotaque, vocabulário e gramática. Variação estilística relaciona-se à adaptação da linguagem com base no contexto ou situação, como a escolha de um registro formal ou informal. Variação situacional envolve as mudanças na forma de linguagem de acordo com a situação comunicativa, ajustando a linguagem para atender às normas e expectativas sociais em diferentes contextos..\hfill}
\linhas{14}

\num{3} Observe as situações e, em seguida, responda à questão.
...
como outros usos mais valorizados socialmente, como aquele
...
Nas atividades de 4 a 7, escreva o tipo de variação linguística representado em cada
...
\fonte{Ariano Suassuna. \emph{Auto da compadecida.} 35 ed. Rio de Janeiro:
Agir, 2005 (Fragmento.)}
\end{myquote}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{./imgSAEB_8_POR/media/image27.png}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{./imgSAEB_8_POR/media/image55.png}
\end{figure}
...
Dois registros de variação linguística que influenciam o nível da formalidade da entrevista são demonstrados em
...
\fonte{Lázaro Ramos. \emph{Na minha pele}. Rio de Janeiro: Objetiva,
2017. (Fragmento.)}
\end{myquote}
