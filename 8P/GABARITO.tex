...
(B)
Incorreta. O texto não aborda o tema sob o ponto de vista da compaixão, o que, inclusive, destoaria do tom mais imparcial que geralmente se busca em notícias.
...
(D) Incorreta. O texto não aborda a solidariedade nem menciona
campanhas de doação.
...
(C) Incorreta. O texto I apenas noticia um fato. O
texto II, por sua vez, faz uma reclamação sobre a greve, por ser opinativo.

(D) Incorreta. O texto I apenas noticia um fato. O texto II de fato se
solidariza com as pessoas que dependem do transporte público, avaliando
negativamente a greve, embora a crítica em si seja mais importante, no caso, do que a própria solidariedade.
...
pretérito que não deixam de ser verdadeiros ou confiáveis. 
...
impessoalidade, característica desejável no texto em questão. 

(C)
Incorreta. A citação do estudo feito pela ONG tem como objetivo aumentar
a credibilidade do texto, não emitir apreciação. 

(D) Correta. O veículo de notícia refere-se ao fato noticiado empregando a expressão ``crescimento desordenado'', citando ainda os respectivos prejuízos para Manaus. O título demonstra esse posicionamento ao empregar o verbo ``sofre''. Por outro lado, a ONG citada emprega um termo mais neutro, ``expansão urbana'', para designar o mesmo fato.
\end{enumerate}
...
(B) Correta. A
expressão se caracteriza como eufemismo, que busca amenizar a dor do
...
figura de linguagem no poema. 

(C)
Incorreta. O exagero é obtido por meio da hipérbole, que não é marcante no poema como algo primordial, embora haja traços dela. 

(D) Incorreta. Trata-se da ironia, figura de
linguagem que significa o contrário do que se diz, característica que
não se encontra em foco no poema.
...
(C)
Incorreta. O texto não visa a influenciar ou formar a opinião do
leitor, mas a influenciar sua decisão de acompanhar o programa divulgado.

(D) Correta. A menção à OMS, tendo em vista o objetivo do texto de
convidar o espectador para acompanhar o programa, visa a convencer o
...
(A) Incorreta. Brasil e mundo globalizado não são ideias opostas no texto,
pois ambos são impactados de forma semelhante.
...
linguística, podendo se encaixar em textos com níveis diversos de formalidade.

(C) Incorreta. Os termos não exemplificam nenhum tipo de variação
linguística, sendo bastante neutros.

(D) Incorreta. Os termos não exemplificam nenhum tipo de variação
linguística, embora o primeiro apresente tom figurado claro.
...
diferentes tipos de leitores que podem ter acesso ao seu conteúdo. Isso fica claro na crítica feita ao viés acadêmico com que se aborda o tema. A
...
(A) Incorreta. Os desvios ortográficos presentes no texto não são resultado da idade da autora, pois não se trata de marcas de distinção de uma geração específica.

(B) Correta. O desvio da norma-padrão, que se observa no texto, provém do nível de escolaridade da autora, cuja escrita se mostra influenciada pela
