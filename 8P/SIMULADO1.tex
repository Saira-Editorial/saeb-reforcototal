...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{./imgSAEB_8_POR/media/image56.png}
\end{figure}
...
\fonte{Francisco Rodrigues Júnior. \emph{Causos de Minas} -- Literatura:
...
Comparando-se os dois textos, conclui-se que o texto I cumpre, em
