...
\fonte{Disponível em:\emph{https://agenciabrasil.ebc.com.br/pesquisa-e-inovacao/noticia/2017-06/campus-party-reciclagem-de-lixo-eletronico-da-origem-projetos}.
...
programa \emph{Salto para o Futuro} {[}...{]}.
...
\fonte{Disponível em:
\emph{http://portal.mec.gov.br/ultimas-noticias/33491-tv-escola/63021-obesidade-infantil-e-tema-do-programa-salto-para-o-futuro}.
...
retoma uma expressão e, ao mesmo tempo,
...
\begin{figure}[H]
\centering
\includegraphics[width=.9\textwidth]{imgSAEB_8_POR/media/image59.png}
\end{figure}
...
\emph{https://agenciabrasil.ebc.com.br/geral/noticia/2023-02/mais-de-3-mil-celulares-foram-furtados-durante-o-carnaval-em-sp}.
Acesso em: 04 mar. 2023.}
\end{myquote}
...
%\caption{Disponível em: \emph{https://bvsms.saude.gov.br/bvs/folder/10006001944.pdf}}
\end{figure}
\end{minipage}
\begin{minipage}{.5\textwidth}
...
\fonte{F. T. Farah. \emph{O enigma das estrelas.} São Paulo: Geração Editorial,
2013. (Fragmento.)}
\end{myquote}
...
\fonte{Donald Ray Pollock. \emph{O mal nosso de cada dia}. Tradução de Paulo
...
\fonte{Eduardo Galeano. \emph{Futebol ao sol e à sombra}. Tradução de Eric
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{imgSAEB_8_POR/media/image60.png}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{imgSAEB_8_POR/media/image61.png}
\end{figure}
...
\fonte{Disponível em:
\emph{https://www.lg.com/br/products/documents/MFL59166617\_BBTV\_SERIES\_REV00.pdf}.
...
\emph{http://arquivopessoa.net/typographia/textos/arquivopessoa-4250.pdf}.
Acesso em: 10 mar. 2023.}
\end{myquote}
\end{minipage}
\begin{minipage}{.5\textwidth}
...
\fonte{Fernando Pessoa. Disponível em: \emph{http://arquivopessoa.net/textos/4234}. Acesso em: 10 mar. 2023.}
\end{myquote}
\end{minipage}
...
\fonte{Fernando Pessoa. Disponível em: \emph{http://arquivopessoa.net/textos/1063}.
...
\fonte{Lázaro Ramos. \emph{Na minha pele}. 1.ed. Rio de Janeiro: Objetiva,
2017 (fragmento).}
\end{myquote}
...
\fonte{Fernando Pessoa. Disponível em: \emph{http://arquivopessoa.net/textos/613}.
