...
\EveryShipout{
  \ifthenelse{\isodd{\value{page}}}
    ...
    {\global\marginparsep=-14em}
}

\renewcommand*{\marginfont}{\color{rosa}\salmao\small\cambria}
...
\node[white] at (0,0) {\hspace*{-5cm}\bfseries\leftmark};
\end{tikzpicture}}
...
\node[white] at (0,0) {\hspace*{2cm}\bfseries \parttitle};
\end{tikzpicture}}{}{}
