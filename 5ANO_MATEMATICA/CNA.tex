...
humano?
\item\reduline{A água da chuva \textbf{não é potável}. Ela é contaminada por substâncias
...
\item \reduline{O planeta Terra possui água em abundância, mas apenas
...
\item\reduline{Nos casos citados, a água invisível pode ser
...
\item \reduline{As águas residuais devem ser sempre tratadas antes de
...
\item\reduline{A partir da alimentação, são absorvidos nutrientes
...
sobreviver?
\item\reduline{O aleitamento materno garante a nutrição dos bebês
...
\item\reduline{Os pulmões.\hfill}

\item Esses órgãos são os únicos responsáveis pela respiração humana?
\item\reduline{Os pulmões não são os únicos responsáveis pela respiração humana. Além deles, participam da respiração as
...
\item\reduline{As células de defesa capazes de combater uma infecção
são chamadas de anticorpos.\hfill}

\item Como essas células atuam?
\item\reduline{Os anticorpos são liberados na corrente sanguínea
...
\item\reduline{As vacinas estimulam a liberação de anticorpos para
...
\item\reduline{Os alimentos da base da pirâmide representam as 
...
\item\reduline{Foram colocados no topo da pirâmide os alimentos de menor
...
\item\reduline{Observa-se que a alimentação deve ser balanceada, sem
...
\item\reduline{O controle da quantidade de calorias ingeridas \textbf{não é}
...
\item\reduline{Uma dieta balanceada deve equilibrar o consumo de
...
\item\reduline{Rotação.\hfill}

\item Qual a duração desse movimento?
\item\reduline{23 horas e 56 minutos.\hfill}
\end{escolha}
...
\item\reduline{A observação correta é a de número 2, pois nela está descrito 
...
\item\reduline{O erro da observação 1 é imaginar que a Terra não está se
...
\item\reduline{Translação.\hfill}

\item O movimento da Rotação ocorre ao mesmo tempo que o movimento indicado na imagem?
\item\reduline{Os movimentos de Rotação e Translação são simultâneos:
...
\item\reduline{A variação das estações do ano ocorre de acordo com a
...
\item\reduline{De acordo com a distribuição da energia solar, em
...
\item\reduline{Em janeiro de 2023 ocorreu o ciclo lunar sideral, pois se
