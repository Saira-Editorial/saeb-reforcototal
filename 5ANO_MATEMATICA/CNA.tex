...
\coment{Alternativa a. A descrição das funções do sistema
...
\linhas{3}
\coment{São os alimentos com menor importância para uma
...
\linhas{4}
\coment{Não, além das calorias ingeridas, a proporção de
