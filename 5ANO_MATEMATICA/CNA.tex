...
\fonte{Mariana Tokarnia. \emph{Quase metade das escolas não tem todos os
...
\fonte{Fonte: CAESB. Disponível em: \emph{https://www.caesb.df.gov.br/dicas-consumo-agua.html}}
...
\coment{Habilidades da BNCC: EF05CI06, EF05CI07 e EF05CI08.}
...
\coment{V, F, V, F, V. Primeira alternativa falsa: o sangue
...
baixas e se dilatam novamente com o aumento de temperatura.}
...
\linhas{3}
\coment{Os alimentos da base da pirâmide representam o acesso
...
\linhas{3}
\coment{Foram colocados no topo da pirâmide os alimentos de menor importância para uma
alimentação saudável e, sugestivamente, de menor valor nutricional. São
...
Batata frita, Biscoito doce, Pizza e Hambúrguer fast food são alimentos com grande
...
d) Incorreta. No sistema reprodutivo, acontecem processos relacionados
...
a) Incorreta. O corpo humano pode produzir células de defesa sozinho,
...
b) Incorreta. O conteúdo da vacina não é capaz de participar da
...
fusos horários em diferentes localidades e estações do ano nos
...
\linhas{3}
\coment{A observação correta é a de número 2, pois nela está descrito corretamente o movimento
...
\linhas{3}
\coment{O erro da observação 1 é imaginar que a Terra não
...
\linhas{2}
\coment{Sim. Os movimentos são simultâneos, enquanto cada
...
\linhas{4}
\coment{A variação das estações do ano varia de acordo com a
...
\num{7} No solstício de verão, a luz solar incide com \preencher\preencher\coment{maior}
...
\coment{Alternativa a. Discuta com os alunos as diferenças
...
\coment{V, F, V, V. Afirmação falsa: a lua não é capaz de
