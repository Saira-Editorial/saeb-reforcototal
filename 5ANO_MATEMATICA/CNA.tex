...
\fonte{Companhia de Saneamento Ambiental do Distrito Federal (CAESB). Dicas importantes da Caesb para um consumo de água mais consciente. Disponível em: https://www.caesb.df.gov.br/dicas-consumo-agua.html. Acesso em: 29 mar. 2023.}
...
\fonte{Tabela Brasileira de Composição de Alimentos (TBCA) da Universidade de São Paulo (USP). Disponível em: http://www.fcf.usp.br/tbca. Acesso em: 29 mar.23}
...
\linhas{3}
\coment{Ciclo lunar sideral, pois se observam fases da lua
...
\coment{Habilidade da BNCC: EF05CI11 - Associar o movimento diário do Sol e das
...
c) Incorreta. A elevação dos níveis d'água nos hemisférios, ainda que
...
\coment{Habilidade da BNCC: EF05CI12 - Concluir sobre a periodicidade das fases da
...
a) Incorreta. Apesar da gestão pública poder lidar com o problema, de
...
Terra;
b) Correta. A luz da lua é apenas uma reflexão da luz solar;
...
inverno;
c) Incorreta. O verão iniciou no hemisfério sul, portanto, não poderia
também iniciar no hemisfério oposto;
d) Correta. No hemisfério norte, no mesmo período do ano, tem-se início
...
a) Correta. A produção do quimo e do quilo, além dos órgãos mencionados,
...
lua minguante;
b) Incorreta. A lua nova não pode ocorrer logo após a lua cheia,
...
d) Incorreta. A água de reuso não desempenha papel fundamental e
