...
\coment{
a) 10 + 6 = 16.
b) Não é possível saber exatamente quantos alunos tiraram nota 10 na
prova, pois, no gráfico, as notas 9 e 10 aparecem juntas.}
...
\num{2} Isabeli que colocar o número 380 em uma reta numérica igual à
representada abaixo:
...
%Além disso, é preciso adicionar uma primeira linha à tabela, com o aluno W, cujas notas são 3, 4, 5, 8, 7
...
Habilidade do SAEB: Compor ou decompor números naturais de até 6 ordens na
forma aditiva, ou em suas ordens, ou em adições e multiplicações.}
...
Habilidade do SAEB: Escrever números racionais (naturais de até 6 ordens,
representação fracionária ou decimal finita até a ordem dos milésimos)
...
Habilidade do SAEB: Calcular o resultado de multiplicações ou divisões
...
Habilidade do SAEB: Inferir o padrão ou a regularidade de uma sequência de
números naturais ordenados, objetos ou figuras.}
...
Habilidade do SAEB: Determinar o horário de início, o horário de término ou
a duração de um acontecimento.}
...
Habilidade do SAEB: Determinar a probabilidade de ocorrência de um
resultado em eventos aleatórios, quando todos os resultados possíveis
têm a mesma chance de ocorrer (equiprováveis).}
...
Habilidade do SAEB: Argumentar ou analisar argumentações/conclusões com
...
Habilidade do SAEB: Argumentar ou analisar
...
Habilidade do SAEB: Resolver problemas que envolvam fração como resultado
...
Habilidade do SAEB: Identificar frações equivalentes.}
...
Habilidade do SAEB: Resolver problemas simples de contagem (combinatória).}
...
Habilidade do SAEB: Resolver problemas de multiplicação ou de divisão,
envolvendo números racionais apenas na representação decimal finita até
a ordem dos milésimos, com os significados de formação de grupos iguais
(incluindo repartição equitativa de medida), proporcionalidade ou
disposição retangular.}
...
Habilidade do SAEB: Identificar a ordem ocupada por um algarismo ou seu
...
Habilidade do SAEB: Resolver problemas de adição ou de subtração,
envolvendo números naturais de até 6 ordens, com os significados de
...
Habilidade do SAEB: Inferir os elementos ausentes em uma sequência de
números naturais ordenados, objetos ou figuras.}
...
Habilidade do SAEB: Estimar/inferir medida de comprimento, capacidade ou
massa de objetos, utilizando unidades de medida convencionais ou não ou
medir comprimento, capacidade ou massa de objetos.}
...
Habilidade do SAEB: Medir ou comparar perímetro ou área de figuras planas
desenhadas em malha quadriculada.}
...
Habilidade do SAEB: Resolver problemas que envolvam moedas e/ou cédulas do
sistema monetário brasileiro.}
...
Habilidade do SAEB: Relacionar valores de moedas e/ou cédulas do sistema
monetário brasileiro, com base nas imagens desses objetos.}
