...
\begin{quote}
O traço mais importante a ser extraído de um texto é seu \preencher{sentido\hfill}.
\end{quote}
...
\begin{quote}
Uma notícia deve levar em conta \preencher{diferentes aspectos} sobre um mesmo tema.
\end{quote}
...
\begin{quote}
O elemento mais básico encontrado em um texto argumentativo é o \preencher{argumento\hfill}.
\end{quote}
...
\begin{quote}
As vacinas podem ser consideradas seguras porque \preencher{não interagem} com nosso DNA.
\end{quote}
...
\begin{quote}
Em um mesmo texto, podemos encontrar \preencher{perspectivas} diferentes.
\end{quote}
