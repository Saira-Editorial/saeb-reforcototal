...
\begin{itemize}
  \item\mbox{} As \textbf{raízes} da árvore representam o conhecimento das experiências e das realidades vividas 
  ...
  \item\mbox{} O \textbf{tronco} da árvore simboliza a técnica teatral, os métodos e as estratégias utilizadas 
  ...
  \item\mbox{} Os \textbf{galhos} da árvore representam as diferentes formas de atuação e intervenção social. Boal 
  ...
  \item\mbox{} As \textbf{folhas} da árvore simbolizam os resultados e as transformações que podem ocorrer a 
...
\begin{itemize}
  \item\mbox{} \textbf{Claves.} São símbolos colocados no início do pentagrama (a pauta musical) para indicar a 
  ...
  \item\mbox{} \textbf{Pauta Musical.} É um conjunto de linhas horizontais paralelas, geralmente cinco, em que as 
  notas são escritas. Cada linha e espaço representa uma nota musical específica.
  \item\mbox{} \textbf{Notas.} São símbolos ovais ou cabeças de notas que são posicionados nas linhas e nos 
  ...
  \item\mbox{} \textbf{Claves de ritmo.} São símbolos que indicam o ritmo e a divisão do tempo. Entre os mais 
  comuns, estão a semibreve (nota de maior duração), a mínima, a semínima, a colcheia e a semicolcheia.
  \item\mbox{} \textbf{Sinais de dinâmica.} São marcas escritas acima ou abaixo das notas que indicam a 
