...
\conteudo{
\includegraphics[width=\textwidth]{./_SAEB_9_POR/media/image1.png}
...
\begin{itemize}
\item\textbf{Tese} Hipótese a ser comprovada por meio de argumentos.

\item\textbf{Opinião} Manifestação de um ponto de vista.

\item\textbf{Posicionamento explícito} Esclarecimento, de forma indiscutível, de uma
crença ou da definição de um dos lados de um assunto.

\item\textbf{Argumentos}  Construções que visam a ajudar na comprovação de uma tese.
\end{itemize}
...
acidentes.
\fonte{Somos ciclistas. Campanha ACPC. Disponível em: https://tinyurl.com/ybvh2svd. Acesso em 05 maio 2023.}
\end{quote}
...
\noindent{}Com a leitura do texto, é possível verificar que o psiquiatra apresenta
...
\begin{itemize}
\item\emph{Produzir conteúdos};

\item\emph{Promover e implementar políticas públicas};

\item\emph{Realizar parcerias};

\item\emph{Desenvolver e promover políticas públicas}.
\end{itemize}
...
\textit{https://epicentroliterario.com.br/dominio\_publico/a-pequena-vendedora-de-fosforos/}.
Acesso em: 28 mar. 2023.}
\end{quote}
...
\conteudo{
\includegraphics[width=\textwidth]{./_SAEB_9_POR/media/image6.jpeg}
...
\fonte{Ministério da economia. Servidores da Esplanada ganham espaço de
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.8\textwidth]{./media/img1pt.png}
\end{figure}
...
\conteudo{
\includegraphics[width=\textwidth]{./_SAEB_9_POR/media/image7.jpeg}
...
\reduline{Opinião. A frase ``Acredito que as políticas de sustentabilidade devem ser priorizadas em todo o mundo para proteger o meio ambiente'' expressa uma opinião pessoal sobre a importância das políticas de sustentabilidade e não pode ser comprovada como verdade absoluta.\hfill}
\end{itemize}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.8\textwidth]{./media/img2pt.png}
\end{figure}
...
\reduline{Por conta do ditado popular que diz que você atrai aquilo que tem medo.
Logo, ter medo de ficar rico atrairia a riqueza em si.\hfill}
\linhas{1}
...
\reduline{Ele pede que pessoas não façam compras até o dia a Black Friday (dia no
qual se abre uma temporada de compras que promete significativas
promoções em muitas lojas).\hfill}
\linhas{3}

\num{3} No terceiro quadro, o homem ficou envergonhado. Explique o motivo.

\reduline{Ele ficou chateado porque a propaganda da promoção foi mentirosa, uma
...
\reduline{Pessoas: Você não entende nada do que falamos com você\ldots{}\hfill}
\linhas{1}

\num{6} Por que a personagem do meme pode ser considerada muito lerda?

\reduline{Por que ela teve dificuldades até de entender uma afirmação sobre a própria dificuldade de entender as coisas.\hfill}
\linhas{1}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.75\textwidth]{./media/img5pt.png}
...
\reduline{O fato de o homem se esforçar tanto simplesmente pelo fato de o valor do
frete ser apresentado como grátis, mesmo que o valor total do produto
seja tão baixo.\hfill}
\linhas{2}

\num{8} Fica implícito que o esforço não será recompensado porque haverá um
  problema no trajeto. Qual seria esse empecilho?

\reduline{Seria o fato de que o cartão do homem (consumidor) não seria aprovado,
impedindo a compra.\hfill}
\linhas{2}

\num{9} Existe uma crítica embutida no meme. Que crítica é essa?

\reduline{Trata-se de uma crítica ao consumismo exacerbado e ao poder da propaganda.\hfill}
\linhas{2}
...
\reduline{O que representa, na imagem, esse esforço, é a montanha e a dficuldade de escalá-la.\hfill}
\linhas{2}
...
\fonte{Ana Elisa Santana. EBC. O Brasil exportava talentos, hoje exporta
...
%\Coment{Oriente os alunos a identificar o tema da reportagem. Depois da leitura, pergunte o que acharam do texto e questione sobre informações que tenham chamado mais a atenção. Solicite que tentem avaliar também a forma de organização do texto e os elementos utilizados para destacar ou hierarquizar informações}.
...
\fonte{Drogas: inimigas da vida. Plenarinho.Disponível em:
\textit{https://plenarinho.leg.br/index.php/2017/05/drogas-inimigas-da-vida/}.
Acesso em: 05 abr. 2023.}
\end{quote}

\num{1} A quem essa reportagem é dirigida?

\reduline{Ao público em geral, mas principalmente aos jovens.\hfill}
\linhas{2}

\num{2} Qual é o provável objetivo de dedicar a esse público uma
reportagem relacionada a esse tema?

\reduline{Provavelmente, trazer a discussão sobre o perigo das drogas para o dia a dia de crianças e
jovens, considerando que é por meio da informação que se combate esse
tipo de problema.\hfill}
\linhas{2}

\num{3} De acordo com a reportagem, por que os jovens decidem
experimentar as drogas?

\reduline{Muitas vezes, em busca por amizades e o consolo para os~dilemas dessa etapa da vida.\hfill}
\linhas{2}

\num{4} Que informação no primeiro parágrafo da reportagem está
relacionada com o título?

\reduline{As consequências que o vício traz para a vida dos jovens e para toda a sociedade.\hfill}
\linhas{3}
...
\reduline{Porque deixam em evidência o compromisso do
jornalista com a verdade, tendo em vista que apresentou elementos para
comprovar o que está relatando.\hfill}
\linhas{2}
...
\reduline{Discurso indireto.\hfill}
\linhas{1}

\num{10} Qual discurso dá mais credibilidade à reportagem: o discurso
direto ou o discurso indireto? Justifique sua resposta.

\reduline{O discurso direto, uma vez que transfere exatamente o que o entrevistado falou.\hfill}
\linhas{4}
...
\reduline{O jornalista manifesta sua opinião em relação às consequências do uso de drogas.\hfill}
\linhas{2}

\num{12} Qual é a importância desse tipo de comentário em uma reportagem
sobre esse assunto?

\reduline{Mostrar que há formas de mudar o que não está certo.\hfill}
\linhas{2}
...
%Imagem ilustrativa que pode ser cortada: \url{https://www.freepik.com/free-photo/hands-holding-earth-csr-business-campaign_17229783.htm\#query=agenda\%202030\&position=4\&from_view=search\&track=ais}
...
\fonte{Mariana Diniza. EBC. Avanços brasileiros contribuem para cumprimento da
...
\fonte{Débora Brito. EBC. ONGs apontam desafios para Brasil atingir metas do
...
%Imagem ilustrativa que pode ser cortada: \url{https://www.freepik.com/free-photo/football-background-grass-with-trophy_2351182.htm\#query=fifa\%20world\%20cup\&position=2\&from_view=search\&track=ais}
...
\fonte{Cláudia Soares Rodrigues. EBC.Brasil estreia contra Bolívia nas
...
\item Analisar os efeitos de sentido dos tempos, modos e/ou vozes verbais
...
\reduline{Ele quis evidenciar o fato de sempre ter um cachorro feliz que o espera em casa.\hfill}
\linhas{1}
...
\reduline{O fato de haver a imagem de várias mulheres de diferentes etnias e biotipos.\hfill}
\linhas{3}

\num{4} Que efeito essa imagem pretende provocar no leitor?

\reduline{Pretende impactar o leitor e fazê-lo refletir sobre o fato de que todas as
mulheres, indiferentemente de sua classe social, cor, idade ou etnia,
merecem igualdade, dignidade e respeito.\hfill}
\linhas{3}
...
\reduline{Pretende despertar memórias de circunstâncias que tenha experenciado ou escutado em que não ocorreu igualdade, dignidade e respeito.\hfill}
\linhas{1}
...
\reduline{Os substantivos buscam provocar o interlocutor para uma
diferente postura diante de atos desrespeitosos, indignos e desiguais.\hfill}
\linhas{1}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.75\textwidth]{./_SAEB_9_POR/media/image21.jpeg}
\end{figure}
\pagebreak

\num{7} Qual é a proposta dessa campanha?

\reduline{A proposta é que as mulheres não se subestimem nem duvidem de seus potenciais. Promover reflexão, conscientização e mobilização para a conquista dos direitos das mulheres, assim como o de viver sem violência e sem discriminação.\hfill}
\linhas{1}

\num{8} O tema da campanha é ``A violência que ninguém vê''. O que seria
esse tipo de violência?

\reduline{Explique aos alunos que se trata de violência psicológica, que, em muitos casos, é o gatilho para casos mais graves, como a agressão física ou o feminicídio. Consiste na ação ou omissão que se destina a degradar ou controlar as ações da mulher, causando a ela dano emocional e diminuição da sua autoestima.\hfill}
\linhas{2}
...
\reduline{Podem ser assim consideradas as palavras "forte" e "corajosa".\hfill}
\linhas{1}

\num{10} Por que essas palavras foram usadas?

\reduline{Essas palavras
...
ideia ou do produto em divulgação.\hfill}
\linhas{3}
...
\fonte{Paulo Henrique Caban Stern Matta. INEP. ``Sucesso absoluto''. Cartilha
do participante 2016. Disponível em:
\textit{http://download.inep.gov.br/educacao\_basica/enem/guia\_participante/2016/manual\_de\_redacao\_do\_enem\_2016.pdf}.Acesso
em: 7 abr. 2023.}
\end{quote}
...
\fonte{Clara de Araujo Dias. INEP. ``Amostra de redações nota 1000''. Cartilha
do participante 2016. Disponível em:
...
%CAMPANHA de doação de Sangue acontece neste sábado (07). Disponível em: \textless{}www.lucasdorioverde.mt.gov.br/site/noticias/6303\textgreater{}. Acesso em: 7 abr. 2023.
...
\fonte{Fernanda Carolina Santos Terra de Deus. Especialistas analisam sete
redações nota mil do Enem; confira. Disponível em:
\textit{http://portal.mec.gov.br/images/stories/noticias/2019/outubro/24.10.2019redacaolink7.pdf}.
Acesso em: 7 abr. 2023.}
\end{quote}
...
\fonte{João da Cruz e Souza. Violões que choram. Faróis. Disponível em:
...
\fonte{Luís Vaz de Camões. Amor é um fogo que arde sem se ver. In: Sonetos.
Disponível em:
...
\reduline{É um sentimento poderoso e intenso que pode, em certos momentos, gerar dor e sofrimento.\hfill}
\linhas{4}
...
\reduline{Evidencia a imagem de que o amor é contraditório e ambíguo.\hfill}
\linhas{1}
...
\reduline{Seria o uso dessa memória para registrar, em imagem, danos causados a um veículo -- no caso, um farol com lataria amassada em volta.\hfill}
\linhas{2}

\num{5} Qual é a condição que se estabelece, no texto do anúncio, para
que se possa dirigir com segurança?

\reduline{A condição é a pessoa que vai dirigir não ter consumido álcool.\hfill}
\linhas{3}

\num{6} O que significa dizer, no texto do anúncio, que ``bebida e
direção são termos antitéticos''?

\reduline{Significa que se trata de termos opostos entre si, que se tornam de certa forma conflituosos quando colocados em paralelo. Vale a pena explicar aos alunos que a figura de linguagem mais coerente para se usar nesse contexto seria "paradoxo", não "antítese", já que, enquanto em uma antítese os termos se opõem semanticamente mas coexistem harmonicamente, no paradoxo surge a real contradição. No caso do texto da campanha, porém, o uso é menos formal.\hfill}
...
\reduline{Essas palavras ajudam a construir a ideia de que, enquanto direção sem álcool pode significar vida, direção sob efeito de álcool passa a representar a morte.\hfill}
\linhas{4}
...
\reduline{Seria um eufemismo porque, na realidade, a necessidade do imóvel seria de uma grande reforma. Isso se associa à imagem porque, na foto, fica claro que se trata de um imóvel bastante distruído, que, para se tornar habitável, precisa de uma enorme reforma.\hfill}
\linhas{4}

\num{9} O que se pode deduzir sobre a qualidade dos imóveis do site
MoreBem a partir do texto?

\reduline{É possível deduzir que o site não esconde necessidades de reparos e reformas em seus imóveis anunciados; além disso, também se pode deduzir que o MoreBem oferece imóveis em melhores condições de moradia.\hfill}
\linhas{2}

\num{10} Como a palavra ``isto'' coopera para a construção de um texto
claro e coeso?

\reduline{A palavra atua em um processo de coesão referencial, no qual estabelece uma relação catafórica, ou seja, conecta-se a algo que será mencionado mais à frente no texto.\hfill}
\linhas{2}
...
%Imagem ilustrativa que pode ser cortada: \url{https://www.freepik.com/free-photo/man-holding-umbrella-jetty-by-tranquil-lake_18930136.htm\#query=loneliness\&position=1\&from_view=search\&track=sph}
\begin{verse}
...
\fonte{Fernando Pessoa. Ah! Ser indiferente!. Disponível em:
...
%Imagem ilustrativa que pode ser cortada: \url{https://www.freepik.com/free-photo/golden-pawn-chess-move-out-from-line-different-thinking-leading-change-disruption-unique-concept-by-3d-render_24458825.htm\#query=contrastant\&position=8\&from_view=search\&track=sph}
...
\fonte{Fernando Pessoa. Livro do desassossego. Disponível em:
...
%Imagem ilustrativa que pode ser cortada: \url{https://www.freepik.com/free-psd/delicious-foodstuff-arrangement_20281576.htm\#page=2\&query=food\%20for\%20all\&position=35\&from_view=search\&track=ais}
...
\fonte{Adriana Veiga Aranha (Org.). Fome Zero: Uma História Brasileira.
Brasília, DF: Ministério Zero, v. 1, 2010. Disponível em:
\textit{https://www.mds.gov.br/webarquivos/publicacao/Fome\%20Zero\%20Vol1.pdf}.
...
\reduline{Porque expressa a indignação da sociedade com a permanência do paradoxo da presença da fome num País que produz alimentos em abundância.\hfill}
\linhas{2}

\num{2} Como é possível garantir que iniciativas que garantem a
segurança alimentar de pessoas pobres tenham sucesso? 

\reduline{O tema precisa estar contemplado na estratégia de desenvolvimento do país.\hfill}
\linhas{2}

\num{3} Para Josué de Castro, o que é a fome? 

\reduline{Para ele, a fome "É a mais trágica expressão do subdesenvolvimento econômico".\hfill}
\linhas{2}
...
\reduline{Extirpar significa arrancar pela raiz.\hfill}
\linhas{3}

\num{5} Que efeito de sentidos essa palavra traz ao trecho? 

\reduline{Essa palavra evidencia a indignação da autora do texto em relação ao fato citado.\hfill}
\linhas{2}

\num{6} Com que intenção provavelmente ela foi usada? 

\reduline{Como um recurso de persuasão para convencer o leitor do absurdo do fato de haver pessoas que passam fome.\hfill}
\linhas{2}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.95\textwidth]{./media/img7pt.png}
...
\reduline{Porque a construção de memórias justifica as pessoas estarem vivas e conviverem. As memórias são o símbolo de um tempo vivido.\hfill}
\linhas{2}
...
\reduline{Ser saudável é, segundo o anúncio, não se privar dos prazeres da vida, não fazer cortes naquilo que se consome e se vive.\hfill}
\linhas{3}
...
%Imagem ilustrativa que pode ser cortada: \url{https://www.freepik.com/free-vector/racism-concept-with-hands-pointing-person_8702850.htm\#query=stop\%20bullying\&position=23\&from_view=search\&track=ais}
...
%Imagem ilustrativa que pode ser cortada: \url{https://www.freepik.com/free-photo/standard-quality-control-collage-concept_30589259.htm\#query=secure\%20information\&position=0\&from_view=search\&track=ais}
...
%Imagem ilustrativa que pode ser cortada: \url{https://www.freepik.com/free-vector/award-medal-realistic-composition-with-isolated-image-medal-with-laurel-wreath-blank-background-vector-illustration_23129813.htm\#query=medal\&position=1\&from_view=search\&track=sph}
...
\fonte{JUSTO, Juliano. Em Lima, Brasil bate recorde histórico com 308 medalhas.
...
\conteudo{
\textbf{Regências verbal e nominal}\bigskip

%https://www.pexels.com/pt-br/foto/foto-aproximada-de-cubos-na-superficie-rosa-1225127/

\includegraphics[width=.8\textwidth]{./_SAEB_9_POR/media/image30.jpeg}\bigskip
%\caption{grátis Foto Aproximada De Cubos Na Superfície Rosa Foto profissional}
...
\reduline{Espera-se que os alunos cheguem à conclusão de que não seria possível, uma vez que as palavras às quais os termos estão relacionados necessariamente precisam de complementos para ser compreendidas.\hfill}
\linhas{1}
...
\reduline{As preposições **contra** e **pela** (da preposição *per* e do artigo *a*) e **a**.\hfill}
\linhas{2}

\num{3} Explique o que significa prosperidade humana.

\reduline{Resposta pessoal. Sugestão de resposta: abundância, fartura e estabilidade dos homens.\hfill}
\linhas{3}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.6\textwidth]{./_SAEB_9_POR/media/image32.jpeg}
...
afirmativas e da reiteração sobre a importância da conscientização.\hfill}
\linhas{1}

\num{5} Que termo complementa o verbo \textbf{lutar} e de que forma ele
está ligado ao nome?

\reduline{O complemento é "contra o racismo" e está ligado ao
verbo pela preposição **contra.**\hfill}
\linhas{1}

\num{6} Além de ``lutar contra o racismo'', quais outras lutas podem
transformar vidas?? Cite duas.

\reduline{Resposta pessoal. Sugestões de resposta:
luta por direitos iguais; luta por empregos fixos; luta por salários
justos; luta por saneamento básico.\hfill}
\linhas{2}
...
\fonte{Disponível em: \textit{https://g1.globo.com/mg/minas-gerais/noticia/2020/04/06/coronavirus-infectologista-responde-a-varias-perguntas-veja.ghtml}. Acesso em: 9 abr. 2023.}
\end{quote}

\num{7} A regência verbal do verbo \textbf{responder} está de acordo com
a gramática normativa? Justifique sua resposta.

\reduline{Sim. De acordo cm a
...
\begin{boxlist}
\boxitem{X} \textbf{a várias perguntas} é objeto indireto.

\boxitem{\white{X}} \textbf{várias} é objeto direto e \textbf{perguntas} é objeto indireto.

\boxitem{\white{X}} \textbf{a várias perguntas} é objeto direto.
\end{boxlist}
...
\fonte{Disponível em:
\textit{https://g1.globo.com/mg/minas-gerais/noticia/2020/04/06/coronavirus-infectologista-responde-a-varias-perguntas-veja.ghtml}.
Acesso em: 9 abr. 2023.}
\end{quote}
...
\reduline{Não, pois o verbo visar é transitivo indireto no sentido de "ter em vista", "almejar", "pretender", e o objeto indireto deve vir precedido da preposição **a.**\hfill}
\linhas{1}
...
%Imagem ilustrativa que pode ser cortada: \url{https://www.freepik.com/free-photo/young-latin-woman-smiling-happy-making-selfie-by-smartphone-city_39467686.htm\#query=smartphone\&position=13\&from_view=search\&track=sph}

\fonte{Disponível em:
\textit{https://adnews.com.br/brasileiros-preferem-ficar-24-horas-sem-agua-que-sem-o-smartphone/}.
Acesso em: 9 abr. 2023.}
\end{quote}

É possível afirmar que a forma verbal ``preferem'' foi utilizada em conformidade com a norma-padrão? Justifique sua resposta.

\reduline{Não. Existe uma variação, pois, em lugar da preposição **a**, foi usada a expressão que.\hfill}
\linhas{1}
...
%Imagem ilustrativa que pode ser cortada: \url{https://www.freepik.com/free-photo/closeup-selective-focus-shot-beautiful-house-sparrow_17417593.htm\#query=bird\&position=3\&from_view=search\&track=sph}
...
\fonte{(Texto produzido para o material)}
\end{quote}
...
%Imagem ilustrativa que pode ser cortada: \url{https://www.freepik.com/free-vector/vintage-sailing-wooden-pirate-boat_16263453.htm\#query=caravela\%20portuguesa\&position=6\&from_view=search\&track=ais\#position=6\&query=caravela\%20portuguesa}

\fonte{CAMINHA, Pero Vaz de. A carta. Disponível em:
...
\fonte{IRMÃOS GRIMM. Rumpelstichen. Disponível em:
