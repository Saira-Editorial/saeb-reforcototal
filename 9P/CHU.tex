...
\includegraphics[width=.5\textwidth,height=4.5cm]{./imgs/img7.png}
\caption{Vegetação natural de cerrado e Campo de cultivo de soja.}
\end{figure}
...
\boxitem{\white{X}} Drenagem total de rios e pântanos.

\boxitem{X} Criação de florestas urbanas.

\boxitem{\white{X}} Expansão da cidade.
\end{boxlist}
\end{multicols}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.5\textwidth]{./media/img1chu.png}
\end{figure}
...
\end{tabular}
\fonte{Empresa de Pesquisa Energética. Disponível em: https://tinyurl.com/5n93t2yw. Acesso em: 04 abr. 2023.}
\end{center}
...
Disponível em: \textit{https://tinyurl.com/mrxvm2ys}. Acesso em: 06 mar. 2023.}
\end{quote}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.3\textwidth]{./imgSAEB_9_CHUM3/media/image1bg.png}
\end{figure}
...
\num{8} Atribua V (verdadeiro) e F (falso) para as afirmativas a seguir.\enlargethispage{2\baselineskip}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=\textwidth]{./media/img2chu.png}
\end{figure}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.8\textwidth]{./imgSAEB_9_CHUM6/media/image2.png}
\caption{IBGE}
\end{figure}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=\textwidth]{./imgSAEB_9_CHUM6/media/image3.png}
\end{figure}
