...
ELES TAMBÉM NOS AJUDARAM A DEFINIR A CLASSIFICAÇÃO DOS
CORREDORES, E ATÉ NOS INDICARAM O VENCEDOR.

ALÉM DISSO, OS NÚMEROS NÃO SERVEM SOMENTE PARA
...
\rosa{10 -- 20 -- 23 -- 30 -- 40 -- 45 -- 50 -- 60 -- 70 -- 78 --80 -- 85 -- 90.}
...
EXEMPLOS: PARA MEDIRMOS COMPRIMENTOS, USAMOS A UNIDADE \textbf{METRO};
PARA MEDIRMOS MASSAS, USAMOS A MEDIDA \textbf{QUILOGRAMA};
PARA MEDIRMOS O VOLUME, USAMOS A MEDIDA \textbf{LITRO}.
}
...
\begin{figure}[H]
\centering
\includegraphics[width=.7\textwidth]{./media/SAEB_1ANO_MAT_FIGURA34.png}
\end{figure}
...
\item\reduline{Resposta circunstancial.\hfill}
...
\item\reduline{Quarta-feira.\hfill}
\linhas{1}

\item QUANTOS SÁBADOS EXISTEM EM JANEIRO DE 2023?

\item\reduline{São quatro sábados.\hfill}
\linhas{2}
...
\item\reduline{Terça-feira.\hfill}
\linhas{1}

\item QUANTOS DOMINGOS EXISTEM NESSE MÊS DE JANEIRO?

\item\reduline{São cinco domingos.\hfill}
\linhas{2}
\end{escolha}
...
\conteudo{
OBSERVE AS MOEDAS E PERCEBA SUAS DIFERENÇAS.

\begin{center}
\includegraphics[width=\textwidth]{./media/SAEB_1ANO_MAT_FIGURA64.png}
\end{center}

A MOEDA DE MENOR VALOR É A DE 1 
CENTAVO, QUE REPRESENTA UM REAL DIVIDIDO EM 100 PARTES. A MOEDA DE MAIOR VALOR É A DE 
1 REAL, QUE EQUIVALE A CEM CENTAVOS.


AGORA, OBSERVE ESTA TABELA, QUE
MOSTRA AS CÉDULAS DO DINHEIRO QUE USAMOS NO BRASIL.

\begin{center}
\includegraphics[width=\textwidth]{./media/SAEB_1ANO_MAT_FIGURA63.png}
\end{center}
...
\rosa{135,20; 55,25; 98,00.}
% \begin{figure}[H]
% \includegraphics[width=.9\textwidth]{./media/SAEB_1ANO_MAT_FIGURA68.png}
% \end{figure}
...
\coment{De cima para baixo, a ordem é: R\$ 1,00, R\$ 0,05, 
R\$ 0,50, R\$ 0,10 e R\$ 0,25.}
\end{minipage}
...
\coment{João ganhou R\$ 10,00.

Bianca ganhou R\$ 10,00.
...
Portanto, jutnos, os dois ganharam R\$ 20,00 -- vinte reais.}

\item QUANTO JOÃO E BIANCA GASTARAM JUNTOS?

\coment{João gastou R\$ 6,00.

Bianca gastou R\$ 5,00.
...
Portanto, juntos, os dois gastaram R\$ 11,00 -- onze reais.}

\item QUANTO DINHEIRO SOBROU PARA JOÃO E BIANCA JUNTOS?

\coment{Juntos, os dois tinham R\$ 20,00.

Juntos, os dois gastaram R\$ 11,00.
...
Portanto, para os dois, sobraram R\$ 9,00 -- nove reais.}
...
\conteudo{
VOCÊ JÁ PAROU PARA PENSAR COMO É POSSIVEL SABER SE VAI CHOVER OU NÃO? EXISTE TODA UMA 
CIÊNCIA POR TRÁS DESSA PREVISÃO: A METEOROLOGIA, QUE CONSEGUE PREVER,
COM MAIS OU MENOS PRECISÃO, OS FENÔMENOS QUE VÃO ACONTECER.
ELA CONSEGUE INDICAR AS CHANCES DE CHUVA, POR EXEMPLO, OU DE QUE O TEMPO
FIQUE NUBLADO OU, AINDA, AS CHANCES DE QUE O TEMPO DÊ UMA VIRADA.

NO ENTANTO, SE OLHAMOS PARA O CÉU E O VEMOS ESCURO, CRIAMOS A EXPECTATIVA DE QUE VAI 
CHOVER, MESMO SEM USAR UMA CIÊNCIA MAIS PRECISA. USAMOS PISTAS QUE ENCONTRAMOS
AO NOSSO REDOR PARA TENTAR PREVER DETERMINADAS SITUAÇÕES. O ACÚMULO DE NUVENS
ESCURAS, POR EXEMPLO, É UMA PISTA IMPORTANTE PARA SE PREVER QUE PODE CHOVER.

NA METEOROLOGIA, UMA SÉRIE DE ACONTECIMENTOS
PERMITE AOS TÉCNICOS FAZER UMA PREVISÃO DO TEMPO, MAS NÓS TAMBÉM PODEMOS FAZER 
PREVISÕES NO DIA A DIA.

VAMOS
APRENDENDO A PREVER O QUE VAI ACONTECER. COM ISSO,
ENTENDEMOS O QUE NÃO TEM CHANCE DE ACONTECER E O QUE TEM CHANCE
ABSOLUTA DE ACONTECER, POR EXEMPLO.


PODEMOS DIZER QUE EXISTEM 4 POSSIBILIDADES.}
...
%\centering{\includegraphics[width=\textwidth]{./media/SAEB_1ANO_MAT_FIGURA83.png}}
...
\rosa{Tesoura falando; jacaré voando; leão miando; chuva caindo para cima; unicórnios; árvore andando.}
...
\coment{Só podem sair os resultados de 1 a 6.}
...
\coment{Solange, pois é a única jogadora que possui uma pedra com 5.}
...
\begin{figure}[H]
\centering
\includegraphics[width=.6\textwidth]{media/image92.jpg}
\end{figure}
...
\conteudo{
VOCÊ JÁ PERCEBEU COMO, POR EXEMPLO, LISTAS
DE COMPRAS, LISTAS DE MATERIAIS DA ESCOLA OU ENTÃO O
\textit{RANKING} DE UM JOGO FICAM ORGANIZADOS?

ELES FICAM ORGANIZADOS EM ESTRUTURAS QUE CHAMAMOS DE \textbf{TABELA}.
E TABELAS EXISTEM AOS MONTES EM NOSSO DIA A DIA, EM SITUAÇÕES QUE VÃO
DESDE O MOMENTO DE VER OS NUTRIENTES DE UM PRODUTO NO SUPERMERCADO
ATÉ O MOMENTO DE CHECAR A SITUAÇÃO DE UM CAMPEONATO COMO A COPA
DO MUNDO DE FUTEBOL.
...
OUTRO EXEMPLO: EM JOGOS ELETRÔNICOS, A CLASSIFICAÇÃO E OS PONTOS DE 
JOGADORES SÃO APRESENTADOS EM
...
RESULTADO ESTÁ NESSE GRÁFICO. PERCEBA QUE A MAIORIA DAS CRIANÇAS
TORCIA PARA O CORINTHIANS. OS GRÁFICOS AJUDAM A PERCEBER ISSO MAIS FACILMENTE. VOCÊ 
SABERIA DIZER, SÓ OLHANDO PARA ELES, QUAL TIME FOI O MENOS ESCOLHIDO?
}
...
\item\reduline{Ricardo tem a maior pontuação.\hfill}

\item QUEM FEZ MENOS PONTOS?

\item\reduline{Hévilin tem a menor pontuação.\hfill}

\item HOUVE ALGUM EMPATE?

\item\reduline{Lucas e Marcelo empataram com 35 pontos.\hfill}

\item QUEM SÃO OS TRÊS PRIMEIROS COLOCADOS AO FINAL DA PARTIDA?

\item\reduline{Ricardo (1º), Débora (2º) e Marcos (3º).\hfill}
\end{escolha}

\num{2} FOI FEITA UMA PESQUISA PARA SABER QUE TIPO DE ALIMENTO AS
CRIANÇAS MAIS COMIAM. O RESULTADO ESTÁ REPRESENTADO NO GRÁFICO.
RESPONDA AO QUE SE PERGUNTA NA SEQUÊNCIA.

\begin{figure}[H]
\centering
\includegraphics[width=.8\textwidth]{./media/SAEB_1ANO_MAT_FIGURA98.png}
\end{figure}

\begin{escolha}
\item QUAL É A COMIDA PREFERIDA DESSA TURMA?

\item\reduline{A maioria dos alunos prefere massa.\hfill}

\item QUAL É A COMIDA MENOS QUERIDA DESSA TURMA?

\item\reduline{A minoria dos alunos costuma comer verduras.\hfill}

\item QUAL É A SEGUNDA COMIDA PREFERIDA DOS ALUNOS DESSA TURMA?

\item\reduline{Doces são a segunda comida preferida dos alunos.\hfill}
...
\num{3} A TABELA MOSTRA OS JOGOS MAIS CURTIDOS PELOS ALUNOS DE UMA TURMA, INDICANDO
QUANTOS ALUNOS PREFEREM CADA JOGO.

\begin{figure}[H]
\centering
\includegraphics[width=.8\textwidth]{./media/SAEB_1ANO_MAT_FIGURA99.png}
\end{figure}

\begin{escolha}
\item COLOQUE OS JOGOS EM ORDEM DO MAIS JOGADO PARA O MENOS JOGADO.

\item\reduline{Roblox; Mario kart 8; Minecraft; Animal crossing: new horizons; 
Super Mario party.\hfill}
\linhas{1}
...
\item PREENCHA O GRÁFICO A SEGUIR, PINTANDO OS ESPAÇOS CONFORME A TABELA DE ALUNOS.

\begin{figure}[H]
\centering
\includegraphics[width=.8\textwidth]{./media/SAEB_1ANO_MAT_FIGURA101.png}
\end{figure}
\end{escolha}
...
VEZES. PINTE A QUANTIDADE DE ESPAÇOS DE CADA JOGADA NO GRÁFICO
A SEGUIR. DEPOIS, REGISTRE O NÚMERO QUE MAIS SAIU E O QUE MENOS SAIU.
...
\begin{figure}[H]
\centering
\includegraphics[width=.6\textwidth]{./media/SAEB_1ANO_MAT_FIGURA103.png}
\end{figure}
...
\item\reduline{Foi a segunda-feira.\hfill}

\item QUAL FOI O DIA MAIS FRIO DESSA SEMANA?

\item\reduline{Foi a sexta-feira.\hfill}

\item AO LONGO DA SEMANA, A TEMPERATURA ESTÁ AUMENTANDO OU DIMINUINDO?

\item\reduline{Espera-se que os alunos percebam que os valores das temperaturas diminuíram ao longo da semana.\hfill}
...
QUAL É O ESTILO DE MÚSICA MENOS OUVIDO PELOS ALUNOS DA ESCOLA? IDENTIFIQUE O ESTILO E A JUSTIFICATIVA CORRESPONDENTE.
