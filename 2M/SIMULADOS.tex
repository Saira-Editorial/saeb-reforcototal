...
\begin{figure}[H]
\centering
\includegraphics[width=.75\textwidth]{./media/image119.png}
\end{figure}
...
Quantas joaninhas e borboletas havia ao todo?\enlargethispage{\baselineskip}
...
\begin{figure}[H]
\centering
\includegraphics[width=.7\textwidth]{./media/image149.png}
\end{figure}
