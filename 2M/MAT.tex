...
\begin{center}
\noindent\includegraphics[width=.7\textwidth]{./media/image2.png}
\end{center}
...
%André: eliminar as linhas da imagem e colocar as respostas por extenso em uma única linha usando o comando \rosa e aumentar a imagem (28/8/23, 11h56) CRoger + Felipe A 
...
% André: individualizar as imagens e melhorar distribuição na página (28/8/23, CR + Felipe A)
...
% André: apagar respostas do quadro e escrevê-las por extenso (28/8/23, CR + Felipe A)
...
\reduline{O aluno deve perceber que, se ele somar o algarismo 8 à ordem das dezenas, o número obtido será o 4007; logo, as ordens das centenas e milhares terão seus algarismos modificados. Porém, o algarismo da ordem das unidades continuará o mesmo.\hfill}
\linhas{6}
\pagebreak
...
\begin{figure}[htpb!]
\begin{center}
\includegraphics[width=0.8\textwidth]{./media/image172.jpg}
\end{center}
\end{figure}
...
% André: tirar resposta do caça-palavras (28/8/23, CR + Felipe A)
...
% André: tirar as respostas (28/8/23, CR + Felipe A)
...
% André: individualizar as imagens e usar \escolha + \item para os itens (28/8/23, CR + Felipe A)
...
Quem virar mais figurinhas ganha o jogo, e ainda fica com
as figurinhas do seu oponente. A turma toda se junta para competir.

É importante que todos os jogadores saibam quantas figurinhas possuem. 
...
% André: quebrar parágrafos para o texto ocupar o espaço branco ao final da página (28/8/23, CR + Felipe A)
...
Começando com vermelho e terminando com violeta, pinte, do menor para o maior, sete 
números que, somados, resultam no número que está no centro da tabela. 
...
\end{mdframed} \enlargethispage{2\baselineskip}
...
\hline
100 & + & 123 & = & \rosa{223} \\ \hline
800 & - & 600 & = & \rosa{200} \\ \hline
200 & + & 146 & = & \rosa{346} \\ \hline
450 & - & 200 & = & \rosa{250} \\ \hline
100 & + & 200 & = & \rosa{300} \\ \hline
250 & + & 70  & = & \rosa{320} \\ \hline
500 & - & 250 & = & \rosa{250} \\ \hline
400 & + & 130 & = & \rosa{530} \\ \hline
320 & - & 60  & = & \rosa{260} \\ \hline
170 & + & 40  & = & \rosa{210} \\ \hline
\end{tabular}
\end{table}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.45\textwidth]{./media/image23.png}
...
Calcule a pontuação das jogadas a seguir. Os ``x'' vermelhos mostram onde o dardo acertou o alvo.
...
%André: colocar as respostas por extenso (28/8/23)
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.4\textwidth]{./media/image26.png}
\end{figure}
...
Você sabe qual é o número do seu sapato? Ou melhor, você sabe qual número você calça? Já ouviu essa pergunta?
Pois é! Calçados têm números para representar os seus tamanhos. Mas como isso é medido? Todos temos tamanhos padronizados de pés? É claro que não! Cada um tem um tamanho de pé. Mas, então, como a loja tem sapatos prontos para serem vendidos para qualquer um? Existem vários padrões para numerar um sapato. No Brasil, usamos o padrão francês. Quando alguém usa um sapato 33, isso significa que o pé dessa pessoa mede até 21,6 centímetros. Cada 6,6 milímetros corresponde a uma unidade de medida. 
%André: retirar o fundo da imagem abaixo
\begin{figure}[H]
\centering
\includegraphics[width=.5\textwidth]{./media/image176.jpg}
\end{figure}
Vamos lá! Você já tentou medir seu pé alguma vez? Pegue uma folha e trace o contorno do seu pé com um lápis ou uma canetinha. Depois, meça do calcanhar até a ponta do dedão em linha reta. Compartilhe as medidas com os colegas.
...
\vspace{+1em}
\centering
\noindent\includegraphics[width=.9\textwidth]{./media/image29.png}
}
...
\reduline{O instrumento é utilizado para medir o tempo, funcionando como um relógio.\hfill}
...
\begin{itemize}
\item 1. Ele me diz se estou atrasado ou se vou chegar a tempo.

\item 3. Ela me diz se engordei ou emagreci, medindo minha massa.

\item 4. Ela me diz o quanto cresci, além de medir o tamanho das coisas.
\end{itemize}

\textbf{Verticais}

\begin{itemize}
\item 2. Ela guarda aquilo que mata minha sede, além de me ajudar a medir a
...
\hspace{0.5cm}
\begin{minipage}{.5\textwidth}
\reduline{80kg, uma vez que o visor da balança apresenta, atualmente, 70 kg.\hfill}
\linhas{4}
\end{minipage}
...
\begin{itemize}
\item Comprimento:\\
\reduline{Uma régua ou os próprios passos, por exemplo.\hfill}
\linhas{1}

\item Massa:\\
\reduline{Balança ou a comparação de quantidades da mesma substância que tenham uma
...
\num{10} Ligue a figura à sua massa em quilogramas, de forma correta.

\begin{figure}[H]
\centering
\includegraphics[width=.6\textwidth]{./media/image41.png}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=.3\textwidth]{./media/image46.png}
\end{figure}
...
\conteudo{
Você já parou para pensar quanto tempo demora um jogo de um esporte
qualquer? Às vezes, vamos jogar bola e não nos damos conta do tempo que
passa. Jogamos até nos cansarmos, ou então até nossa mãe nos
...
tempo? Vamos analisar alguns esportes e compará-los. Veja a lista a seguir.

\textbf{Futebol:} São dois tempos de 45 minutos, totalizando 1 hora e 30 minutos.

\textbf{Basquete:} São quatro tempos de 10 minutos, totalizando 40 minutos.

\textbf{Vôlei:} Não tem tempo determinado. Acaba quando o time alcança o número de pontos.

\textbf{Fórmula 1:} É determinado pelo número de voltas, mas uma
corrida não pode passar de 2 horas.

\textbf{Handebol:} São dois tempos de 30 minutos, totalizando 1 hora.

\textbf{Tênis:} Igual ao vôlei, sem tempo determinado. O jogador deve atingir um número determinado de pontos
% \conteudo{
...
% \begin{tabular}{|c|c|}
% \hline
% \textbf{Esporte}   & \textbf{Tempo de duração}                                                                                                                \\ \hline
% \textbf{Futebol}   & \begin{tabular}[c]{@{}c@{}}São dois tempos de 45 minutos.\\ Tempo total: 1 hora e 30 minutos.\end{tabular}                               \\ \hline
% \textbf{Basquete}  & \begin{tabular}[c]{@{}c@{}}São quatro tempos de 10 minutos.\\ Tempo total: 40 minutos.\end{tabular}                                      \\ \hline
% \textbf{Vôlei}     & \begin{tabular}[c]{@{}c@{}}Não tem tempo determinado.\\ Acaba quando o time alcança o número de pontos.\end{tabular}                     \\ \hline
% \textbf{Fórmula 1} & \begin{tabular}[c]{@{}c@{}}É determinado pelo número de voltas, mas uma\\ corrida não pode passar de 2 horas.\end{tabular}               \\ \hline
% \textbf{Handebol}  & \begin{tabular}[c]{@{}c@{}}São dois tempos de 30 minutos.\\ Tempo total: 1 hora.\end{tabular}                                            \\ \hline
% \textbf{Tênis}     & \begin{tabular}[c]{@{}c@{}}Igual ao vôlei, sem tempo determinado.\\ O jogador deve atingir um número determinado de pontos.\end{tabular} \\ \hline
% \end{tabular}
% \end{table}
}
...
\begin{tabular}{|c|c|}
\hline
Quantos meses tem meio ano?          & \rosa{6}   \\ \hline
Quantos dias têm três semanas?       & \rosa{21}  \\ \hline
Quantos dias tem, no máximo, um mês? & \rosa{31}  \\ \hline
Quantos dias tem, no mínimo, um mês? & \rosa{28}  \\ \hline
Quantas semanas têm três meses?      & \rosa{12}  \\ \hline
Quantas horas tem uma semana?        & \rosa{168} \\ \hline
\end{tabular}
\end{table}
...
% \begin{figure}[htpb!]
% \centering
% \includegraphics[width=.8\textwidth]{./media/image56.png}
% \end{figure}
...
\hline
                & Resposta                                      \\ \hline
1/2 hora depois & \rosa{9:40}                   \\ \hline
1 hora depois   & \rosa{10:10}                  \\ \hline
2 horas depois  & \rosa{11:10}                  \\ \hline
3 horas depois  & \rosa{12:10}                  \\ \hline
12 horas depois & \rosa{9:10 da noite ou 21:10} \\ \hline
\end{tabular}
\end{table}
...
\begin{figure}[H]
\centering
\includegraphics[width=.7\textwidth]{./media/image54.png}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=.9\textwidth]{./media/image52.png}
\end{figure}
...
\end{figure}\enlargethispage{4\baselineskip}

\coment{A atividade não tem uma resposta determinada, pois dependerá do cotidiano do aluno. O importante é que cada um consiga organizar, na linha do tempo, sua própria rotina, de forma lógica. O aluno deve, por exemplo, colocar atividades associadas ao período da manhã - como escovar os dentes, por exemplo - nessa parte do dia. }
...
\begin{escolha}[itemsep=-5pt]
\item Em que dia ocorrerá a disputa de 3° e 4° lugares?
...
\begin{figure}[H]
\centering
\includegraphics[width=.7\textwidth]{./media/image175.jpg}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=.6\textwidth]{./media/image62.png}
\end{figure}
...
contas e deveres etc. Nesses jogos, às vezes, você ganha dinheiro ou às vezes
você perde, mas o importante é que pense na
melhor forma de usar o dinheiro para ganhar o jogo, ou seja,
...
\item caso você precise vender, perderá 50.
\end{enumerate}
...
\reduline{Célio e César.\hfill}\enlargethispage{2\baselineskip}
...
\reduline{O aluno pode configurar o pagamento como desejar; porém, o cálculo da
...
desenho no quadro.\enlargethispage{2\baselineskip}
...
\vspace*{-1em}
\begin{figure}[htpb!]
\includegraphics[width=.78\textwidth]{./media/image67.png}
\end{figure}
...
\begin{center}
\noindent\includegraphics[width=.5\textwidth]{./media/image84.png}
\end{center}
...
Talvez aqui o aluno possa deixar a imaginação fluir, já que diferentes respostas são possíveis\hfill}\enlargethispage{2\baselineskip}

\item Certeza:\\
\reduline{É certo que haverá um vencedor, pelo mesmo motivo de que não pode haver um empate.\hfill}
\end{itemize}
...
\num{4} Ângela ganhou uma bicicleta de seus pais. Ela ainda não sabe andar de
...
\begin{figure}[H]
\includegraphics[width=.8\textwidth]{./media/image88.png}
\end{figure}
...
colocarmos dados importantes e, assim, enxergarmos melhor o que esses
...
lugares diferentes e com grupos diferentes: entre alunos de uma
sala de aula, entre moradores de um condomínio, entre os funcionários de
uma empresa, ou com qualquer outro grupo de pessoas.

\begin{center}
\noindent\includegraphics[width=.7\textwidth]{./media/image173.jpg}
\end{center}
...
Como esses dados ficariam em uma tabela e em um gráfico?

\begin{center}
\noindent\includegraphics[width=.9\textwidth]{./media/image89.png}
\end{center}
}
...
\begin{figure}[H]
\centering
\includegraphics[width=.5\textwidth]{./media/image174.jpg}
\end{figure}

\reduline{A resposta é pessoal. O importante é que os alunos pensem sobre quais são as matérias com as quais têm maior facilidade e, assim, realizarem uma comparação.\hfill}
...
Analise o gráfico a seguir e, então, responda às questões de 3 a 6.
...
linhas azuis mostram as temperaturas menores.
...
\num{3} Em qual mês choveu mais nos últimos anos?

\reduline{Janeiro.\hfill}
\linhas{1}

\num{4} Qual mês foi mais quente nos últimos anos?

\reduline{Fevereiro.\hfill}
\linhas{1}

\num{5} Quais foram os dois meses mais frios nos últimos anos?

\reduline{Junho e julho.\hfill}
\linhas{1}

\num{6} Considerando as médias das chuvas e das temperaturas, qual seria seu mês preferido do ano? Por quê?
...
1º                 & \rosa{De chuá}         & \rosa{19 x 3 = 57}       \\ \hline
2º                 & \rosa{Pulinho grande}  & \rosa{(18 x 3) + 2 = 56} \\ \hline
3º                 & \rosa{Cesta amarela}   & \rosa{18 x 3 = 54}       \\ \hline
4º                 & \rosa{Garrafão mágico} & \rosa{17 x 3 = 51}       \\ \hline
5º                 & \rosa{Regatinha}       & \rosa{(16 x 3) + 2 = 50} \\ \hline
6º                 & \rosa{Bolinha laranja} & \rosa{15 x 3 = 45}       \\ \hline
7º                 & \rosa{Cestinha}        & \rosa{(12 x 3) + 8 = 44} \\ \hline
8º                 & \rosa{Zona morta}      & \rosa{(13 x 3) + 1 = 40} \\ \hline
9º                 & \rosa{Pipoca}          & \rosa{(10 x 3) + 9 = 39} \\ \hline
10º                & \rosa{De 3}            & \rosa{10 x 3 = 30}       \\ \hline
\end{tabular}
\end{table}
...
\num{1} Uma pessoa saiu para fazer compras, planejando comprar uma calça, uma bermuda, um par de tênis, uma camiseta e um par de meias. Analise a tabela e indique o valor da conta a ser pago por ela, considerando que ela escolha comprar nos lugares onde os
...
\num{2} O gráfico mostra as notas de Jéssica no mês passado. Indique em
...
\num{3} Indique qual é o doce menos vendido em uma doceria, analisando o gráfico.
...
\conteudo{
Você com certeza já comeu uma bela pizza! De muçarela, de
calabresa, uma portuguesa, quatro queijos! Hummmm! Pizza é uma delícia!

\begin{center}
\includegraphics[width=.7\textwidth]{./media/image103.png}
\end{center}

Você já percebeu que elas vêm divididas em pedaços? Algumas vêm
...
Claro! Pizza! Vamos supor que, na sua família, haja quatro pessoas. Se
cada um comer dois pedaços, temos:
(2 + 2 + 2 + 2 = 8) pedaços.
Que conta mais comprida! Para melhorar essa situação, podemos fazer a
seguinte operação:

(4 familiares x 2 pedaços cada = 8 pedaços.)
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.6\textwidth]{./media/image104.png}
\end{figure}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.4\textwidth]{./media/image108.png}
...
pinte o quadradinho da mentira de vermelho.\enlargethispage{2\baselineskip}

\begin{figure}[htpb!]
\centering
\includegraphics[width=.9\textwidth]{./media/image109.png}
\end{figure}

\begin{figure}[htpb!]
\centering
\includegraphics[width=.9\textwidth]{./media/image110.png}
\end{figure}
