...
\vspace*{0.5em}
\conteudo{O ábaco da figura é o mais simples e serve somente para representar
...
\begin{figure}[H]
\centering
\includegraphics[width=.75\textwidth]{./media/image41.png}
\end{figure}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.7\textwidth]{./media/image104_prof.png}
\end{figure}
