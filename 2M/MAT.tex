...
\reduline{A resposta é pessoal. O importante é que os alunos pensem sobre quais são as matérias com as quais têm maior facilidade e aquelas com as quais têm mais dificuldade e, assim, realizarem uma comparação.\hfill}
\linhas{2}
...
\item Considerando as médias das chuvas e das temperaturas, qual seria seu mês preferido do ano? Por quê?
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.7\textwidth]{./media/image95_prof.png}
\end{figure}
