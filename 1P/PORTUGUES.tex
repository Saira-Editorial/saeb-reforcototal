...
\fonte{CONTOS TRADICIONAIS, FÁBULAS, LENDAS E MITOS. DISPONÍVEL EM: \emph{http://www.dominiopublico.gov.br/download/texto/me001614.pdf}. ACESSO EM: 31 JUL. 2023.}
\end{myquote}
...
\begin{itemize}
	...
	\item O QUINTAL AVISTADO PERTENCIA A UMA FEITICEIRA TEMIDA E PODEROSA. \rosa{X}
\end{itemize}
...
\num{10} QUANTAS SAIAS A BARATA TEM NA REALIDADE?
...
\begin{center}
\includegraphics[width=.8\textwidth]{media/image170.png}
\end{center}
}
...
\reduline{Aparece a representação de uma seringa, porque, na campanha, serão usadas seringas para aplicar a vacina.}
\linhas{3}
