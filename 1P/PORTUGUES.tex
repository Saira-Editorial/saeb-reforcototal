...
DUAS PALAVRAS FORMAM RIMAS QUANDO TÊM O MESMO SOM NO FINAL. POR EXEMPLO: PALAVRAS COMO "GATO" E "RATO" TÊM O MESMO SOM NO FINAL; POR ISSO, ELAS RIMAM.
...
AS PALAVRAS "GATO" E "RATO" TÊM O MESMO SOM NO FINAL; ENTÃO, ELAS RIMAM ENTRE SI.
}
\pagebreak
...
\item AGORA, ESCREVA UMA LISTA SOMENTE COM AS VOGAIS E OUTRA SOMENTE COM AS CONSOANTES.

\reduline{A lista das vogais deve ser: A - E - I - O - U. A lista das consoantes deve ser: B - C - D - F - G - H - J - L - M - N - P - Q - R - S - T - V - X - Z, além de K, W e X.\hfill}
...
\reduline{Deve ser mercada a imagem do meio.}
...
\reduline{Devem ser escritas as seguintes letras: V, S, C, S, A, D, M, P.}
...
\reduline{As palavras pintadas devem ser JANELA, PANELA e CANELA.}
...
\reduline{Devem ser circulados os símbolos que não representam letras do alfabeto. As palavras escritas corretamente são: maçâ- rato -- tatu - tapete -- casa -- mola -- bule -- doce.\hfill}
\linhas{4}
...
\reduline{Devem ser circuladas as seguintes imagens: bolo - pato - tatu - mala.}
...
\reduline{Devem ser pintadas as palavras CORRIDA e FERIDA.}
...
\reduline{Devem ser pintadas as palavras COELHO, MENINA e TELEFONE; RELÓGIO, ESCOVA e MALA.}
...
\reduline{A letra circulada deve ser o "O".\hfill}
\end{escolha}
...
\reduline{A palavra circulada deve ser o artigo "O".\hfill}
...
\reduline{A palavra pintada deve ser "macaco".}
...
\reduline{A palavra pintada deve ser "sentar".}
\reduline{SENTAR\hfill}

\linhas{1}
\end{escolha}

\num{4} DESENHE O ANIMAL QUE APARECE NA PARLENDA E ESCREVA SEU NOME.
\reduline{O aluno deve desenhar um macaco e escrever "MACACO".}
...
\reduline{A palavra circulada deve ser "PIRULITO".}
...
\reduline{A palavra se divide em quatro "pedaços de sons" (sílabas).\hfill}

\linhas{2}

\item AGORA PINTE A ÚLTIMA PALAVRA DA MÚSICA.
\reduline{A palavra pintada deve ser "EU".}
\end{escolha}
...
\reduline{As sílabas circuladas e copiadas devem ser: "CE", "A", "LA", "RA".}
...
\reduline{Os nomes escritos devem ser: 1- GATO; 2- CACHORRO; 3- VACA; 4- CAVALO; 5- COELHO.}
...
\reduline{Respostas: banana, morango, uva, maçã.\hfill}
...
\reduline{As figuras marcadas devem ser "cenoura, "celular" e "cegonha".}
...
\reduline{As sílabas copiadas devem ser "AR-RE", "BOR-TA", "PA-O" e "JAR-DIM".}
...
\reduline{O título a ser pintado é "Pombinha Branca".}
...
\reduline{Ela está lavando a roupa do casamento.\hfill}
...
\coment{O aluno deve circular as seis imagens centrais que aparecem no cartaz.}
...
\begin{mdframed}[linewidth=2pt,linecolor=salmao,roundcorner=2pt]
\vspace{3cm}
\coment{Resposta pessoal. É importante que a gatinha seja branca, como é descrita nos versos.}
\end{mdframed}
...
\textbf{CONVITE:} SERVE PARA CHAMAR ALGUÉM PARA ALGUM EVENTO. 
...
\textbf{LISTA:} SERVE PARA ORGANIZAR INFORMAÇÕES.
...
\fonte{Secretaria de Estado da Educação de Goiás. Salada de frutas. Disponível em:
