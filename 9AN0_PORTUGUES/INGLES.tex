...
convencer o leitor. \reduline{V}

\item Um texto argumentativo deve apresentar diferentes aspectos sobre
um assunto. \reduline{V}

\item ``So'' não pode ser considerado um conectivo de argumentação. \reduline{F}

\item Um texto argumentativo não apresenta exemplos. \reduline{F}
\end{boxlist}
...
\reduline{O texto busca convencer o leitor a respeito da vacinação contra o
coronavírus.}
...
\reduline{SAEB: Identificar os recursos verbais e/ou não verbais que contribuem
