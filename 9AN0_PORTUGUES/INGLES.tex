...
\reduline{Devemos compará-las para obtermos uma visão mais ampla.}

\num{3} Complete a frase a seguir.\\
Em um mesmo texto, podemos encontrar \preencher diferentes.

\reduline{perspectivas}

\num{4} Assinale V para verdadeiro e F para falso.

\begin{boxlist}
\item Fatos e opiniões nomeiam ideias que se relacionam com o mesmo conceito. \reduline{F}

\item É muito importante identificarmos diferentes perspectivas sobre um
tema. \reduline{V}

\item Não é possível encontrarmos fatos e opiniões em um mesmo texto. \reduline{F}
...
\reduline{O texto apresenta um fato no trecho ``Some parts of the coast of England will get further protection''.}

\num{7} Encontre, no texto, uma perspectiva negativa a respeito do tema.

\linhas{4}

\reduline{Uma visão negativa pode ser encontrada no trecho ``Although necessary, some experts consider these bans to be insufficient''.}

\num{8} Identifique no texto uma informação confiável.

\linhas{6}

\reduline{De acordo com o professor Callum Roberts, ``while this kind of measure is important, only a small amount of the English coast will be protected''.}
...
\reduline{SAEB: Contrapor perspectivas sobre um mesmo assunto em textos em língua
inglesa.
...
\reduline{SAEB: Avaliar a qualidade e a validade das informações veiculadas em
...
\reduline{SAEB: Distinguir fatos de opiniões em textos em língua inglesa.
BNCC: EF09LI06 -- Distinguir fatos de opiniões em textos argumentativos
da esfera jornalística.
