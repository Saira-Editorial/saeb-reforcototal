...
\fonte{Fonte de pesquisa: Jackie Wattles. CNN. NASA rover finds 'clearest evidence yet' of an ancient lake on Mars. \emph{Disponível em:
...
a) Correta. Essa informação pode ser encontrada no trecho ``{[}\ldots{}{]} it is very important to keep on wearing masks since we the pandemic is not over yet.'';
...
\coment{De acordo com o professor Callum Roberts, "{[}\ldots{}{]} while this kind of measure is important, only a small amount of the English coast will be protected''.}
...
\fonte{BBC. Fonte de pesquisa: Patrick Hughes. England's archaeological history gathers dust as museums fill up. \emph{
...
\fonte{Fonte de pesquisa: Michaeleen Doucleff. Look up! Venus and Jupiter are going in for a nighttime kiss. NPR. Disponível em: \emph{
