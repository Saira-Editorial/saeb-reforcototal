...
\reduline{Este módulo parte do entendimento do conceito de energia para embasar
...
do meio rural. \reduline{V}

\item O surgimento das indústrias centralizou a economia nas cidades. \reduline{V}

\item A presença de fazendas nas cidades exemplifica o convívio duradouro
entre os tipos de produção. \reduline{F}

\item A natureza repõe seus recursos mais rápido do que a necessidade
industrial. \reduline{F}
\end{boxlist}

\reduline{A urbanização praticamente eliminou as atividades rurais dos centros
...
\begin{boxlist}
\item Construção de hortas urbanas. \reduline{X}

\item Drenagem total de rios e pântanos.

\item Criação de florestas urbanas. \reduline{X}

\item Expansão da cidade.
\end{boxlist}

\reduline{A construção de hortas urbanas aproxima a produção de alimentos dos
...
\reduline{Resposta pessoal. Espera-se que os alunos reflitam sobre a situação ruim em que a humanidade se encontra e tentem pensar em maneiras de alterar o quadro enquanto é tempo.}
...
\reduline{Melhoria da ventilação natural de prédios e bairros; construção de áreas de lazer abertas; investimento em arquitetura verde.}

\item Ausência de vegetação contínua.

\linhas{5}

\reduline{Reflorestamento; arborização urbana; valorização do paisagismo.}
\end{escolha}
...
\reduline{A produção precisa suprir a pouca durabilidade dos produtos, e isso faz com que seja extraído da natureza
...
\section{Habilidades da BNCC} 1. EF09GE01, EF09GE02, EF09GE03,
