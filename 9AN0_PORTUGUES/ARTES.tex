...
\reduline{Possibilidade de resposta: \textit{Madonna Rucellai}, de Duccio di Buoninsegna, de 1285. Disponível em: https://commons.wikimedia.org/wiki/File:Madonna\_em\_Majestade\_dita\_Rucellai\_-\_Duccio.jpg. Acesso em: 10 maio 2023.\hfill}
\linhas{2}
...
\reduline{Possibilidade de resposta: máscara funerária egípcia. Disponível em: https://commons.wikimedia.org/wiki/File:Funerary\_Mask\_of\_Wah\_MET\_DP311797.jpg. Acesso em: 10 maio 2023.\hfill}
\linhas{2}

\item Corpo simplificado, feito com poucas linhas, que sugere a prática de
punições daquela cultura.

\reduline{Possibilidade de respsota: pintura rupestre da Serra da Capivara. Disponível em: https://commons.wikimedia.org/wiki/File:Puni\%C3\%A7\%C3\%B5es\_(14205232887).jpg. Acesso em: 10 maio 2023.\hfill}
\linhas{2}
...
\reduline{Possibilidade de resposta: \textit{Discóbolo}, de Míron, do século V a.C. Disponível em: https://commons.wikimedia.org/wiki/File:Roman\_bronze\_copy\_of\_Myron\%E2\%80\%99s\_Discobolos,\_2nd\_century\_CE\_(Glyptothek\_Munich).jpg. Acesso em: 10 maio 2023.\hfill}
\linhas{2}
\end{escolha}
...
\item
  ...
  histórico-sócio-cultural. \reduline{X}
\item
...
\item Enfatizava o movimento natural do corpo. \reduline{X}
...
\linhas{3}
\reduline{Sensores, programação e tecnologia audiovisual.}
...
( \reduline{II} ) O uso de máscaras era uma forte marca desse grupo teatral. Os
...
( \reduline{IV} ) Criado em Salvador, em 1990, esse grupo teatral coloca em prática um
...
( \reduline{III} ) Esse grupo teatral, criado em 1982, é uma companhia brasileira,
...
( \reduline{I} ) Teatro chinês tradicional que surgiu no final do século XVIII. Durante a
...
( \reduline{II} ) Cria sequências de imagens e efeitos especiais em 2D ou 3D.

( \reduline{III} ) Realiza efeitos especiais, fundos sonoros e edita áudio em sincronia com as imagens.

( \reduline{I} ) Aprova o roteiro, escolhe o elenco, planeja a produção.

( \reduline{IV} ) Cria ou adapta uma narrativa para o audiovisual.
...
\reduline{SAEB: Analisar formas, gêneros e estilos distintos de música e teatro
...
\reduline{SAEB: Analisar o papel dos profissionais e a utilização dos
...
\begin{boxlist}
\item Igrejas e teatros. \reduline{M}

\item Danças e músicas. \reduline{I}

\item Crenças populares e festas. \reduline{I}

\item Áudios e vídeos. \reduline{M}
\end{boxlist}
...
\linhas{2}
\reduline{A Literatura de Cordel recebeu contribuições das culturas africana,
indígena e europeia (portugueses).}

\num{2}  Com base no texto que você leu, assinale V para verdadeiro e F para falso.

\begin{boxlist}
\item A Literatura de Cordel era vendida em mercados e feiras livres, desde sua origem.\reduline{F}
\item A Literatura de Cordel é um patrimônio cultural material.\reduline{F}
\item A Literatura de cordel é um patrimônio cultural imaterial.\reduline{V}
\item A Literatura de Cordel é uma forma de expressão da literatura tradicional.\reduline{F}
\end{boxlist}
...
\linhas{6}
\reduline{A roda de capoeira surgiu no século XVII, no período colonial brasileiro.}
...
( \reduline{III} ) \textbf{Livro de registro das celebrações.} Reúne os rituais e
...
( \reduline{IV} ) \textbf{Livro de registro dos lugares.} Recebe as inscrições dos
...
( \reduline{I} ) \textbf{Livro de registro das formas de expressão.} Recebe 
...
( \reduline{II} ) \textbf{Livro de registro dos saberes.} Reúne os 
...
\linhas{4}
\reduline{Os bens que representavam a cultura das classes mais abastadas.}
...
\reduline{SAEB: Avaliar produções que inter-relacionam diferentes linguagens
artísticas.
...
\reduline{SAEB: Avaliar o papel das diversas linguagens artísticas no
...
\reduline{SAEB: Avaliar nas linguagens artísticas a diversidade do patrimônio
...
\reduline{SAEB: Analisar formas, gêneros e estilos distintos de artes visuais e
...
\reduline{SAEB: Analisar a função do tema como projeto integrador das diferentes
...
\reduline{SAEB: Identificar diferentes formas de registro das artes por meio de
notação ou procedimentos e técnicas de áudio e audiovisual.
...
\reduline{SAEB: Identificar os usos de diferentes tecnologias e recursos
