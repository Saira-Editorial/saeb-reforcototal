...
\conteudo{\textbf{O que significa contexto da obra de arte?}

Vamos dar início a essa conversa, buscando o significado da palavra
contextualizar em um dicionário. Segundo o dicionário on-line
\emph{Dicio} contextualizar é:

\begin{quote}
Mostrar as circunstâncias que estão ao redor de um fato, acontecimento,
situação: o advogado contextualizou as provas. Entender ou interpretar
algo tendo em conta as circunstâncias que o rodeiam, colocando num
contexto: contextualizou o texto historicamente.
\end{quote}
...
Para ajudar na contextualização de uma obra de arte, faça algumas
perguntas: Em que data a obra foi realizada? A que período histórico a
obra está relacionada? Que artista a realizou? O que sabemos ou podemos
saber sobre esse artista? Com que finalidade a obra foi realizada? Quais
os fatos sociais, políticos, econômicos, religiosos e culturais mais
marcantes do período em que a obra foi produzida? Que relações a obra
...
\textbf{O que são práticas na arte?}

É o fazer artístico! É o colocar mãos à obra e experimentar e vivenciar
a arte como uma prática social, interagindo com a linguagem artística,
não somente como expectador, analista ou apreciador, mas como criador,
sujeito ativo.

\textbf{Quais são os elementos da linguagem na arte?}

Sem ter a intenção de esgotar os múltiplos elementos da linguagem
artística, podemos citar, nas artes visuais: ponto, linha, forma,
direção, cor, tom, escala, dimensão, espaço, movimento etc. Na música:
altura, intensidade, timbre, melodia, ritmo etc. No teatro: entonações
de voz, personagens, narrativas, figurinos, cenário, iluminação,
sonoplastia etc. Na dança: tempo, peso, fluência, espaço, deslocamentos,
ritmos de movimento, direções etc.}

\coment{Sugerimos que a primeira leitura do texto seja realizada pelos alunos
individualmente. Peça a eles que grifem no texto as partes que geraram
dúvidas de compreensão do conteúdo, para depois realizar uma discussão
coletiva sobre as informações apresentadas no texto. Anote as principais
dúvidas e tenha elas como referência para avaliar quais são os pontos do
conteúdo que devem ser retomados na sua prática. Durante a discussão
coletiva, intervenha, auxiliando na compreensão de alguns aspectos e
avise-os que essas questões serão fruto de novos estudos e discussões em
aulas posteriores.

Em outro momento, retome a leitura da parte do texto sobre o contexto
das obras de arte e apresente, por meio de projeção, impressão, pesquisa
na internet, entre outras possibilidades, uma obra de artes visuais a
ser contextualizada, que seja do interesse dos alunos ou que sirva para
futuras atividades que fazem parte do seu planejamento.

Faça algumas das perguntas indicadas no texto, para a contextualização
da obra. Não é necessário que esgote todas as perguntas em uma só aula.
A escolha das perguntas que serão feitas, devem estar de acordo com os
objetivos planejados e o grau de conhecimento que os alunos já têm a
respeito do assunto.\\
\textbf{Habilidades BNCC}: EF69AR01 / EF69AR03 / EF69AR04}

\colorsec{Habilidades SAEB}

\begin{itemize}
\item Reconhecer artistas que contribuíram para o desenvolvimento e a
disseminação de diferentes gêneros e estilos nas artes visuais, dança,
música e teatro.

\item Analisar formas, gêneros e estilos distintos de artes visuais e dança,
em diferentes contextos, por meio de seus elementos constitutivos.

\item Analisar a função do tema como projeto integrador das diferentes
...
interagindo com a linguagem artística, não somente como expectador,
analista ou apreciador, mas como criador, sujeito ativo.}
...
\coment{Altura, intensidade, timbre, melodia, ritmo etc.}
...
Habilidade BNCC: EF69AR03

a) Incorreta;
b) Incorreta;
c) Incorreta;
d) Correta. Todas as afirmativas relacionam-se com a história do teatro.}

\num{6} O corpo se expressa nas artes visuais, na dança, na música, no
teatro, e é representado de muitas formas. Relacione as colunas
indicando as visões de cada sociedade sobre o corpo e a existência
humana representadas em cada obra de arte.

(1) \emph{Discóbolo}. Cópia do original grego de Míron (século 5 a.C.).
Bronze. Gliptoteca de Munique, Alemanha.

(2) \emph{Madonna Rucellai,} Duccio di Buoninsegna\emph{,} 1285. Têmpera em
madeira. 450 cm x 292 cm. Galeria dos Uffizi, Florença, Itália.

(3) Pintura rupestre, entre 12 mil e 6 mil anos atrás. Parque Nacional Serra
da Capivara, Piauí.

(4) Detalhe da pintura da câmara mortuária de Sennedjem. Cerca de 1200
a.C.

\begin{boxlist}
\item corpo feito com poucas linhas, pouca profundidade, para expressar
a religiosidade e esconder a sensualidade de corpos reais. \coment{2}

\item corpo representando figura de destaque na sociedade, uma forma de
cultuar os mortos, com linhas simples e níveis retilíneos. \coment{4}

\item corpo simplificado, feito com poucas linhas e sugerem a prática de
punições daquela cultura. \coment{3}
...
%\textless{}Imagem 1:
%\url{https://commons.wikimedia.org/wiki/File:Roman_bronze_copy_of_Myron\%E2\%80\%99s_Discobolos,_2nd_century_CE_(Glyptothek_Munich).jpg}\textgreater%{}
%
%\textless{}Imagem 2:
%\url{https://commons.wikimedia.org/wiki/File:Madonna_em_Majestade_dita_Rucellai_-_Duccio.jpg}\textgreater{}
%
%\textless{}Imagem 3:
%\url{https://commons.wikimedia.org/wiki/File:Puni\%C3\%A7\%C3\%B5es_(14205232887).jpg}\textgreater{}
%
%\textless{}Imagem 4:
%\url{https://commons.wikimedia.org/wiki/File:Maler_der_Grabkammer_des_Sennudem_001.jpg}\textgreater{}

\coment{
\emph{Discóbolo}, do escultor Míron, uma obra da Grécia Antiga,
representa um atleta lançador de discos. Nesse período, chamado de
Clássico, os artistas buscavam representar o corpo humano, tanto
feminino como masculino, dentro das proporções corretas, expressando
também os ideais da sociedade da época, de harmonia e de equilíbrio
entre corpo e mente. O \emph{Discóbolo}, assim como outras obras
originais da época, foi destruído e não existe mais. É possível
conhecê-lo por meio de cópias realizadas por outros artistas gregos e
romanos.

\emph{Madonna Rucellai}, de Duccio di Buoninsegna, é uma obra da Idade
Média, período entre os séculos 5 e 15 da era cristã. A maioria das
obras de arte desse período são representações religiosas. As obras de
arte desse período, onde o corpo era considerado ``fonte de pecado'',
não deveriam representar a sensualidade e, por isso, o corpo era
``escondido'', aparecendo apenas rosto, pés e mãos. As figuras eram
feitas com poucas linhas e quase não havia profundidade.

Pintura rupestre da Serra da Capivara, Piauí, executada entre 12 a 6 mil
anos atrás pelos povos que habitaram, naquela época, o que hoje
corresponde ao estado do Piauí. Na pintura, poucas linhas já são
suficientes para representar o corpo humano e sugere a ``representação
da prática de punições''. O Parque Nacional Serra da Capivara foi
declarado pela~UNESCO, em 1991,~Patrimônio Cultural da Humanidade.
Indicamos a visita virtual ao Museu do Homem Americano, disponível em:
http://fumdham.org.br. Acesso em: 7 mar. 2023.

O detalhe da pintura de parede da câmara mortuária de Sennedjem, artesão
de túmulos reais, da 19ª dinastia egípcia, fundada em 1 295 a.C., quando
o faraó Ramessés I assumiu o trono, representa Sennedjem arando o campo
com tração animal. Na pintura é possível identificar alguns dos padrões
rígidos utilizados pelos egípcios antigos para representar o corpo
humano: a cabeça e as pernas são vistas de lado; as mãos desenhadas sem
distinção entre direita e esquerda; linhas simples; cores uniformes. Na
época, a arte buscava, entre outras coisas, representar e homenagear
faraós e figuras de destaque na sociedade egípcia e estava relacionada,
principalmente, com o culto dos mortos. Os artistas deviam seguir
rígidas normas, buscando representar a harmonia, a solenidade do momento
da passagem da vida terrena à vida após a morte.
...
\item As linhas, sequências ordenadas de pontos, podem ser retas e curvas. \coment{V}
...
Habilidade BNCC: EF69AR04

Respostas na ordem em aparecem:

F: Existem diversos elementos constitutivos das artes visuais: ponto,
linha, forma, direção, cor, tom, escala, dimensão, espaço, movimento
etc.; V; V; F: É no espaço tridimensional que as formas têm altura, largura e
profundidade.}
...
\blue{Representação de qualquer objeto inanimado.}

\blue{Representação de um local, seja no campo ou na cidade.}

\blue{Quando a artista retrata algo ou alguém.}

\blue{Quando o artista retrata a si mesmo.}
\end{boxlist}
...
Respostas: Autorretrato = Quando o artista retrata a si mesmo; Retrato =
Quando o artista retrata algo ou alguém; Paisagem = Representação de um
local, seja no campo ou na cidade; Natureza-morta = Representação de
...
Portanto, estamos falando de artefatos da cultura que afetam esses dois
sentidos do homem, a visão e a audição. (COUTINHO, 2006, p. 16).
\end{quote}
...
Resposta pessoal. O aluno pode citar, por exemplo, cor, espaço,
movimento, luz, sombra, tom, som (efeitos sonoros, diálogos, música).}

\num{10} Leia o trecho de uma reportagem sobre Augusto Boal, um dos expoentes
do Teatro brasileiro e mundial.

\begin{quote}
\textbf{Augusto Boal e o Teatro do Oprimido}

%Augusto Boal recebendo o Prêmio Transfroteiriço de Paz e Democracia,
%Abbey Teatro. Dublin, 2008.
%\textless{}
%\href{https://openverse.org/image/7fb346b1-5ef1-4f22-a4d9-99b2d135e07f?q=augusto\%20boal}{File:Augusto
%Boal \textbar{} Openverse}\textgreater{}
%\textless{}Foto de AnnMari\textgreater{}\strut


Falecido aos 78 anos de idade, Augusto Boal foi e ainda é um dos grandes
nomes da dramaturgia brasileira, principalmente por conta de sua forma
de trabalhar o teatro como ferramenta de luta política e social. Boal é
criador~do Teatro do Oprimido, técnica cênica que coloca os espectadores
como protagonistas nas encenações, suprimindo a separação entre
realidade e ficção.

O artista~é~autor de diversas obras literárias e vencedor de prêmios e
honrarias no Brasil e no mundo, chegando a ser nomeado Embaixador
Mundial do Teatro pela Unesco, em 2009, ano de sua morte.~

\fonte{Disponível em:
https://www.brasildefato.com.br/2019/05/02/ha-10-anos-falecia-augusto-boal-criador-do-teatro-do-oprimido}.
...
teatro, nas artes visuais, dança e música. Conheça algumas obras de
artistas brasileiros e faça uma pesquisa para escrever brevemente sobre
eles e suas contribuições.

\begin{longtable}[]{@{}ll@{}}
\toprule
\begin{minipage}[t]{0.48\columnwidth}\raggedright\strut
\includegraphics[width=2.50764in,height=1.87292in]{media/image6.png}

Escultura sem nome, de Amilcar de Castro. Hall das Bandeiras do Palácio
da Inconfidência, Belo Horizonte, MG.

\textless{}\href{https://commons.wikimedia.org/wiki/File:Amilcardecastroalmg.jpg?uselang=pt}{\emph{https://commons.wikimedia.org/wiki/File:Amilcardecastroalmg.jpg?uselang=pt}}\textgreater{}\strut
...
\coment{
Dinâmica: Sala de aula invertida

Oriente seus alunos a pesquisarem sobre os artistas brasileiros e suas
contribuições para a Arte em fontes confiáveis da internet, sugerindo
alguns sites, entre eles:

Augusto Boal: http://augustoboal.com.br. Acesso em: 8 mar. 2023.

Amilcar de Castro: https://enciclopedia.itaucultural.org.br/pessoa2448/amilcar-de-castro. Acesso em: 8 mar. 2023.
...
%\toprule
%\begin{minipage}[t]{0.48\columnwidth}\raggedright\strut
%\includegraphics[width=2.20972in,height=1.45833in]{media/image9.png}
...
%\toprule
%\begin{minipage}[t]{0.48\columnwidth}\raggedright\strut
%\includegraphics[width=1.92708in,height=1.51319in]{media/image10.jpeg}
...
%\textless{}Imagem: \emph{\url{https://commons.wikimedia.org/wiki/File:Cabinet_of_Dr_Caligari_1920_Lobby_Card.jpg}\textgreater{}}\strut
...
\fonte{Disponível em:
https://enciclopedia.itaucultural.org.br/termo347/abstracionismo.
Acesso em: 8 mar. 2023.}
\end{quote}
...
Suas obras são regidas pela figuração e imitação do mundo;
