...
\fonte{Agência Brasil. Retrospectiva 2022: confira as principais notícias de janeiro. Disponível on-line.}
\end{quote}
...
\fonte{Fonte de pesquisa: Ciência Hoje das Crianças. Uma soneca por todo o inverno. Disponível on-line.}
\end{quote}
...
\fonte{Joseph Shafan. *As fábulas de Esopo*. Edição disponível on-line.}
\end{quote}
...
\fonte{Luciana Atheniense. Estado de Minas. O impacto da tragédia das chuvas no turismo do litoral Norte de SP. Disponível on-line.}
