...
% Definindo os vértices do triângulo
    \coordinate[label=above:$A$] (A) at (3,5);
    ...
    \draw pic[draw, fill=green!30, angle radius=0.7cm,angle eccentricity=1.5,"$x + 20^\circ$"] {angle=C--B--A};
    \draw pic[draw, fill=green!30, angle radius=0.7cm,angle eccentricity=1.5,"$2x$"] {angle=A--C--B};
