...
\num{10} Considerando a figura abaixo, em que ABC é a representação de um
...
comprimento. Sabendo dessa informação, qual é a área desse \textit{chip}, em centímetros quadrados?
...
% \num{16} Em determinado mês, três livrarias A, B e C venderam, respectivamente 
% 120 livros, 80 livros e 160 livros. Com base nesses dados, assinale a alternativa correta.

% \begin{escolha}
% \item C vendeu mais livros que A e B juntas.
% \item A vendeu menos livros que B.
% \item C vendeu 70 livros a mais do que A.
% \item B vendeu o dobro de livros em comparação com C.
% \end{escolha}
...
\begin{myquote}
\centering{Profissão - Batimentos cardíacos - Pressão - Altura}
\end{myquote}
