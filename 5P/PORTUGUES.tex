...
\marginnote{Neste módulo, os alunos deverão ser guiados durante o processo de
...
Ao entrarmos em contato com um texto, primeiro devemos identificar seu tema e seu assunto. Leia o texto a seguir.\bigskip
...
\fonte{Texto escrito para este material.}\bigskip
...
\sidetext{SAEB: Localizar informação explícita.
...
\sidetext{SAEB: Inferir informações implícitas em textos.
...
\sidetext{SAEB: Identificar a ideia central do texto.
...
\conteudo{Enquanto caminhava pela floresta, Chapeuzinho Vermelho encontrou um lobo
...
\sidetext{SAEB: Analisar os efeitos de sentido de verbos de enunciação.
...
\marginnote{Neste módulo, estudaremos o gênero textual notícia. Você deve
...
absorvermos todo o seu conteúdo.\looseness=-1
...
\noindent{}Além da escrita, um texto argumentativo pode apresentar \preencher{imagens\hfill}.
...
\end{escolha}
\sidetext{SAEB: Analisar o uso de recursos de persuasão em textos verbais e/ou
...
\sidetext{SAEB: Julgar a eficácia de argumentos em textos. BNCC: EF05LP20 -
...
\end{escolha}
\end{minipage}
\sidetext{SAEB: Analisar os efeitos de sentido de recursos multissemióticos em
...
\marginnote{Habilidades da BNCC: EF35LP27, EF35LP31.}
...
\begin{quote}
Um conjunto de versos constitui uma \preencher{estrofe\hfill}.
\end{quote}
...
\marginnote{Neste módulo, os alunos conhecerão o conceito de variedade linguística.
...
preservadas e valorizadas.\bigskip

\includegraphics[width=\textwidth]{./imgs/img18.jpg}
...
“mecê” e “nhor-sim”, termos que não são mais ser utilizados atualmente.\hfill}

\num{2} Destaque alguns dos termos que você identificou, durante a sua
leitura, como variedades linguísticas.


\reduline{Resposta pessoal. Sugestões: apre, mecê, canhe, nhor-sim.\hfill}
\linhas{1}
...
“cascado”, que se trata de um grupo sertanejo.\hfill}
\linhas{1}
...
As \preencher{Possibilidades de resposta: bandeirola ou bandeirinha} de São João representam uma decoração típica das
...
\emph{https://bit.ly/3mlNajT}. Acesso em: 26 fev. 2023.}
\end{quote}
...
\sidetext{SAEB: Identificar as variedades linguísticas em textos. BNCC: EF35LP30 – Diferenciar discurso indireto e discurso direto, determinando o efeito de sentido de verbos de enunciação e explicando o uso de variedades linguísticas no discurso direto, quando for
o caso.}
...
\fonte{Olavo Bilac. Poesias infantis. Rio de Janeiro: Francisco Alves, 1929. Disponível em: \emph{https://bit.ly/43ePQR3}. Acesso em: 25 mar. 2023.}
...
\sidetext{SAEB: Analisar os efeitos de sentido decorrentes do uso dos advérbios.}
...
\marginnote{Neste módulo, os alunos vão entrar em contato com as diferenças entre
...
\begin{wrapfigure}{l}{.5\textwidth}
\includegraphics[width=.5\textwidth]{./imgs/img21b.jpg}
\end{wrapfigure}
...
\sidetext{SAEB: Avaliar a fidedignidade de informações sobre um mesmo fato veiculadas em diferentes mídias. BNCC:
...
\sidetext{SAEB: Distinguir fatos de opiniões em textos. BNCC: EF05LP16 – Comparar
...
\marginnote{Os alunos serão apresentados a dois modos bastante comuns de organizar
...
\includegraphics[width=\textwidth]{./imgs/img22.jpg}\bigskip
...
os resultados em um gráfico.}

\conteudo{Veja:\bigskip

\includegraphics[width=\textwidth]{../ilustracoes/POR5/SAEB_5ANO_POR_FIGURA1.png}\bigskip
...
\vspace*{-1cm}
\includegraphics[width=\textwidth]{../ilustracoes/POR5/SAEB_5ANO_POR_FIGURA2.png}
\vspace*{-2.5cm}
...
\reduline{Por meio de um gráfico de barras, quantidades podem ser comparadas por meio da comparação entre as alturas (barras verticais) ou os comprimentos (barras horizontais) dos elementos do gráfico.\hfill}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.5\textwidth]{../ilustracoes/POR5/SAEB_5ANO_POR_FIGURA3.png}
\end{figure}
...
\includegraphics[width=\textwidth]{./imgs/img24.jpg}
...
\sidetext{SAEB: Analisar relações de causa e consequência. BNCC:
...
\end{escolha}
\end{minipage}
\sidetext{SAEB: Identificar os mecanismos de progressão textual. BNCC:
