...
\begin{itemize}
\item EF05HI01, EF05HI07, EF05HI08.
\end{itemize}
...
\begin{center}
\includegraphics[width=.6\textwidth]{./imgs/img26.png}
\end{center}
...
\begin{center}
\includegraphics[width=.8\textwidth]{./imgs/img27.png}\\
Árvore de araucária, que pode viver até 700 anos.
\end{center}

\begin{center}
\includegraphics[width=.8\textwidth]{./imgs/img28.png}\\
Formiga, que vive até dois anos.
\end{center}
...
\begin{figure}[htpb!]
\includegraphics[width=\textwidth]{./imgs/img31.png}
...
\begin{enumerate}
\item \reduline{agricultura baseada no ciclo do sol\hfill}
\linhas{1}

\item \reduline{função religiosa e sagrada\hfill}
\linhas{1}
\end{enumerate}
...
\begin{enumerate}
\item \reduline{Aqui o aluno pode colocar qualquer característica do calendário
ocidental atual: 12 meses\hfill}
\linhas{1}

\item \reduline{4 estações, 365 dias, etc. As informações não
estão no texto, então o professor deve lembrar que este é o calendário
que eles utilizam no dia a dia.\hfill}
\end{enumerate}

Calendário Chinês:

\begin{enumerate}
\item \reduline{Baseado no ciclo da lua e do sol\hfill}
\linhas{1}

\item \reduline{Duração de 12 anos\hfill}
\linhas{1}
\end{enumerate}
...
\begin{enumerate}
\item \reduline{Dividido por estações\hfill}
\linhas{1}

\item \reduline{baseado em aspectos da natureza, peixes, chuvas etc)\hfill}
\linhas{1}
\end{enumerate}
...
\begin{itemize}
\item EF05GE03, EF05GE10, EF05GE11, EF05GE12.
\end{itemize}
...
\fonte{Bruna Vieira. G1. Poluição em escolas em Diadema, na Grande SP, é quase três vezes maior do que o recomendado, aponta pesquisa. Disponível em: \emph{https://g1.globo.com/sp/sao-paulo/noticia/2022/07/06/poluicao-em-escolas-em-diadema-na-grande-sp-e-quase-tres-vezes-maior-do-que-o-recomendado-aponta-pesquisa.ghtml}. Acesso em: 23 fev. 2023}
\end{myquote}
...
\includegraphics[width=\textwidth]{./imgs/img37.jpg}
...
\begin{itemize}
\item EF05GE02, EF05HI03, EF05HI10.
\end{itemize}
...
\begin{center}
\includegraphics[width=.7\textwidth]{./imgs/img38.png}
\end{center}
...
%\begin{figure}[htpb!]
%\includegraphics[width=\textwidth]{./imgs/img40.png}
...
\reduline{Negativa: Desabrigou pessoas.\hfill}

\reduline{Positiva: Maior espaço de reunião da população nas festividades.
...
\begin{figure}[htpb!]
\includegraphics[width=1\textwidth]{./imgs/img46.png}
\caption{{[}...{]} O Brasil é uma República Federativa organizada política e
...
\num{2} Agora, marque o estado em que você mora com um X no mapa acima.\bigskip
...
\begin{itemize}
\item Criança: De \preencher{zero\hspace{2cm}} até \preencher{doze\hspace{2cm}} anos de idade.

\item Adolescente: Entre \preencher{doze\hspace{2cm}} e \preencher{dezoito\hspace{2cm}} anos de idade.
\end{itemize}
...
\num{2}\enlargethispage{\baselineskip}
...
\begin{center}
\includegraphics[width=.45\textwidth]{./imgs/img53.png}
\includegraphics[width=.45\textwidth]{./imgs/img54.png}
\end{center}
...
\begin{figure}[htpb!]
\includegraphics[width=\textwidth]{./imgs/img55.png}

\includegraphics[width=\textwidth]{./imgs/img56.png}
\end{figure}
...
\textbf{Imagem 1}
\begin{itemize}
\item Nome da atividade: \reduline{Pecuária\hfill}
\linhas{1}

\item Local: \reduline{Campo\hfill}
\linhas{1}

\item Principal produto do trabalho: \reduline{Alimentos de origem animal\hfill}
\linhas{1}
\end{itemize}

\textbf{Imagem 2}
\begin{itemize}
\item Nome da atividade: \reduline{Agricultura\hfill}
\linhas{1}

\item Local: \reduline{Campo\hfill}
\linhas{1}

\item Principal produto do trabalho: \reduline{Alimentos de origem vegetal\hfill}
\linhas{1}
\end{itemize}
...
\begin{figure}[htpb!]
\includegraphics[width=\textwidth]{./imgs/img59.png}
