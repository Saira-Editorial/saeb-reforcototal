...
\begin{figure}[H]
\centering
\includegraphics[width=.4\textwidth]{./imgSAEB_7_POR/media/image1.png}
\end{figure}
...
\begin{figure}[h!]
\centering\includegraphics[width=\textwidth]{./imgSAEB_7_POR/media/image5.png}
\end{figure}
...
\bigskip
O livro \preencher{cujo} autor Maria conhecia, foi premiado em diversos
concursos literários. A \preencher{obra} tratava das questões que interessavam
a \preencher{ela}. A \preencher{garota} era uma leitora incansável.
\bigskip
