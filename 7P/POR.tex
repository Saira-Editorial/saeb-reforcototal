...
\noindent{}Leia a sentença a seguir e responda as questões 3 e 4. 
...
\noindent{}Leia a notícia abaixo e responda às questões de 5 a 10.
...
\noindent{}Leia o texto abaixo para responder às questões de 3 a 10.
...
\num{3} Qual o assunto central do texto?
...
\num{5} No primeiro parágrafo predominam fatos ou opiniões? Justifique sua resposta.
...
\num{6} Identifique fatos e opiniões do segundo parágrafo.
...
\num{7} No terceiro parágrafo, existe uma expressão que indica que o autor vai
relativizar as opiniões positivas do parágrafo anterior. Que expressão é essa? 

\reduline{Contudo.\hfill}

\num{8} Quais são as principais críticas aos filmes Barbie? 
