...
\noindent{}Leia o texto abaixo e responda às questões 8 e 9. 
...
\num{6} Na primeira frase do texto, existe uma marca evidente de parcialidade.
Que marca é essa?

\reduline{Na primeira frase do texto, o uso da primeira pessoa do singular é
uma marca evidente de parcialidade.} 

\num{7} Levando em consideração os dois primeiros parágrafos, responda: a marca de 
...
\num{8} Nos três últimos parágrafos, que recurso o autor usa para dialogar com
os leitores?  

\reduline{Nos três últimos parágrafos, o autor faz perguntas para dialogar com
o leitor.}
...
\noindent{}Leia o texto abaixo para responder às questões de 7 a 10.
...
\num{7} Explique a metáfora do trecho ``o céu era um oceano escuro e piscante''.
...
\num{8} Copie do texto um exemplo de personificação e explique por que você
...
\num{9} Explique a figura de linguagem estabelecida pelos termos destacados no trecho 
...
\num{10} Explique a ironia do trecho final do texto.
