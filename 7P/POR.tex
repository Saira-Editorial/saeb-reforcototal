...
Leia a sentença a seguir e responda as questões 1 e 2. 
...
\end{figure}
%Fonte: pixabay https://pixabay.com/pt/vectors/mosquito-picada-lib%C3%A9lula-asa-voe-1743558/
...
\end{figure}
%Fonte: pixabay https://pixabay.com/pt/vectors/coroa-rei-o-rei-de-monarca-j%C3%B3ia-5334406/
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{./imgSAEB_7_POR/media/image38.png}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{./imgSAEB_7_POR/media/image48.png}
\end{figure}
...
\end{figure}
%Fonte Pixabay https://pixabay.com/pt/photos/ecologia-proteger-proteção-2903067/
...
\caption{Domínio público / Acervo Arquivo Nacional}
\end{figure}
%Fonte: Wikipedia https://commons.wikimedia.org/wiki/File:J%C3%BAlia_Lopes_de_Almeida,_sem_data.tif
