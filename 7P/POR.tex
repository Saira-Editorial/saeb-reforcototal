...
\noindent{}Leia a sentença a seguir e responda as questões 1 e 2. 
...
\noindent{}Leia a notícia abaixo e responda às questões de 3 a 8.
...
\noindent{}De acordo com o texto, a erradicação da malária se baseia na cooperação entre diferentes países 
da América porque:
...
\noindent{}Para o autor do texto acima, quando receberam alunos e professores depois da pandemia de 
...
\noindent{}De acordo com as afirmações presentes no texto, é correto afirmar que a alimentação saudável
...
\noindent{}Leia o seguinte trecho do Estatuto da Criança e do Adolescente -- ECA -- para 
...
\noindent{}Analise o texto a seguir para responder às questões 4 e 5. 
...
\noindent{}Leia o texto abaixo e responda às questões 7 e 8. 
...
\noindent{}Pode-se afirmar que o trecho acima pertence a um texto de divulgação científica, pois contém:
...
\noindent{}Os dois textos tratam de questões relacionadas à dengue. Quanto às diferenças
...
\noindent{}Sobre os trechos selecionados é correto afirmar que:
...
\noindent{}Leia o trecho a seguir e responda as questões 3 e 4.
...
\noindent{}Leia o trecho a seguir e responda às questões 5 e 6.
...
\noindent{}Passe a frase para o discurso indireto.
...
\noindent{}Nesse trecho da lenda da mandioca, notam-se traços da cultura
...
\noindent{}\emph{Casimiro de Abreu}
...
\noindent{}A primeira versão da ``Canção do exílio'', escrita por Gonçalves Dias em 1847,
...
\noindent{}O texto acima pode ser caracterizado como poema visual. Os poemas visuais
...
\noindent{}Leia o texto abaixo para responder às questões de 1 a 9.
...
\noindent{}A leitura integral do texto acima permite afirmar que o autor
...
\noindent{}No final do segundo parágrafo, as aspas serviram para:
...
\noindent{}Para o coordenador da Embratur, o Brasil está na vanguarda da discussão sobre 
...
\noindent{}Leia o texto abaixo para responder às questões de 2 a 9.
...
\noindent{}De acordo com o texto, devemos retornar à prática de assistir aos filmes 
...
\noindent{}Segundo o texto acima, os pais devem   
...
\noindent{}De acordo com o autor do texto acima, a obra de Lima Barreto segue atual 
porque 
...
cherges são recursos que dialogam com amplos contextos, embora sejam muito
...
\noindent{}Leia a tirinha abaixo e responda às questões de 1 a 6.
...
\begin{myquote}No fragmento do conto ``Pai contra Mãe'', o narrador de Machado de Assis faz a crítica
...
\begin{myquote}Na imagem acima observa-se uma campanha para evitar a proliferação do
...
\begin{myquote}A respeito do meme acima, pode-se afirmar que
...
\noindent{}Leia o texto abaixo para responder às questões de 1 a 5.
...
que supreendem o leitor, o autor explica onde as encontrou: em um no Enade de 2021, 
fonte confiável que ele usou para escrever a notícia.}
...
que os futuros professroes deveriam fazer e o que eles cumprem concretamente.}

\num{4} Levando em consideração o texto como um todo, para que servem as 
informações do quarto parágrafo?

\reduline{As informações do quarto parágrafo servem para exemplificaar as 
afirmações dos parágrafos anteriores, de maneira mais detalhada.}
...
\noindent{}Leia o texto abaixo para responder às questões de 7 e 8.
...
uma marca evidente de parcialidade.} 
...
que é bastante persuasiva.} 

\noindent{}Leia o texto abaixo para responder às questões 9 e 10. 
...
apresentou as opiniões de um especialista.}
...
\noindent{}Assinale a alternativa que contém uma explícita marca de parcialidade do texto acima.
...
\noindent{}Leia o texto abaixo para responder às questões de 5 a 8.
...
contribui para reduzir mudanças climáticas.}
...
não se pode negar que é preciso restaurar áreas degradadas.}
...
\noindent{}No contexto em que se insere, a expressão ``mesmo assim'' expressa oposição entre:
...
\noindent{}Na frase ``Como \textbf{deve} ser triste depender do luxo para ser feliz!'', 
...
\noindent{}O uso do gerúndio na campanha acima expressa:
...
\noindent{}Leia os primeiros versos do Hino Nacional Brasileiro para responder às perguntas:
...
% \noindent{}Leia o texto abaixo para responder à questão 6.
...
\noindent{}Leia o texto abaixo para responder às questões de 6 a 9.
...
\noindent{}Para descrever a personagem Iracema, o autor se valeu sobretudo de
...
\noindent{}No trecho acima, o efeito obtido por meio da personificação da ``febre de possuir'' é descrever
...
\noindent{}Leia o texto a seguir para responder às questões de 1 a 3.
...
\noindent{}Leia o texto a seguir para responder às questões 4 e 5.
...
\noindent{}Leia o texto abaixo para responder às questões de 6 a 8.
...
jovens'', ``o exame'', ``Estes'', ``O local'' e ``os estudantes''.}
...
\noindent{}Na frase ``Tenho ali na parede o retrato \textsc{\textbf{dela}}'', expressão destacada
se refere
...
\noindent{}No trecho acima, a expressão ``a inocente criança'' se refere
...
\noindent{}No texto acima, todos os pronomes destacados se referem 
...
\noindent{}Leia um trecho do romance \textit{Dom Casmurro}, de Machado de Assis:
...
\noindent{}Leia o texto abaixo para responder às questões de 4 a 10.
...
\noindent{}O coco é uma dança popular de roda, que se executa ao som de canto, batida de palmas e 
...
\noindent{}No exemplo acima, o autor usou da norma-padrão para adequar-se à linguagem apropriada ao texto
...
\noindent{}No diálogo acima, observa-se a transcrição da fala coloquial em:
