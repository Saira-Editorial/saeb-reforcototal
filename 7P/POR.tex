...
infringem as regra de trânsito, elas me \textsc{\textbf{diriam}} que \ledots{}''
...
É inútil descrever o quarto de um estudante. \textsc{\textbf{Aí}} nada se encontra de novo. Ao
...
roupa, o chapéu, a bengala e a bacia; a mesa \textsc{\textbf{onde} escreve e que só apresenta
de recomendável a gaveta, cheia de papéis, de cartas de família, de flores e
...
No trecho acima, as palavras destacadas -- ``aí'' e ``onde'' -- se referem a 

\begin{escolha}
  
  \item ``estudante'' e ``estante''.
  
  \item ``nada'' e ``cabide''.
  
  \item ``o quarto de um estudante'' e ``mesa''.
  
  \item ``descrever'' e ``gaveta''.
