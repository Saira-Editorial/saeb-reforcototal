...
a) Incorreta. As palavras destacadas se referem, respectivamente, a ``o quarto
   de um estudante'' e ``mesa''.
b) Incorreta. As palavras destacadas se referem, respectivamente, a ``o quarto
   de um estudante'' e ``mesa''.
c) Correta. As palavras destacadas -- ``aí'' e ``onde'' -- se referem a termos
   que as antecedem: respectivamente, ``o quarto de um estudante'' e ``mesa''.
d) Incorreta. As palavras destacadas se referem, respectivamente, a ``o quarto
   de um estudante'' e ``mesa''.
