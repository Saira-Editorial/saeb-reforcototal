...
\usepackage{edlab-git}				% define epígrafe, quote
...
\usepackage{pdfpages}
\usepackage{wrapfig}
\usepackage{graphicx} %Incluí esse pacote segundo informação que obtive no GPT (Rogério, 5/10/23, 13h06)
