...
\centering\includegraphics[width=.7\textwidth]{./imgSAEB_6_POR/freepik/PORT_6_IMG-2.jpeg}
\end{wrapfigure}
...
sugestões para a cidade e entregam ao prefeito. Disponível em: https://shorturl.at/ipsOS.
...
\reduline{A palavra significa ``um grande número ou quantidade indefinida de algo''. Na crônica, ela mostra a força do universo digital, que, por sua imensa quantidade de possibilidades, não só envolve como também vicia as pessoas.\hfill}
...
\centering\includegraphics[width=0.6\textwidth]{./imgSAEB_6_POR/freepik/PORT_6_IMG-5.jpeg}
\end{figure}
...
\item Uma carta de reclamação. \rosa{X}
...
\includegraphics[width=\textwidth]{./imgSAEB_6_POR/freepik/PORT_6_IMG-15.jpeg}
\end{figure}
...
\conteudo{A \textbf{intertextualidade} é uma técnica que envolve a criação de conexões
...
Utilize os dois textos a seguir para responder às questões de 1 a 4.
...
\reduline{A palavra adquire um sentido literal, já que os olhos do gatinho
são realmente inclinados, na diagonal.\hfill}\linhas{3}
...
\conteudo{As citações de terceiros em textos são uma prática comum na escrita
...
\begin{itemize}
\item \textbf{Citação direta} quando você transcreve exatamente as palavras de um
...
\item \textbf{Citação indireta} quando você utiliza a ideia ou informação de um
autor, mas escreve com suas
\item \textbf{Citação de citação} quando você utiliza uma citação que foi citada
...
\item \textbf{Paráfrase} quando você produz um texto com base em outro que já
...
Utilize o texto a seguir para resolver as atividades de 1 a 7.
...
mundo ao seu redor.\hfill}\linhas{5}
...
selvagens. O trecho que confirma essa informação é: ``Ao contrário dos cães, que desejam ser como os humanos, os gatos não aspiram a ser outra coisa senão gatos.''\hfill}\linhas{2}

\num{4} Que tipos de argumentos o autor utiliza para defender essa tese?

\reduline{O autor utiliza comparações e referências da convivência cotidiana com os gatos, como em "Há uma ameaça escondida atrás de cada cortina e sob cada almofada.", além do trecho que apresenta a citação de um autor especialista, John Bradshaw.\hfill}\linhas{2}

\num{5} Por que o autor do artigo reproduz a fala de um especialista no
desenvolvimento do texto?

\reduline{Porque a fala do especialista dá credibilidade ao texto.\hfill}\linhas{2}
...
\begin{escolha}
\item Reproduzem a fala do especialista na forma de discurso indireto. \rosa{X}
...
\reduline{O conector *segundo*, que precede trecho entre aspas.\hfill}
...
confessou que entendia a letra de Ciranda-cirandinha de outro jeito.\hfill}
...
falar. Por isso ele informa que ela "confessou" que cantava errado.\hfill}
...
\conteudo{Opinião é uma avaliação subjetiva ou julgamento que uma pessoa faz sobre
...
\begin{myquote}
\begin{figure}[H]
\centering\noindent\includegraphics[width=.45\textwidth]{./imgSAEB_6_POR/freepik/PORT_6_IMG-36.jpeg}
\end{figure}
...
historiadores descrevem.  \rosa{X}
...
história de ficção, quase inacreditável.\hfill}\linhas{3}
...
foi incrível, maravilhoso.\hfill}
...
\conteudo{Para cada situação comunicativa existe uma escolha lexical, ou seja, de
...
\begin{itemize}
\item \textbf{Ambiguidade} quando uma palavra ou expressão adquire mais de um
sentido, a depender da intenção do enunciador ou da interpretação do
receptor.

\item \textbf{Ironia} consiste na utilização de determinada palavra ou expressão
...
Leia o texto a seguir para resolver as atividades de 1 a 3.
...
\conteudo{
Uma \textbf{notícia} é um relato factual de um evento, acontecimento ou situação
...
\begin{itemize}
\item \textbf{Atualidade}: recente e atual, relata algo que acabou de acontecer ou
foi descoberto.
\item \textbf{Objetividade}: apresentada de forma imparcial, sem opiniões pessoais
ou julgamentos de valor.
\item \textbf{Clareza}: necessita ser escrita de forma clara e concisa, usando uma
linguagem simples e direta para que o leitor possa compreender
facilmente.
\item \textbf{Relevância}: deve ser de interesse público e ter uma importância
significativa para a sociedade.
\item \textbf{Precisão}: A notícia deve ser precisa e baseada em fatos
verificáveis, com informações precisas e corretas.
\item \textbf{Novidade}: A notícia deve ter algo de novo ou original que chame a
atenção do leitor ou ouvinte.
\item \textbf{Conexão}: deve estabelecer uma conexão com o público,
...
\reduline{O compartilhamento de senhas por parte dos usuários da Netflix.\hfill}\linhas{1}
...
mês atrás", e não se sabe a qual mês ele se refere.\hfill}\linhas{2}
...
anuncia que há regras para o compartilhamento de senhas.\hfill}\linhas{2}
...
pessoas compartilham senhas com amigos e parentes, dando a entender que
sabe de que maneira essa prática funciona.\hfill}\linhas{2}
...
apresente informações precisas para o leitor, sem qualquer viés de
opinião.
...
\centering\includegraphics[width=0.5\textwidth]{./imgSAEB_6_POR/freepik/PORT_6_IMG-24.jpeg}
\end{figure}
...
\begin{itemize}
\item EF69LP04, EF69LP28.
\end{itemize}

\conteudo{
O \textbf{modalizador} é uma palavra ou expressão por meio da qual o enunciador
...
Leia a resenha crítica do filme \emph{Yesterday} para responder às questões
de 2 a 7.
...
\reduline{Ele se refere ao fato de o personagem ser um músico amador em
busca do sucesso.\hfill}\linhas{2}
...
estranho um mundo em que as pessoas não conheçam os Beatles.\hfill}\linhas{2}
...
em que o mundo todo sofre um apagão. \reduline{Exato = certeza.\hfill}
...
\begin{itemize}
\item \textbf{Metáfora}: comparação implícita entre duas coisas que têm
características em comum;
\item \textbf{Metonímia}: uso de uma palavra ou expressão no lugar de outra, com a
qual se relaciona de alguma forma;
\item \textbf{Hipérbole}: exagero proposital para enfatizar uma ideia ou emoção;
\item \textbf{Ironia}: uso de palavras que aparentemente significam o oposto do que
se quer dizer, com o objetivo de criticar ou provocar um efeito de
humor;
\item \textbf{Personificação}: atribuição de características humanas a seres
inanimados ou animais;
\item \textbf{Catacrese}: quando uma palavra é usada de forma aproximada ou adaptada, por falta de um termo mais adequado, como ``asa da xícara'' ou ``pé da cama'';
\item \textbf{Sinestesia}: ocorre quando uma expressão mistura duas sensações
diferentes entre aquelas percebidas pelos órgãos sensoriais;
\item \textbf{Gradação}: sequência de palavras que intensifica uma ideia;
\item \textbf{Eufemismo}: expressões usadas para atenuar uma ideia tida como
agressiva ou desagradável;
\item \textbf{Onomatopeia}: representação gráfica dos sons;
\item \textbf{Aliteração}: repetição de sons consonantais idênticos ou semelhantes para
sugerir acusticamente algum elemento, ato, fenômeno;
\item \textbf{Pleonasmo}: construção em que se expressam as ideias de forma redundante, para enfatizá-las.
\end{itemize}
...
quis dizer que ela pressentia que iriam vencer o campeonato.\hfill}\linhas{2}
...
\item O jogo me causou muita dor na batata da perna. \rosa{X}
...
Observe a imagem a seguir, que apresenta apenas texto não verbal
para promover a necessidade de cuidarmos do meio ambiente.

\begin{figure}[H]
%PORT_6_IMG-31 — POR.tex:3411
\centering\includegraphics[width=0.5\textwidth]{./imgSAEB_6_POR/freepik/PORT_6_IMG-31b.jpeg}
\end{figure}
...
\centering\includegraphics[width=0.5\textwidth]{./imgSAEB_6_POR/freepik/PORT_6_IMG-32.jpeg}
\end{wrapfigure}
...
Os \textbf{pronomes} são os responsáveis por relacionar o substantivo a uma das
...
palavras, vamos ressaltar neste módulo o estudo dos \textbf{sinônimos} (em
...
\reduline{Não adianta ele os testar.\hfill}

\num{7} Em ``É aqui que eu queria chegar'', o enunciador se refere, de
fato, a um lugar geográfico? Explique.

\reduline{Não se trata de uma referência a um lugar físico, mas da referência a um ponto da argumentação a que o enunciador queria chegar em seu texto.\hfill}
...
\begin{itemize}
\item \textbf{Sociais}: dependem dos \textbf{grupos sociais em
que a pessoa se insere}, ou seja, das pessoas com quem ela convive.
\item \textbf{Regionais}: sofrem forte influência do \textbf{espaço geográfico} ocupado
pelo falante.
\item \textbf{Históricas}: dependem da época de uso da língua, já que esse uso varia com o passar dos anos, das décadas, dos séculos.
\item \textbf{Estilísticas}: surgem da adequação que o falante faz de seu nível de
...
\item O menino driblou a mãe com perfeição. \rosa{X}
...
Observe uma imagem retirada do Twitter da Prefeitura do
...
\begin{figure}[H]
\centering\includegraphics[width=.9\textwidth]{./imgSAEB_6_POR/media/image12.png}
\caption{Carlos Ruas.}
\end{figure}
...
\begin{figure}[H]
\centering\includegraphics[width=.65\textwidth]{./imgSAEB_6_POR/media/image15.jpeg}
...
\begin{figure}[H]
\centering\includegraphics[width=.85\textwidth]{./imgSAEB_6_POR/media/image35.jpeg}
\end{figure}
...
\begin{figure}[H]
\centering\includegraphics[width=.6\textwidth]{./imgSAEB_6_POR/media/image36.png}
...
\begin{figure}[H]
\centering\includegraphics[width=\textwidth]{./imgSAEB_6_POR/media/image37.png}
...
\begin{figure}[H]
\centering\includegraphics[width=\textwidth]{./imgSAEB_6_POR/media/image38.png}
...
\begin{figure}[H]
\centering\includegraphics[width=.85\textwidth]{./imgSAEB_6_POR/media/image39.png}
\end{figure}
...
\num{5} Analise o anúncio.\enlargethispage{3\baselineskip}

\begin{figure}[H]
\centering\includegraphics[width=.5\textwidth]{./imgSAEB_6_POR/media/image40.jpeg}
...
\begin{figure}[H]
\centering\includegraphics[width=\textwidth]{./imgSAEB_6_POR/media/image41.png}
...
\num{8} Leia o texto.\enlargethispage{3\baselineskip}
...
rostos de D. Pedro I e suas esposas}. Jornal da USP, publicado em
07 mar. 2023. Atualizado em 10 mar. 2023. Disponível em: https://shorturl.at/zE145. Acesso em: 14 mar. 2023. Adaptado.}
\end{quote}
...
% REVER
\begin{figure}[htpb!]
\includegraphics[width=\textwidth]{./imgSAEB_6_POR/media/image42.png}
\end{figure}
...
\begin{figure}[htpb!]
\centering\includegraphics[width=\textwidth]{./imgSAEB_6_POR/media/image43.jpeg}
...
\begin{quote}
\begin{center}
\textbf{Damiani pede manutenção asfáltica em ruas esburacadas de Sorriso}
\end{center}
...
\begin{figure}[H]
\centering\includegraphics[width=\textwidth]{./imgSAEB_6_POR/media/image39.png}
\end{figure}
...
\begin{figure}[H]
\centering\includegraphics[width=.9\textwidth]{./imgSAEB_6_POR/media/image44.png}
...
\begin{quote}
\begin{center}
\textbf{Câmara aprova projeto que obriga pet shops e clínicas veterinárias a
...
abandonados?\enlargethispage{2\baselineskip}
...
\begin{figure}[H]
\centering\includegraphics[width=\textwidth]{./imgSAEB_6_POR/media/image46.png}
...
\begin{quote}
\begin{center}
\textbf{Contato com tecnologia digital pode provocar danos aos bebês}
\end{center}
\medskip
...
\begin{figure}[H]
\centering\includegraphics[width=.8\textwidth]{./imgSAEB_6_POR/media/image50.png}
\end{figure}
...
\begin{figure}[H]
\centering\includegraphics[width=.9\textwidth]{./imgSAEB_6_POR/media/image51.png}
