...
\reduline{Não se trata de uma referência a um lugar físico, mas da referência a um ponto da argumentação a que o enunciador queria chegar em seu texto.\hfill}\linhas{1}
