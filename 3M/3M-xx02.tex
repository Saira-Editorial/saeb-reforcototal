...
\subsubsection{} Adicione ou subtraia para obter o número desejado.
...
\subsubsection{} Utilize os sinais menor que (\textbf{\textless{}}), maior que (\textbf{\textgreater{}}) ou igual a
...
\subsubsection{} Ligue a operação na coluna 1 ao seu resultado na coluna 2.
...
\subsubsection{} Observe atentamente a figura dada e, em seguida, responda ao que se pede em cada item.
...
\subsubsection{} Vicente vendeu 6 sorvetes de chocolate, 8 de morango, 3
...
\subsubsection{} A receita de um bolo pede para colocar 260 g de
...
\subsubsection{} Raquel adora confeitaria. Por isso, 
...
\subsubsection{} Complete o quadro, transformando as adições em multiplicações. Em seguida, encontre o resultado.
...
\pagebreak
\subsubsection{} João possui uma distribuidora de ovos. Hoje, ele recebeu 15 caixas  
...
\subsubsection{} A mãe de Beatriz comprou uma caixa de bombons para presentear os quatro filhos. 
...
\subsubsection{} Brenda se deparou com uma divisão em sua prova de matemática. 
...
\subsubsection{} Complete cada frase com a palavra ``dobro'' ou com a palavra ``triplo''.
...
\pagebreak
\subsubsection{} No quadro branco da professora Adriana, foram escritos os números a seguir:
...
\begin{comment}
\subsubsection{} Observe a conversa entre Rebeca, Raquel e Renata no sítio do avô de Rebeca.
...
\subsubsection{} Uma costureira recebeu uma encomenda para colocar 6 botões em
...
\subsubsection{} Para uma festa familiar, a mãe de Josué comprou 12 fardos de
...
\subsubsection{} Um campeonato interno de basquete será promovido na escola em que Carlos
