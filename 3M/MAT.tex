...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.3\textwidth]{./media/image2.png}
\end{figure}
...
\begin{itemize}
\item 
  A sequência pode ser a dos números pares:
\end{itemize}
...
%NOTE: Esse exercício não parece adequado para 3o ano e o nível de dificuldade destoa do restante das atividades
...
\num{2} As notas de Geografia de 20 alunos foram organizadas em uma tabela.
...
\pagebreak
\num{3} Uma escola fez um apesquisa sobre os esportes preferidos de seus alunos
...
%NOTE: Inverter o gabarito (o que era 2 vira três e vice-verso).
