...
% ANDRÉ Os comentários abaixo valem para quase todas as habilidades apresentadas:

% Somente o item ``Comparar diferentes sentenças de adições ou de subtrações de dois
%números naturais.'' parece estar parcialmente de acordo como terceiro ano.

% [!] Verificar se o item um corresponde a conteúdo do terceiro ano EF1 -- anos iniciais -- 
% e se é contemplado pelo material. O que causou estranhamento foi a indicação de representação 
% de fração, que pertence ao conjunto dos números racionais e não dos números naturais. 

% ANDRÉ [!] Compor ou decompor número de seis ordens, adequado seria trabalhar números de 
% até 4 algarismos para 3o ano do EF1 -- Anos Iniciais

% Qual documento do SAEB devo consultar para extrair as habilidade específicas por disciplina e ano?

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% REFORMULAR e INCLUIR ITENS dos enunciados 

\begin{itemize} 
  \item Identificar a ordem ocupada por um algarismo ou seu valor posicional
(ou valor relativo) em um número natural de até 4 ordens.

  \item Comparar ou ordenar números naturais de até quatro ordens.

  \item Compor ou decompor números naturais de até 4 ordens na forma aditiva,
 ou em suas ordens, ou em adições e multiplicações.

  \item Comparar diferentes sentenças de adições ou de subtrações de dois
 números naturais.

%%%% Em relação ao documento da BNCC e de orientações da revista Nova Escola: %%%%% 
%%%% as orientações para o 3 ano EF1 dizem respeito ao conjunto dos números naturais 
%%%% e não dos números racionais %%%%

% Cálculos mentais e escritos (adição e subtração)

% Regularidade de sequências numéricas

% Equações de números naturais

% Significados de metade e de terça parte
...
\conteudo{
Valor relativo é aquele que o algarismo assume no número  
A classe de um número é chamada unidade (1), dezena (10), centena (100), unidade de milhar. 
A unidade é numero de 1ª ordem, a dezena é número de 2ª ordem, 
a centena é número de 3ª ordem, a unidade de milhar é número de 4ª ordem. 
...
Com essas informações, é possível realizar uma decomposição numérica
de acordo com a posição do algarismo, segundo a classe e ordem:

Exemplo: 389 = 3 x 100 + 8 x 10 + 9

\noindent\includegraphics[width=\textwidth]{./media/image1.png}}
% ANDRÉ Fazer imagem, considerando as 4 ordens
...
porque não atingem número suficiente de 10 para formar outro grupo. Isto é, 4 x 10 + 6.\hfill}
\end{escolha}
...
\num{4} Escreva os números em cada item. Depois, decomponha esse número conforme o exemplo.
...
\hline
\begin{tabular}[c]{@{}l@{}}Número escrito\\ por extenso\end{tabular} & \begin{tabular}[c]{@{}l@{}}Número escrito\\ em algarismos\end{tabular} & Número decomposto \\ \hline
...
\begin{longtable}[]{@{}ll@{}}
\toprule
Dezena & Unidade\tabularnewline\rosa{8} & \rosa{5}
\midrule
\endhead
&\tabularnewline
\bottomrule
...
\item Somando todas as peças, qual o maior número que Richard pode
representar? 
