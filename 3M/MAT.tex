...
%Note. 1. E escrever uma frase que introduza a noção de medida: tempo, comprimento, massa e volume. 2. Juntar as duas tabelas? (pelo menos, melhorar a disposição das medidas de tempo: vertical minuto, hora, dia, semana, quinzena, mês, semestre, ano (ano bissexto), década, século, milênio. 
...
\reduline{Portanto, ele ainda precisará crescer 33 cm para poder usar o brinquedo.\hfill}
...
%Note. Refazer o enunciado do exercício de modo que a pergunta e o resultado indicado sejam correspondentes 
...
%Note. Este conteúdo deve ser apresentado antes do conteúdo do módulo anterior que mostra tabelas com medidas. 
\conteudo{
...
%Note: Reduzir e simplificar bastante. Essa explicação está muito complicada para 3o ano, além de envolver conceitos de outras disciplinas que ainda não estão consolidadas nesta etapa.
