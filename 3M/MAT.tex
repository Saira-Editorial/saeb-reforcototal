...
Valor absoluto é o valor do próprio algarismo, o e valor posicional, chamado também de valor relativo, se refere ao lugar que o algarismo ocupa no número de acordo com a classe e a ordem. 
...
relativo igual a 100, porque ocupa a classe da centena, na 3ª ordem. 
Sendo assim, 1 x 100 = 100.

Com essas informações, é possível decompor o número 2.146, de acordo com a posição que o algarismo ocupa no número: 2.146 = 2 x 1.000 + 1 x 100 + 4 x 10 + 6.

}

\section*{Atividades}

\num{1} Vilma encontrou um pedaço de papel em sua bolsa. Nele, estava escrito o número a seguir:
...
\reduline{É possível formar 4 grupos de 10 unidades, e 6 unidades ficam sem grupo, 
porque não atingem as 10 unidades necessárias para formar outro grupo. 
Isto é, 46 = 4 x 10 + 6.\hfill}
\end{escolha}
...
\num{4} Escreva o número em algarismos ao lado de cada item. Depois, decomponha o número, conforme o exemplo.
...
\num{5} Complete a tabela de acordo com a orientação.\bigskip
...
\reduline{O número pode ser decomposto da seguinte maneira: 50 x 10 + 9 = 59\hfill}
\linhas{1}
...
\end{figure}
%NOTE. ICO. Conferir se a imagem está de acordo com o texto.
...
\coment{88 deve estar ligado ao oitenta e oito; 283 deve estar ligado ao duzentos e oitenta e três; 57 deve estar ligado a ciquenta e sete; e 316 deve estar ligado a trezentos e dezesseis.}
...
Calcule em que ponto Felipe parou na marcação se ele completou a corrida?
...
%Note. Inserir resposta: Anternativa ``D''
...
\item
  T
% Note. Indicar a resposta do professor: Alternativa ``D''
\end{escolha}
...
Indique o número correspondente ao representado por Ana Letícia?
...
\item
  1.509
% Conferir se a imagem final corresponde ao texto.
\end{escolha}

\begin{escolha}
\item Decomponha o número representado por Ana Letícia.
\reduline{5 x 100 + 1 x 9 = 509.\hfill}
\end{escolha}
\linhas{3}
\pagebreak
...
\conteudo{\begin{itemize}
\item [ ] \textbf{Adição}
\end{itemize}

\vspace{1em}
\begin{center}
\noindent\includegraphics[width=.4\textwidth]{./media/image10.png}
\end{center}
...
\num{1} Assinale a alternativa de acordo com o que se pede em cada item.
...
= (igual a) em cada situação para comparar as quantidades representadas.\bigskip
...
\num{3} Ligue cada operação na coluna 1 ao resultado na coluna 2.
...
%NOTE: É preciso indicar as respostas dos itens
...
%NOTE: \coment é um comando?
\coment{84 + 12 = 96; 60 -- 23 = 37; 67 -- 58 = 9; 50 -- 2 x (5 + 15) + 2 = 50 -- 40 + 2 = 12; 2 + 8 -- 2 x (1 + 2) = 2 + 8 -- 6 = 4}
...
\begin{escolha}
\item Calcule a soma de todos os números que estão na primeira coluna?
\reduline{4 + 9 + 2 = 15\hfill}
\linhas{2}

\item Calcule a soma de todos os números que estão na segunda coluna?
\reduline{3 + 5 + 7 = 15\hfill}
\linhas{2}

\item Calcule a soma de todos os números que estão na terceira coluna?
\reduline{8 + 1 + 6 = 15\hfill}
\linhas{2}

\item O que você percebe ao comparar os resultados das somas dos números de cada coluna?
\reduline{O resultado de todas as somas apresentam o mesmo resultado, 15.\hfill}
\linhas{2}

\item Calcule a soma dos números que estão na 1º linha?
\reduline{4 + 3 + 8 = 15\hfill}
\linhas{1}

\item Calcule a soma dos números que estão na 2º linha?
\reduline{9 + 5 + 1 = 15\hfill}
\linhas{2}

\item Calcule a soma dos números que estão na 3º linha?
...
Em seguida, solicita mais 135 g de farinha de trigo. 
...
\num{7} Raquel sempre adorou confeitaria. Por isso, 
...
\num{8} Complete o quadro, transformando as adições em multiplicações. Em seguida, encontre o resultado, conforme o modelo.
...
%\end{figure}
\reduline{(15 x 252):12 = 315 embalagens com capacidade de 12 ovos cada uma.\hfill}
...
Calcule o quociente, supondo Brenda acertou o cálculo.
...
Na caixa, os bombons estão distribuídos em 8 fileiras com 9 unidades cada. 
Calcule a quantidade de bombons que cada filho deve receber, se todos ganharem a mesma quantidade.
...
\end{escolha}
\end{minipage}
% Note. Incluir resposta: ``Resposta C. 6 x 12 = 72.''

\num{3} Um campeonato interno de basquete será promovido na escola em que Carlos
estuda. Pelas regras, cada time deverá ter 5 jogadores titulares e mais 3 reservas. Sabendo-se que serão montados 6 times, a quantidade de alunos que poderão participar do campeonato é igual a
...
% Note. Incluir: ``Resposta: D. (5 + 3) x 6 = 48 alunos'' 
...
\conteudo{Uma sequência ou sucessão é um conjunto numérico ordenado, no qual existe sempre uma lógica de formação.
...
diversas cores.
%Note. Conferir resposta de acordo com imagem definitiva
...
%Note. Essa questão pode dar problema pra dautônico. 
...
%Note: Inserir os números abaixo na cor do professor na tabela
...
\end{multicols}
\end{escolha}
%Note. Vf como a resposta aparece para o professor
...
\end{multicols}
\end{escolha}
%Note. Incluir resposta: ``Resposta: d. 2; 6; 12; 20; 30; 42. A sequência é dada por n\twosuperior + n  = 62 + 6 = 42'
...
%Note. Incluir resposta: ``Resposta: d. Antecessor de um número: Número imediatamente anterior a um número na sequência dos números naturais. Sucessor de um número: Número imediatamente a frente, ou após, de um número na sequência dos números naturais."
...
%NOTE: Incluir frase introdutória sobre unidade de medida: comprimento; mencionar que hora é uma unidade de tempo (hora, minuto e segundo).

\conteudo{

Unidade de medida é uma quantidade estabelecida e padronizada, usada para medir e comparar grandezas físicas. 

Por exemplo, hora, período, dia, semana, mês, ano, década, século, milênio, são unidades de medida de tempo. 
...
\begin{center}
\noindent\includegraphics[width=0.5\textwidth]{./media/image42.png}
\end{center}

\pagebreak

\item A borracha mede \reduline{4 cm.\hfill}

\begin{center}
\noindent\includegraphics[width=0.5\textwidth]{./media/image43.png}
\end{center}

\item O apontador mede \reduline{4 cm.\hfill}

\begin{center}
\noindent\includegraphics[width=0.5\textwidth]{./media/image44.png}
\end{center}

\item A tesoura mede \reduline{10 cm.\hfill}

\begin{center}
\noindent\includegraphics[width=0.5\textwidth]{./media/image45.png}
\end{center}
\end{escolha}

%Note. Checar se a imagem final corresponde às medidas indicadas nas respostas.
...
%Note. Checar se a imagem impressa corresponde à resposta.
...
% Note. Indicar reinteradamente que um metro tem cem centímetros. 
...
\reduline{Jorge começou a assistir o episódio às 16h15.\hfill}
\linhas{2}
...
\end{multicols}
\end{escolha}
%Note. O problema foi adaptado e é preciso redigir uma resposta. Com os números apresentados, a resposta é 3 garrafinhas + 100 mL, não é exata. Melhor seria trocar 40 por 50, assim a resposta seria dois litros, o correspondente a 4 garrafinhas. 
...
O ano é composto por 12 meses. O nome dos meses e suas respectivas quantidades de dias estão na tabela a seguir.
...
\conteudo{
\begin{center}
\textbf{A Hora no Relógio Analógico}
\end{center}
...
Para ler as horas no relógio analógico, siga a ordem: primeiro, o ponteiro das as horas, e, depois, o ponteiro dos minutos. 


\begin{myquote}
\begin{itemize}

\item Observe o exemplo a seguir. O ponteiro menor está no 11, e o ponteiro maior no 12. Então, sao onze horas. 
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=0.4\textwidth]{./media/image54b.png}
\end{figure}
...
\includegraphics[width=0.8\textwidth]{./media/image64a.png}
}
...
\end{figure}
%Note. ICO. Incluir nas alternativas, conforme o original
...
\conteudo{
\textbf{Tipos de gráficos mais utilizados em estatística}
...
\includegraphics[width=0.9\textwidth]{./media/image76.png}
}
