...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.5\textwidth]{./media/image2a.jpg}
\end{figure}
...
\end{itemize}
%Note. Inverter gabarito: 2 pelo três e vice-versa.
...
\reduline{Total de números: 16. Total de números que interessam: 5, sendo eles 9, 10, 11, 12 e 13. 
Probabilidade de 5 em 16.\hfill}
\linhas{1}
