...
Valor absoluto é o valor do próprio algarismo, o e valor posicional ou relativo se refere ao lugar que o algarismo assume no número de acordo com a classe e a ordem. 
...
relativo igual a 100, porque ocupa a classe da centena, na 3ª ordem. Sendo assim, 1 x 100 = 100.
}
...
Com essas informações, é possível realizar a decomposição numérica de acordo com a posição do algarismo, segundo a classe e ordem:
...
\num{1} Vilma encontrou um pedaço de papel em sua bolsa em que estava escrito um número:
...
\item
  Calcule quantos grupos de 10 unidades é possível formar com o número 46?
\reduline{É possível formar 4 grupos de 10 unidades, e 6 unidades ficam sem grupo, 
porque não atingem 10, necessários para formar outro grupo. Isto é, 4 x 10 + 6.\hfill}
\end{escolha}

\num{2} Arnaldo contou suas figurinhas e montou 8 grupos com 10 figurinhas. Ao total, adicionou mais quatro figurinhas.
...
\item  Como se escreve por extenso a quantidade de figurinhas que Arnaldo possui?\\
...
\num{4} Escreva os números em algarismos em cada item. Depois, decomponha esse número, conforme o exemplo.
...
material dourado. Ele montou o número a seguir:
