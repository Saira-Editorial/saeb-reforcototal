...
\hline
\textsc{unidade de milhar} & \textsc{centena} & \textsc{dezena} & \textsc{unidade} \\
\hline
\textsc{4ª ordem} & \textsc{3ª ordem} & \textsc{2ª ordem} & \textsc{1ª ordem}  \\
\hline
2 & 1 & 4 & 6 \\
\hline
\end{tabular}
...
Com essas informações, é possível decompor o número 2.146, segundo a classe e a ordem:

Exemplo: 2.146 = 2 x 1.000 + 1 x 100 + 4 x 10 + 6.
}


\section*{Atividades}

\num{1} Vilma encontrou um pedaço de papel em sua bolsa. Nele, estava escrito um número abaixo:
...
\hline
\begin{tabular}[c]{@{}l@{}}Número escrito\\ por extenso\end{tabular} & \begin{tabular}[c]{@{}l@{}}Número escrito\\ em algarismos\end{tabular} & Número decomposto \\ 
\hline
...
\num{14} No quadro branco da professora Adriana, foram escritos os números abaixo:
