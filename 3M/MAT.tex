...
%% # Conferir se todas as ``Notes'' foram resolvidas
%% # Conferir se todas as Atividades apresentam respostas discursivas 
%% (e não alternativas)
%% # Conferir se as imagens estão de acordo com o texto
%% # Conferir se todasas atividades, treinos etc. tem resposta (tem de ter, independentemente qual seja e onde entre)
%%
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=0.6\textwidth]{./media/image81.png}
\end{figure}
