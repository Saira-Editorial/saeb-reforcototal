...
%%%LATEX%%%%%%
%% # Arrumar Sumário que está puxando ``Matemática'' do ligar errado e colocando a página errada 
...
\conteudo{
\begin{center}
\textbf{Valor absoluto e valor relativo} 
\end{center}

Valor absoluto é o valor do próprio algarismo, e o valor posicional, chamado também de valor relativo, se refere ao lugar que o algarismo ocupa no número de acordo com a classe e a ordem. 
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.4\textwidth]{./media/image2.png}
\end{figure}
...
\num{2} Arnaldo contou suas figurinhas. Com elas, ele montou 8 grupos com 10 figurinhas e, ao total, adicionou ainda mais quatro figurinhas.
...
\num{4} Escreva o número em algarismos ao lado de cada item. Depois, decomponha o número de acordo com o modelo.
...
\conteudo{
\begin{center}
\textbf{Operações matemáticas: adição, subtração, multiplicação e divisão}
\end{center}
...
\num{2} Utilize os sinais menor que (\textless{}), maior que (\textgreater{}) ou igual a
(=), em cada situação, para comparar as quantidades representadas.\bigskip
...
\item
  O \reduline{triplo\hfill} de 1 é 2.
\item
...
\item
  O \reduline{dobro\hfill} de 64 é 128.
\end{escolha}
...
estuda. Pelas regras, cada time deverá ter 5 jogadores titulares e mais 3 reservas. Considerando que serão formados 6 times, a quantidade de alunos que poderão participar do campeonato é igual a:
...
Na sequência numérica dos números naturais, todos os termos possuem um sucessor. O sucessor de um número é o aquele imediatamente posterior na sequência. 
...
\begin{itemize}
\item 
  A sequência pode ser ordenada em números pares:
\end{itemize}
...
\coment{3ª linha: 424, 425, 426, 427, 428; 5ª linha: 443, 449; 6ª linha: 452, 453, 454, 459; 7ª linha: 463, 469; 8ª linha: 479; 9ª linha: 489.}

\item Qual o número que está na 3ª coluna e na 4ª linha?
\reduline{433.\hfill}
...
\begin{escolha}
\item Qual o número da pessoa atendida imediatamente antes de Rafaela?
\reduline{O número 31, pois é o antecessor de 32.\hfill}

\item Qual o número da pessoa atendida depois de Rafaela?
\reduline{O número 33, pois é o sucessor de 32.\hfill}
\end{escolha}

\num{7} Observe a reta numérica com números naturais e responda.
...
\begin{center}
\noindent\includegraphics[width=0.4\textwidth]{./media/image43.png}
\end{center}

\item O apontador mede \reduline{4 cm.\hfill}

\begin{center}
\noindent\includegraphics[width=0.4\textwidth]{./media/image44.png}
\end{center}

\item A tesoura mede \reduline{10 cm.\hfill}

\begin{center}
\noindent\includegraphics[width=0.4\textwidth]{./media/image45.png}
\end{center}
\end{escolha}
...
\reduline{ Por comparação, percebe-se que, no comprimento de um lápis, cabem cerca de 4 a 5 borrachas, conforme a figura dada.\hfill}
\linhas{2}
...
\conteudo{
\begin{center}
\textbf{Quanto tempo o tempo tem?}
\end{center}
...
\begin{center}
\textbf{Conhecendo nosso dinheiro}
\end{center}
...
\conteudo{
\textbf{Gráficos comuns em estatística}
