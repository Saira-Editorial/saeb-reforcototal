...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.7\textwidth]{./imgs/mat20.png}
\end{figure}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.6\textwidth]{../ilustracoes/MAT5/SAEB_5ANO_MAT_figura119.png}
\end{figure}
...
\begin{myquote}
\textbf{As cantigas de roda como manifestações do patrimônio cultural:
o papel da escola na perpetuação dessa cultura}
