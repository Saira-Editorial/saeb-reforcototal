...
números, frisando muito as classes e até a 6ª ordem. É muito importante
...
\begin{center}
\includegraphics[width=.8\textwidth]{../ilustracoes/MAT5/SAEB_5ANO_MAT_figura1.png}
\end{center}
}
...
%\coment{Além disso, utilize o exercício para treinar a escrita dos alunos. Exemplo: trinta e dois mil e oitenta e quatro.}
...
%\coment{Professor, devemos explorar bem a escrita dos números a partir da decomposição, pois muitos alunos desenvolvem dificuldades, conseguindo fazer a decomposição, mas sem compreender a volta (montagem dos números decompostos).}
...
da segunda coluna, traçando linhas retas.\enlargethispage{4\baselineskip}
...
\includegraphics[width=.3\textwidth]{../ilustracoes/MAT5/SAEB_5ANO_MAT_figura17.png}
}
...
\mbox{50 – 2 x (5 + 15) + 2 x 3 – 2 x 2) + 3 x (10 – 4 x 2) \rosa{= 18}}

\mbox{2 + 8 x 2 – 2(1 + 2 x 3) \rosa{= 4}}

\mbox{50 – {[}24 + 3 x (2 + 3 x 2{]} \rosa{= 2}}

\mbox{2 x 3 – {[}10 – 2 x (1 + 1 x 3){]} \rosa{= 6}}
...
\reduline{81 + 108 + 99 = 288 cm = 2,88 m\hfill}
\bigskip
...
\begin{multicols}{2}
\red{1,935 kg} \rosa{segundo balão}

\red{2,340 km} \rosa{terceiro balão}

\red{0,400 g} \rosa{quarto balão}

\red{0,35 m} \rosa{primeiro balão}
...
\begin{center}
\includegraphics[width=.4\textwidth]{../ilustracoes/MAT5/SAEB_5ANO_MAT_figura33.png}
\end{center}
...
\begin{center}
\includegraphics[width=.4\textwidth]{../ilustracoes/MAT5/SAEB_5ANO_MAT_figura34.png}
\end{center}
...
\reduline{Resposta: A e E. Letra A: 14 quadradinhos. Letra C: 11 quadradinhos. Letra D: 13 quadradinhos. Letra E: 14 quadradinhos.\hfill}\\
\reduline{Portanto, as duas letras que o cumpam asuperfícies de mesmo tamanho são A
e E.\hfill}
...
\reduline{24 x 1.500,00 = R\$ 36 000,00.\hfill}
\linhas{2}


\item
  Qual o valor que cada parcela terá?\\
\reduline{Lendo atentamente o texto, sabe-se que será de R\$ 1 500,00.\hfill}
\linhas{2}
...
\reduline{25.000,00 + (24 x 1.500,00) – 2.580,00 = R\$ 58 420,00.\hfill}
\linhas{1}
...
\reduline{40 – 34,09 = R\$ 5,91.\hfill}
\end{escolha}
...
\reduline{Temos 6 possibilidades de números que podem sair: 1, 2, 3, 4, 5 e 6.\hfill}\\
\reduline{Interessa um número par: 2, 4 e 6.\hfill}\\
\reduline{Portanto, a probabilidade será de 3/6 = ½ = 0,50 = 50\%.\hfill}

\item
  Tirar, na face voltada para cima, um número ímpar.\\
\reduline{Temos 6 possibilidades de números que podem sair: 1, 2, 3, 4, 5 e 6.\hfill}\\
\reduline{Interessa um número ímpar: 1, 3 e 5.\hfill}\\
\reduline{Portanto, a probabilidade será de 3/6 = ½ = 0,50 = 50\%.\hfill}

\item
  Tirar, na face voltada para cima, um número menor do que 3.\\
\reduline{Temos 6 possibilidades de números que podem sair: 1, 2, 3, 4, 5 e 6.\hfill}\\
\reduline{Interessa um número menor que 3: 1 e 2.\hfill}\\
\reduline{Portanto, a probabilidade será de 2/6 = 1/3.\hfill}
\end{escolha}
...
\reduline{6/20 = 3/10 = 0,30 = 30\%.\hfill}

\item
  A probabilidade de a bola não ser da cor preta.\\
\reduline{(6 + 4 + 2)/20 = 12/20 = 6/10 = 0,60 = 60\%.}\hfill.
\end{escolha}
...
\reduline{12/(12 +3 + 5) = 12/20 = 6/10 = 0,60 = 60\%.\hfill}
\linhas{1}

\item
  A probabilidade de ele ser um livro de português.\\
\reduline{A probabilidade é de 0\%; ou seja, é impossível sair um livro de
  português, visto que na caixa não há livros dessa disciplina.\hfill}
\end{escolha}
...
\begin{center}
\includegraphics[width=.6\textwidth]{../ilustracoes/MAT5/SAEB_5ANO_MAT_figura57.png}
\end{center}
}
...
\begin{center}
\includegraphics[width=.6\textwidth]{../ilustracoes/MAT5/SAEB_5ANO_MAT_figura58.png}
\end{center}
...
\begin{center}
\includegraphics[width=.6\textwidth]{../ilustracoes/MAT5/SAEB_5ANO_MAT_figura59.png}
\end{center}
...
\begin{center}
\includegraphics[width=.6\textwidth]{../ilustracoes/MAT5/SAEB_5ANO_MAT_figura60.png}
\end{center}
}
...
\reduline{Segunda-feira e quinta- feira ela percorreu a mesma distância: 14 km.\hfill}
...
\begin{center}
\includegraphics[width=.75\textwidth]{../ilustracoes/MAT5/SAEB_5ANO_MAT_figura67.png}
\end{center}
}
...
\reduline{1/6 + 2/4 = 1/6 + ½ = 4/6 = 2/3 do total de figurinhas foram doadas por Cássia e por Marcos.\hfill}
\linhas{1}

\item
  Qual a fração do total de figurinhas do álbum que ainda falta para que os
  alunos o completem?\\
\reduline{ 1 – 2/3 = 3/3 – 2/3 = 1/3.\hfill}
\linhas{1}
\end{escolha}
...
\reduline{1 – 5/9 = 9/9 – 5/9 = 4/9\hfill}
\linhas{2}
...
\item
  Ampliar a quantidade de todos os ingredientes na mesma proporção inicial. \rosa{X}
\end{escolha}
...
\begin{center}
\includegraphics[width=.6\textwidth]{../ilustracoes/MAT5/SAEB_5ANO_MAT_figura85-1.png}
\end{center}

Mas, se dividirmos o mesmo círculo em 8 partes iguais e sombreamos 4 partes, algo semelhante acontece.

\begin{center}
\includegraphics[width=.6\textwidth]{../ilustracoes/MAT5/SAEB_5ANO_MAT_figura85-2.png}
\end{center}
...
\begin{center}
\includegraphics[width=.6\textwidth]{../ilustracoes/MAT5/SAEB_5ANO_MAT_figura85-3.png}
\end{center}
...
\reduline{1,7; 1,68; 7,5; 1,45; 14,5.\hfill}
\linhas{1}
\item
...
\item
  4,36 – 2,501\\
\reduline{1,859.\hfill}
\linhas{1}

\item
  9,57 + 1,04\\
\reduline{10,61.\hfill}
\linhas{1}

\item
  20,957 + 4,58\\
\reduline{25,537.\hfill}
\linhas{1}

\item
  36 – 6,054\\
\reduline{29,946.\hfill}
\linhas{1}
\end{escolha}
...
\reduline{Pela análise da reta numérica dada, os alunos que tiraram nota acima
  de 8,3 foram Lara, Diego, Enzo e Amanda.\hfill}

\item
  Quais alunos tiraram nota maior que nove?\\
\reduline{Os alunos que obtiveram nota maior do que 9 foram Enzo e Amanda.\hfill}
\linhas{1}

\item
  Quantos pontos faltaram para que Mariana tirasse nota 10?\\
\reduline{10 – 7,9 = 2,1.\hfill}
\linhas{1}
\end{escolha}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=.5\textwidth]{../ilustracoes/MAT5/SAEB_5ANO_MAT_figura103.png}
\end{figure}
