...
\num{2} A PESSOA ESTAVA SOZINHO (A) NO
...
\num{3} QUAL FOI O PERÍODO QUE ESSA PESSOA FOI NO
...
\num{4} POR QUE A MATÉRIA QUE FEZ A PORTA ESTÁ
...
\num{6} MARQUE UM X NO QUADRO COM A INFORMAÇÃO
...
\num{9} POR QUE A CANOA VIROU? CIRCULE O BALÃO COM A RESPOSTA
...
\num{11} O QUE ELE PRECISA PARA SE CURAR DA DOENÇA? CIRCULE NO
...
\num{1} O QUE O PERSONAGEM DO PRIMEIRO QUADRINHO ESTÁ
...
\num{2} PARA VOCÊ QUEM É QUE O JACARÉ QUE APARECE NO SEGUNDO
...
\num{3} O MENINO DO PRIMEIRO QUADRINHO LIGOU PARA DANIEL
...
\num{4} O QUE SIGNIFICA A ESPRESSÃO “OLHA, SÃO INFINITOS! NO
...
\num{5} QUAIS SÃO OS NOME DOS PERSONAGENS DA
...
\num{6} COMO TALITA FICOU QUANDO FICOU SABENDO QUE SEU AMIGO
FELIPE IA
...
\num{8} O QUE SIGNIFICA A EXPRESSÃO USADA PELA MENINA QUE ESTÁ
...
\num{9} OS BALÕES TEM UM FORMATO DIFERENTE PARA MOSTRAR QUE AS
CRIANÇAS
