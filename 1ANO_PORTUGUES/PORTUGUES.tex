\section{MÓDULO 1: BRINCANDO COM LETRAS E SONS
...
Habilidades da BNCC: EF01LP04, EF01LP05, EF01LP07, EF01LP08, EF01LP09
...
pode representar? Depois apresente as vogais, brincando com elas,
mostrando que elas podem ser todas ditas em sequência; proceda da mesma
forma com as consoantes, explicitando, de maneira divertida, que para
...
CADA LETRA DO ALFABETO REPRESENTA UM SOM CHAMADO DE FONEMA QUE DÃO
ORIGEM ÀS PALAVRAS. A LETRA H É A ÚNICA LETRA DO ALFABETO QUE NÃO
APRESENTA SOM.

O ALFABETO ESTÁ DIVIDIDO EM DUAS PARTE: VOGAIS E CONSONANTE.

AS VOGAIS SÃO A - E - I - O - U E AS CONSOANTES SÃO B, C, D, F, G, H, J,
L, M, N, P, Q, R, S, T, V, X, Z. AINDA EXISTE TRÊS LETRAS ESPECIAIS K,
Y, W, QUE SÃO USADAS PARA ESCREVER PALAVRAS DE ORIGEM ESTRANGEIRAS QUE
TAMBÉM FAZEM PARTE DAS CONSOANTES.

UMA PALAVRA PODE SER DIVIDIDA EM UM OU MAIS PEDACINHOS CHAMADOS DE
SÍLABAS QUE SÃO PRONUNCIADAS DE UMA ÚNICA VEZ. A SÍLABAS DAS PALAVRAS
PODEM SER INICIAL, MEDIAL E FINAL.OBSERVE O EXEMPLO:
...
A SÍLABA OU O SOM INICIAL É SA A MEDIAL PA E A FINAL TO.
...
Para essa atividade você pode levar o alfabeto móvel e colocar em uma
caixa juntos com números placas de trânsito e outros símbolos como
@,\#,\&,\%.Solicitar que os alunos separem as letras dos outros símbolo
em seguida colocar as letra na ordem certa pode também separar as vogais
da consoantes. Habilidades BNCC EF01LP04/ EF01LP05
...
A) AGORA PENTE AS VOGAIS DE AZUL E DE VERMELHO AS CONSOANTES.

O aluno deverá pintar as letra A -E -- I- O -- U de vermelhos e as
outras letras de azul.

01- MARQUE COM UM X NA IMAGEM EM QUE SÓ APARECE
...
\subsubsection{2. PINTE SOMENTE O QUE É USADO PARA ESCREVER AS
...
\subsubsection{3. ESCREVA A PRIMEIRA LETRA DO NOME DAS
...
ensinar o som de cada letra, levar algumas imagens e pedir para as
crianças formar os seus nomes explorando som da letra inicial, medial e
final. Habilidades BNCC EF01LP05
...
\subsubsection{4. ESCREVA AS SÍLABAS QUE ESTÁ FALTANDO PARA COMPLETAR O
NOME DO
DESENHO.}\label{escreva-as-suxedlabas-que-estuxe1-faltando-para-completar-o-nome-do-desenho.}

Retome ao alfabeto móvel para formar o nome das palavras contar as
letras que formam cada palavra com som inicial, medial e final e
comparar as palavras que aparecem sons iguais. os alunos e depois
realizar a atividade. Habilidades BNCC EF01LP05/ EF01LP07
...
\subsubsection{5. CONTE QUANTAS LETRAS TEM AS PALAVRAS E ESCREVA NO
...
\subsubsection{6. PINTE DE AMARELO AS PALAVRAS NO QUADRO QUE COMEÇA COM
O MESMO
SOM.}\label{pinte-de-amarelo-as-palavras-no-quadro-que-comeuxe7a-com-o-mesmo-som.}

Para essa atividade é interessante brincar o jogo das rimas. Habilidade
BNCC EF01LP09
...
\subsubsection{7. SEPARE AS SÍLABAS DAS PALAVRAS DOS NOMES DOS ANIMAIS
DA FAZENDO DE SEU ANTÔNIO. E ESCREVA A QUANTIDADE DE PEDACINHO NO
...
Leia as palavras coma com os alunos e em seguida convide-as a baterem
palmas para observar quantas vezes abre a boca para falar a palavra ou
quantas vezes bate palmas

Habilidade BNCC EF01LP08

\includegraphics[width=1.29126in,height=1.13542in]{media/image26.jpg}

\textbf{SILÁBAS QUANTIDADE}
...
\subsubsection{8. ENCONTRE E PINTE NO CAÇA-PALAVRAS OS NOMES DOS
DESENHOS.}\label{encontre-e-pinte-no-cauxe7a-palavras-os-nomes-dos-desenhos.}

\protect\hypertarget{_heading=h.1fob9te}{}{}Retome ao alfabeto móvel
ajudar as crianças a formarem as palavras observando as palavras com o
som final igual ou palavras que rimam em seguida pintar no caça
--apalavras. Habilidade BNCC EF01LP08/ EF01LP09
...
. Retome ao alfabeto móvel para formar os nomes dos desenhos explorando
os sons inicial. Medial e final e ainda quantas vezes abre a boca para
falar a palavra. Habilidade BNCC EF01LP08/ EF01LP09
...
Habilidade BNCC EF01LP08/ EF01LP09
...
(C) Está incorreta, pois confundiu o som medial com a final.

\section{\texorpdfstring{\\
}{ }}\label{section-3}

\section{MÓDULO 2: LENDO PALAVRAS E FRASES
...
Habilidades da BNCC: EF01LP01, EF12LP01, EF01LP02, EF01LP13
...
crianças explorando como ler as palavras e os textos. Habilidades BNCC
EF01LP01.
...
descobrir quantas sílabas tem a palavra. Habilidade BNCC EF12LP01
...
C) QUANTAS VESES VOCÊ ABRE A BOCA PRA FALAR ESSA PALAVRA?
...
crianças os nomes dos desenhos para escrever na cruzadinha. Habilidade
BNCC EF01LP02
...
\textbf{Levar a palavra cebola em fichas recortada em sílabas. Formar os
nomes dos desenhos com as letras móveis para fazer comparação das
sílabas das palavras Habilidade BNCC} EF01LP13\textbf{.}
...
situação. Habilidade BNCC EF01LP02
...
\section{MODULO 3: ENCONTRANDO
INFORMAÇÕES}\label{modulo-3-encontrando-informauxe7uxf5es}

\protect\hypertarget{_heading=h.lnxbz9}{}{}HABILIDADE DO SAEB Localizar
informações explícitas em textos.

Habilidades da BNCC: EF15LP03
...
\protect\hypertarget{_heading=h.z337ya}{}{}Habilidade SAEB localizar
informações explícitas em textos.
...
\section{MÓDULO 4: POR QUE ESSE TEXTO?
...
\section{MÓDULO 5: COMPREENDER O
TEXTO}\label{muxf3dulo-5-compreender-o-texto}

\protect\hypertarget{_heading=h.3whwml4}{}{}HABILIDADE DO SAEB ~Inferir
...
\section{MÓDULO 6: AS INFORMAÇÕES DO
TEXTO}\label{muxf3dulo-6-as-informauxe7uxf5es-do-texto}

\protect\hypertarget{_heading=h.1pxezwc}{}{}Habilidade SAEB~Inferir
...
Cantar a música coma as crianças exploradas a oralidade. Habilidade SAEB
...
\subsubsection{1. PORQUE NÃO TINHA NO
ITOTORÓ?}\label{porque-nuxe3o-tinha-no-itotoruxf3}

\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_

R:ele podia tinha secado
...
\subsubsection{4. POR QUE A MANEIRA QUE FEZ A MORTA ESTÁ
...
\section{MÓDULO 7: OS TEXTOS E AS
...
\protect\hypertarget{_heading=h.er3p7jk5yewm}{}{}INFERIR INFORMAÇÕES EM
TEXTOS QUE ARTICULAM LINGUAGEM VERBAL E NÃO VERBAL

\protect\hypertarget{_heading=h.69rmtrb8c7jb}{}{}

\protect\hypertarget{_heading=h.23ckvvd}{}{}\textbf{Habilidade da BNCC:}
EF15LP14
...
\protect\hypertarget{_heading=h.vx1227}{}{}(C) Incorreta, pois acreditou
que pelo fato de ter a silaba to igual seria o nome da palavra.
...
OBSEVE A FRUTA PREFERIDA DE SOFIA.
...
VEJA A PALVRA QUE GUTO ESCREVEU.
...
A PALVRA QUE TERMINA COM O MESMO SOM DA SÍLABA PALVRA QUE GUTO ESCREVEU
É
...
Habilidade BNCCEF01LP13 Comparar palavras, identificando semelhanças e
diferenças entre sons de sílabas iniciais, mediais e finais.
...
(C) Incorreta, pois acreditou que ia mandar uma receita do bolo do
...
(C) Incorreta, por acreditar que o cartaz seria a capa de um livro de
...
(C) incorreta, pois acreditou que João e Maria planejava fugir dos pais
...
(C) Incorreta, pois considerou que alguma família se reúne para contar
história.
