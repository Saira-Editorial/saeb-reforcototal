...
\reduline{Maçâ- rato -- tatu - tapete -- casa -- mola -- bule -- doce.}
\linhas{4}
...
\num{1} LEIA A PALAVRA.}\label{leia-a-palavra.}
...
\num{2} AGORA LEIA A FRASE.}\label{agora-leia-a-frase.}
...
\num{6} CIRCULE E COPIE A ÚLTIMA SÍLABA DOS NOMES DAS
...
\num{7} OBSERVE A NUMERAÇÃO DE CADA ANIMAL E PREECHA A
...
\num{8} ENCONTRE NO CAÇA-PALAVRAS OS NOMES DAS FRUTAS. DEPOIS
COPIE NOS LUGARES
...
\num{9} TRADUZA OS CÓDIGOS E ESCREVA
...
\num{10} DESEMBARALHE AS PALAVRAS E FORME UMA
...
\num{11} MARQUE UM X NAS FIGURAS CUJO O NOME COMEÇA IGUAL A
PALAVRA
...
\num{12} COPIE A PRIMEIRA E A ÚLTIMA SÍLABA DO NOME DO
...
\num{13} NUMERE OS DESENHOS DE ACORDO COM O NÚMERO DAS
...
\num{14} OBSERVE A IMAGEM E ESCREVA UMA
